In the aftermath of our hackathon in Dresden, we have a [[Downloads|first release candidate]] now!
...
This is the after-hackathon release, and so far we have these changes 
(please correct me if I am wrong or forgot something):
...
# added the {{bc | Help | Report a Bug}} plugin (thanks Mark Longair)
...
# if you drop a .java file into the plugins/ directory and call {{bc | Plugins | Scripting | Refresh Javas}}, it will be added to the Plugins  menu and be compiled transparently upon being called.
