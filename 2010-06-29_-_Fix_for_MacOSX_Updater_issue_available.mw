<span style="color:red">'''Critical:'''</span> If you update Fiji on MacOSX, and instead of a Fiji window nothing is opened when you try to restart Fiji, you need to follow [[Fix_non-functional_Fiji_after_Update_on_MacOSX|these instructions]].<br/>
