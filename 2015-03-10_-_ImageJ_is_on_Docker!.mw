Today, the [[Contributors|ImageJ team]] is pleased to announce the first official support for running ImageJ in Docker: Fiji images!

= Motivation =

If you aren't already familiar with [https://www.docker.com/ Docker], it provides a flexible mechanism for distributing operating system + application state.
...
* [https://registry.hub.docker.com/u/fiji/fiji/ Fiji on Docker Hub]
* [https://github.com/fiji/dockerfiles Fiji Dockerfiles]
* [[Docker|Instructions for use]]
