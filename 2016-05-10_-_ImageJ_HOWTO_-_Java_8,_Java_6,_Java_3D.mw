...
<br>[[File:Osx.png|alt=macOS|x32px]]
...
[[File:Win.png|alt=Windows|x32px]]
<br>[[File:Tux.png|alt=Linux|x32px]]
| Download the final (2017-May-30) [[Fiji/Downloads#Java_6|Java-6 version of Fiji]]. It comes bundled with Java 6 and all platform launchers.
...
| Download the final (2017-May-30) [[Fiji/Downloads#Java_6|Java-6 version of Fiji]]. It is distributed ''without'' Java, so you must [[Frequently Asked Questions#How_do_I_set_up_Java_6_on_OS_X.3F|install Apple Java 6]] on your system.
...
| colspan=5 | See the [https://imagej.net/download.html ImageJ 1.x downloads page] for instructions.
|}
