...
In [[MATLAB]], select in the menu {{bc | File | Set Path...}} and add the ''scripts'' folder there  (on Mac, the file chooser doesn't let you choose directories within .app packages, so you have to use the [[MATLAB]] command <code>addpath('/Applications/Fiji.app/scripts')</code> or whatever folder works for you) .
...
{{Person|JeanYvesTinevez}} ([[User talk:JeanYvesTinevez|talk]]) 10:35, 8 August 2013 (CDT)
