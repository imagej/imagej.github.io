...
While the [[BigStitcher_Registration|Interest Point-based registration]] is quite resistant to outliers and will typically work even with few actually corresponding points, there are situations in which you might want to manually curate the detected interest points:

* in very heterogeneous samples you might have a lot of spurious detections that you want to exclude.
* for extracting [[BigStitcher_PSF|Point Spread Functions (PSFs)]] for [[BigStitcher_Deconvolution|Deconvolution]], you want to only use detected beads, but not detections in the sample itself.

We offer a variety of ways to manage interest points in '''MultiView mode''', which can be found in the main menu under <code>Interest Points</code>. 

[[File:BigStitcher_ips_menu.png|center|800px]]
...
[[File:BigStitcher_ips_explorer_bdv_all.png|thumb|300px|all interest points as an overlay in BigDataViewer]]

[[File:BigStitcher_ips_explorer_bdv_corresponding.png|thumb|300px|'''corresponding''' interest points as an overlay in BigDataViewer]]

[[File:BigStitcher_ips_explorer_panel.png|center|600px]]
...
[[File:BigStitcher_ips_new_from_corresponding.png|center|400px]]
...
[[File:BigStitcher_ips_dist_hist.png|center|600px]]
...
[[File:BigStitcher_ips_dist_hist_relative.png|center|400px]]
...
[[File:BigStitcher_ips_dist_remove_dist.png|center|400px]]
...
[[File:BigStitcher_ips_manual_remove_example.png|center|1000px]]
...
[[File:BigStitcher_ips_vis_dialog.png|center|600px]]
