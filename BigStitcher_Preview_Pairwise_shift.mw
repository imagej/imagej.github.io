...
[[File:BigStitcher_stitch_4_0.png|center|600px]]
...
{{Notice|The Interactive Link Explorer will work on the views selected in the main window, the others will be grayed out while it is open}}
...
* Once you are satisfied with the results, you can click '''Apply & Run Global Optimization''' to continue with the [[BigStitcher_Global_optimization|global optimization]] immediately.

[[File:BigStitcher_stitch_4_1.png|center|1000px]]

Go back to the [[BigStitcher#Documentation|main page]]
<!--[[File:BigStitcher_stitch_4_2.png]]-->
