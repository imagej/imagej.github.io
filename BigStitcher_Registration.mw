...
[[File:BigStitcher_Register_prec_desc_tr.png|thumb|300px|Parameters for Precise descriptor-based (translation invariant) registration]]
...
[[File:BigStitcher_Register_icp.png|thumb|300px|Parameters for ICP-based (no invariance) registration]]
...
If you opted for '''Regularization''' of the transform in the previous dialog, you will be asked for the type of the second transformation model to estimate and a '''lambda''' (<math>\in[0,1]</math>), i.e. how much weight you want to give to the regularizing model in the final averaged result.

[[File:BigStitcher_regularize_model.png|center|400px]]
...
[[File:BigStitcher_register_grouping.png|center|600px]]
