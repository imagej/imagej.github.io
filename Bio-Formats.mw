...
| author                 = [https://www.openmicroscopy.org/ Open Microscopy Environment]:<br/>- [[LOCI|UW-Madison LOCI]]<br/>- [https://www.glencoesoftware.com/ Glencoe Software]<br/>- [https://www.dundee.ac.uk/ University of Dundee]
| maintainer             = OME development team
| filename               = [https://downloads.openmicroscopy.org/bio-formats/ See Bio-Formats Downloads page]
| source                 = {{GitHub|org=openmicroscopy|repo=bioformats}}
| latest version         = [https://downloads.openmicroscopy.org/bio-formats/ See Bio-Formats Downloads page]
| status                 = active
...
See [https://loci.wisc.edu/software/bio-formats LOCI's Bio-Formats site] for a historical narrative of the project.

== Documentation ==

What follows is a brief overview of the available plugins. You will find them all under the "Bio-Formats" submenu of Plugins. See the [https://www.openmicroscopy.org/bio-formats/ Bio-Formats web site] for additional information about Bio-Formats in general.

See especially the [https://docs.openmicroscopy.org/latest/bio-formats/users/imagej/load-images.html#using-bio-formats-to-load-images-into-imagej Using Bio-Formats] page for detailed instructions.
...
* [https://www.emouseatlas.org/emap/analysis_tools_resources/software/woolz.html Woolz] (*.wlz)
...
== Reporting bugs ==
To report a bug in Bio-Formats, please see [https://docs.openmicroscopy.org/latest/bio-formats/about/bug-reporting.html reporting a bug in Bio-Formats].
