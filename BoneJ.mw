...
| maintainer             = {{Person|Michaeldoube}}, {{Person|Alessandrofelder}}
...
| latest version         = [https://github.com/bonej-org/BoneJ2/releases styloid-r7]
| status                 = Active
}}
BoneJ is a collection of skeletal biology plug-ins for ImageJ.
This is the new, modernized version of the software available through the ImageJ [https://imagej.net/Updater updater]. Its update site is called [http://sites.imagej.net/BoneJ BoneJ]. For the old ImageJ1 version, see [[BoneJ1]].
...
# [https://imagej.net/Downloads Download] the latest version of Fiji for your operating system
# Launch Fiji
...
* '''Lines per direction''': controls how many parallel lines are drawn per each direction. Each line has the length <math>d = \sqrt{width^2 + height^2 + depth^2}</math>.
...
==== Results ====
* '''Degree of anisotropy''': how much orientation there is in the structure. <math>0.0</math> means the image is completely isotropic, the sample has no directionality whatsoever. <math>1.0</math> means there is an extreme prevailing orientation in the structure of the image.
* '''Radii of fitted ellipsoid''' (optional): the lengths of the radii <math>a \leq b \leq c</math> of the ellipsoid fitted on the MIL points. Degree of anisotropy equals <math>= 1.0 - \frac{1}{c^2}/\frac{1}{a^2}</math>.
* '''Eigenvectors and values''' (optional): the values <math>m00, m01, m02 ... m22</math> correspond to the <math>x, y, z</math> components of the three eigenvectors of the fitted ellipsoid. The eigenvalues <math>D1, D2, D3</math> correspond to <math>\frac{1}{c^2}, \frac{1}{b^2}, \frac{1}{a^2}</math> respectively, where <math>a, b, c</math> are the radii of the ellipsoid.
...
If you use it in your published work, please cite Doube M. 2020 Multithreaded two-pass connected components labelling and particle analysis in ImageJ. bioRxiv , 2020.02.28.969139. (doi:10.1101/2020.02.28.969139) [https://doi.org/10.1101/2020.02.28.969139]
...
==== Citation ====
Doube M. 2020 Multithreaded two-pass connected components labelling and particle analysis in ImageJ. bioRxiv , 2020.02.28.969139. (doi:10.1101/2020.02.28.969139) [https://doi.org/10.1101/2020.02.28.969139]
...
We have removed some plug-ins from BoneJ. ''Neck shaft angle'', ''Plateness'' and ''Structure model index'' have been discontinued. ''Interpolate ROIs'', [https://imagej.net/3D_Binary_Filters ''Dilate 3D'' and ''Erode 3D''] come pre-packaged with ImageJ, so they are no longer included in BoneJ2.
...
== Citation ==
If you'd like to cite the software, we will soon publish a paper about migrating BoneJ from ImageJ1 to ImageJ2. You can read the draft (and send us your feedback) as we're writing it [https://v1.overleaf.com/read/yxdkwpcdkjzj for Wellcome Open Research on Overleaf]. We recommend you cite the specific release used in your research.

== Funding ==
The redesign and porting effort to create BoneJ2 was supported by a [https://wellcome.ac.uk/grant-funding/people-and-projects/grants-awarded/bonej2-fullfeatured-nextgeneration-bonej-standardised Wellcome Trust Biomedical Resource and Technology Development Grant]. Interaction with [[SciView]] was assisted by a [https://royalsociety.org/grants-schemes-awards/grants/international-exchanges/ Royal Society International Exchange grant]. [[#Ellipsoid factor|''Ellipsoid Factor'']] validation and improvements were funded by the UK [https://bbsrc.ukri.org/research/grants-search/AwardDetails/?FundingReference=BB%2fP006167%2f1 BBSRC].
