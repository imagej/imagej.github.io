...
== Current release ([[BoneJ2]]) ==

There's a new modernized version of BoneJ available through the ImageJ [https://imagej.net/Updater updater]. Read more about [[BoneJ2]].

== Legacy (BoneJ v1.x) Installation ==

{{Logo | ImageJ1 | size=24px}} BoneJ was originally designed to work with plain [[ImageJ 1.x]].
...
BoneJ and pQCT plug-ins are in the process of separation. The latter have their own [https://imagej.net/PQCT| update site], and they don't need BoneJ to work. However, if you download <code>BoneJ_.jar</code> from [http://bonej.org/legacy bonej.org] it still includes older versions of the pQCT tools.  
