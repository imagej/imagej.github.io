...
&nbsp;&nbsp;&nbsp;&nbsp;'''radius*''' : a scalar or list of scalar representing the standard deviation of the gaussian kernel standard deviation along the image axis<br>
&nbsp;&nbsp;&nbsp;&nbsp;'''boundary''' : a string in {'min', 'max', 'same', 'zero', '<u>mirror</u>', 'periodic'}, default is mirror<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;<code>img2 = cip.gauss( img1 , 5 )</code>
[[File:CIP_gauss.PNG|none|400px]]<br>
...
<span style="font-size:110%">'''Signature'''</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;<code>outputImage = cip.erode( inputImage*, radius*, shape, boundary, pixelSize)</code>

<span style="font-size:110%">'''Input'''</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;'''inputImage*''' : the image process<br>
&nbsp;&nbsp;&nbsp;&nbsp;'''radius*''' : a integer or list of integer representing the half size of the filter window along the image axis.<br>
&nbsp;&nbsp;&nbsp;&nbsp;'''shape''' : a string in {'<u>rectangle</u>', 'disk'} describing the shape of the window used for the processing.<br>
&nbsp;&nbsp;&nbsp;&nbsp;'''boundary''' : a string in {'min', 'max', 'same', '<u>mirror</u>', 'periodic'}, default is mirror<br>
&nbsp;&nbsp;&nbsp;&nbsp;'''pixelSize''' : a scalar or list of scalar along image dimension. Default is 1.
...
<span style="font-size:110%">'''Example'''</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;<code>img2 = cip.erode( img1 , 2 )</code>
[[File:CIP_erode.PNG|none|400px]]<br>

<span style="font-size:115%">'''Implementation'''</span><br>
...
<span style="font-size:110%">'''Signature'''</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;<code>outputImage = cip.dilate( inputImage* , radius*, shape, boundary, pixelSize)</code>
...
<span style="font-size:110%">'''Example'''</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;<code>img2 = cip.dilate( img1 , 2 )</code>
[[File:CIP_dilate.PNG|none|400px]]<br>
...
<span style="font-size:110%">'''Signature'''</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;<code>outputImage = cip.opening( inputImage* , radius* , shape, boundary, pixelSize)</code>
...
<span style="font-size:110%">'''Example'''</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;<code>img2 = cip.opening( img1 , 5 )</code>
[[File:CIP_opening.PNG|none|400px]]<br>
...
<span style="font-size:110%">'''Signature'''</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;<code>outputImage = cip.closing( inputImage* , radius* , shape, boundary, pixelSize)</code>
...
<span style="font-size:110%">'''Example'''</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;<code>img2 = cip.closing( img1 , 16, 'disk' )</code>
[[File:CIP_closing.PNG|none|600px]]<br>
...
<span style="font-size:110%">'''Example'''</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;<code>img2 = cip.tophat( img1 , 5, 'disk' )</code>
[[File:CIP_tophat.PNG|none|500px]]<br>
...
<span style="font-size:110%">'''Signature'''</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;<code>outputImage = cip.distance(inputImage*, threshold, pixelSize)</code>

<span style="font-size:110%">'''Input'''</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;'''inputImage*''' : the image process<br>
&nbsp;&nbsp;&nbsp;&nbsp;'''threshold''' : if the input image is not binary that value can be used to threshold the image. if the input image is binary that value is ignored<br>
...
<span style="font-size:110%">'''Example'''</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;<code>img2 = cip.distance( img1 , 500 )</code> or 
<code>img2 = cip.distance( img1 , 'threshold', 500 )</code> 
[[File:CIP_distance1.PNG|none|400px]]<br>

&nbsp;&nbsp;&nbsp;&nbsp;<code>img2 = cip.distance( img1 )</code> will build the distance map for a binary image.
[[File:CIP_distance2.PNG|none|400px]]<br>
...
<span style="font-size:110%">'''Signature'''</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;<code>outputImage = cip.median(inputImage*, radius*, shape, boundary, pixelSize)</code>
...
<span style="font-size:110%">'''Example'''</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;<code>img2 = cip.median( img1 , 5 )</code>
[[File:CIP_median.PNG|none|400px]]<br>
...
<span style="font-size:110%">'''Signature'''</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;<code>outputImage = cip.invert(inputImage*)</code>
...
<span style="font-size:110%">'''Example'''</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;<code>img2 = cip.invert( img1 )</code>
[[File:CIP_invert.PNG|none|400px]]<br>
