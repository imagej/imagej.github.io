...
##see the 2 slides titled "Check with multi-colour beads" at [https://www.biodip.de/w/images/f/fa/QuantitativeColocAnalysis-10-2011.pdf Colocalization analysis course notes]
#How to measure the colour channel shift systematic error?
##[http://www.knoplab.de/psfj/overview/ psfJ] from Knop lab can make the measurement.
...
##Erik M's TransformJ Translate plugin in Fiji/ImageJ can do a sub pixel resolution shift for for each channel, as we have measured those shifts [https://imagescience.org/meijering/software/transformj/translate/ TransformJ Translate]
...
##The [https://imagescience.org/meijering/software/transformj/affine/ TransformJ Affine plugin]  might do the job,  which can also expand or shrink the image to accommodate different magnification as well as shift and rotation. 
