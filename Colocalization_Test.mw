...
| source                 = {{GitHub|org=fiji|repo=Colocalisation_Analysis|source=Colocalisation_Test.java}}, modified from [[MBF ImageJ]]
| latest version         = june 2009
| website                = [[Colocalization Analysis#Colocalization_Test]]
| status                 = <span style="color:red">Deprecated, use [[Coloc 2]] instead.</span>
}}
