...
The PSF is the image of a point source of light as imaged through a lens (or set of lenses).
...
#The raw measured PSF obtained by imaging sub-resolution size beads using the optical system.
#The measured PSF obtained by acquiring and processing multiple z-stacks of sub-resolution size beads.
#The theoretical PSF generated by a computer program, after input of values describing the optical system.
...
#The emission wavelength of the fluorophore
#The objective used (magnification and NA)
#The refractive index of the objective lens immersion medium
...
Several plugins for imageJ exist. The most sophisticated are the [http://bigwww.epfl.ch/algorithms/deconvolutionlab/ DeconvolutionLab (BIG - EPFL)] and the parallel [[Parallel_Iterative_Deconvolution|iterative]] and [[Parallel_Spectral_Deconvolution|spectral]] deconvolution plugins.
