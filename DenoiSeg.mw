...
Read [https://imagej.net/TensorFlow-GPU this page] for how to get GPU support. With out a GPU the training will take ages.
...
If you just want to test the FIJI plugin you may use this [https://cloud.mpi-cbg.de/index.php/s/Mayv4JHOlR6ykBh data]. It was used to create the screenshots below.
...
# In Python, run this at the end of your training: <code>mode.export_TF()</code>. 
