...
Thomas Boudier  [[File:EmailBoudier.png]], [https://www.sinica.edu.tw/en Academia Sinica], Taipei, Taiwan.
...
* [https://imagejdocu.list.lu/plugin/segmentation/3d_spots_segmentation/start 3D Segmentation] (iterative thresholding, spots segmentation, ...)
...
Download and copy the following jar in your plugins folder [https://drive.google.com/open?id=1aODVyqRjmU53wEM52lfLM74Yn9GP9PBl Diana_1.48.jar]

You have also to manually download and copy into your plugins directory the [[3D_ImageJ_Suite|3D ImageJ Suite]].

''Note that this version works only with 3D ImageJ library [https://drive.google.com/open?id=1a83KAeDEcCk0Lio3xXebd7Fxk83cTjy- mcib3d-core3.94.jar] and upper!"
