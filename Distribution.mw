...
* '''Documentation.'''
** Create a page here on the '''[https://imagej.net/ ImageJ Wiki]'''.
...
| style="background: #dfd; vertical-align: top" |
* Users '''[[How to follow a 3rd party update site|enable the update site]]''' to receive your extension.
* ImageJ's '''[[Updater]]''' automatically checks for updates from all enabled update sites.
| style="background: #dfd; vertical-align: top" |
* You do not need server space to host your extensions; you can use a '''[[How to set up and populate an update site#Add_your_personal_update_site|personal update site]]''' hosted on the ImageJ web site.
...
| style="vertical-align: top" |
* Users download the archive, unpacking it into ImageJ's <code>plugins</code> folder.
| style="vertical-align: top" |
...
* Users <i>will</i> report bugs found in outdated versions of the extension.
|}
...
* '''[https://help.github.com/articles/create-a-repo Create a new repository]''' for your project.
* '''[https://help.github.com/articles/pushing-to-a-remote Push your code]''' there.
* '''[[Git|Learn Git]]''' to manage your code effectively.
| style="background: #dfd; vertical-align: top" |
...
* "Doing it in public" is a great way to '''[http://blog.codinghorror.com/how-to-stop-sucking-and-be-awesome-instead/ stop sucking and be awesome instead]'''.
...
|-
| style="vertical-align: top" |
* Similar to GitHub, but using [https://bitbucket.org/ BitBucket] instead.
| style="vertical-align: top" |
* Similar to GitHub.
| style="vertical-align: top" |
...
|-
| style="vertical-align: top" |
* Similar to GitHub, but using [http://sourceforge.net/ SourceForge] instead.
| style="vertical-align: top" |
...
|-
| style="background: #dfd; vertical-align: top" |
* '''[https://imagej.net/index.php?title=Special:UserLogin&returnto=Welcome&type=signup Create an account]'''.
* '''[https://www.mediawiki.org/wiki/Help:Starting_a_new_page Create a page]''' for your extension.
| style="background: #dfd; vertical-align: top" |
...
* [http://imagejdocu.tudor.lu/doku.php?id=create_new_content Create a page] for your extension.
| style="vertical-align: top" |
...
|-
| style="vertical-align: top" |
* Prepare an HTML page modeled after the [https://imagej.net/plugins/index.html list of ImageJ 1.x plugins].
* Email it to {{Person|Rasband}}, the developer of ImageJ 1.x, and sole maintainer of the [https://imagej.net/index.html ImageJ 1.x website].
| style="vertical-align: top" |
...
|'''Disadvantages'''
|-
| style="vertical-align: top" | (Varies)
| style="vertical-align: top" |
