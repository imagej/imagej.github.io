{{Notice | This guide discusses how to modify an already-existing [[plugin]], and contribute your changes back.<br>
* If you are interested in developing a '''new''' plugin instead, see [[Writing plugins]].<br>
...
<div style="float: left; padding-right: 1em">__TOC__</div>{{DevelopMenu | tutorials}}== Introduction ==
...
In many cases, the plugin or library will '''have its own source code repository''' online somewhere. For instance, in the [[Fiji]] project, plugin code lives in the [https://github.com/fiji Fiji GitHub organization]; e.g., the '''VIB-lib''' library's repository is {{GitHub|org=fiji|repo=VIB-lib|label=VIB-lib}}. This structure allows for easy, independent development of each individual component.
...
By doing this, you will be duplicating the whole repository into your own GitHub account. This way you can freely work on the library with an identical version of the existing repository's master branch.  ''See [https://help.github.com/articles/fork-a-repo GitHub: how to fork a repository] for more details.''

== Clone ==
Next, go to your command line, move to your workspace folder and clone the repository:
<source lang="bash">$ git clone https://github.com/username/VIB-lib</source>
...
''See [https://help.github.com/articles/configuring-a-remote-for-a-fork/ GitHub: how to configure a remote fork] and  [https://help.github.com/articles/syncing-a-fork/ GitHub: how to sync a fork] for more details.''
...
Most of the ImageJ plugins and support libraries are developed as [[Maven]] projects. Developers typically prefer one of the supported [[IDEs|Integrated Development Environments]] to build and run the code.

The most popular IDE is undoubtedly Eclipse, and you can follow [[Eclipse|this tutorial]] to build the plugin or library (you only need to change the URL from the ImageJ repository to the appropriate plugin or library repository URL).

=== Commit early, commit often! ===

Remember to:
<ol>
<li>[https://help.github.com/articles/making-changes Make changes and commit them] to your topic branch</li>
<li>Push the commits to your GitHub repository; e.g.:
<source lang="bash">
...
''See [https://help.github.com/articles/using-pull-requests GitHub: how to send a pull request] for more details.''
...
[[Image:GitHub-discussion-view-tutorial.png|700px]]

== Modifying your commits ==
From the discussion, you might realize you need to modify a part of the changes you made on your branch. Some of the changes introduced by your commits can be fixed with new commits (that will appear in the discussion view of the pull request). But some commits may need to be modified so the history of your repository stays reasonably clean. In that case, you need to use the [https://help.github.com/articles/about-git-rebase/ git rebase command]:

{{Notice|If you prefer using a graphical interface (e.g. Atlassian SourceTree or GitHub Desktop) instead of the command line, there are also options to do an interactive rebase. To force-push your amended commits to the existing branch on github though, the best option is to use the command line, see below.}}
...
* Each line lists a command (by default, pick), the [https://git-scm.com/book/en/v2/Git-Internals-Git-Objects commit hash], and the commit message. The entire git rebase procedure centers around your manipulation of these three columns. The changes you make are rebased onto your repository.
...
Note that the "+HEAD" in this command tells git to overwrite the remote branch, similar to a [http://stackoverflow.com/questions/5509543/how-do-i-properly-force-a-git-push force push].
...
[[Image:GitHub-merge-and-close-pull-request.png|780px]]

== See also ==
This tutorial has been written using the following references:

* [https://help.github.com/articles/fork-a-repo GitHub: how to fork a repository]
* [https://help.github.com/articles/making-changes/ GitHub: making changes]
* [https://help.github.com/articles/using-pull-requests GitHub: how to send a pull request].
* [https://help.github.com/articles/configuring-a-remote-for-a-fork/ GitHub: how to configure a remote fork]
* [https://help.github.com/articles/syncing-a-fork/ GitHub: how to sync a fork]
* [https://help.github.com/articles/about-git-rebase/ GitHub: About Git rebase]
