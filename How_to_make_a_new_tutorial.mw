...
After clicking on {{bc | Plugins | Utilities | Fiji | New Fiji Tutorial}}, you will be asked for the title of your tutorial:

[[Image:How_to_make_a_new_tutorial-PageTitle.jpg]]

You will get two new windows: the ''Snapshot'' winow (which is set to be always on top) and the ''Editor'' window:

[[Image:How_to_make_a_new_tutorial-Editor.jpg|640px]]
...
To take snapshots of modal dialogs (which block events to the ''Snapshot'' window, including a hover), it is more convenient to click on "Snap (3sec delay)" and quickly open the modal dialog.  See also the [[How_to_make_a_new_tutorial#Tip:_use_two_different_Fiji_instances|tip at the end]].

In any of the two modes, the snapshot window will hide itself before taking the snapshot.

[[Image:How_to_make_a_new_tutorial-MakeSnapshots.jpg|640px]]

After taking some or all of the snapshots you want to include in your tutorial, you have to crop them.  Just select the appropriate rectangle, and then click on ImageJ's {{bc | Edit | Crop}} or hit {{key|Ctrl}}+{{key|Shift}}+{{key|X}}:

[[Image:How_to_make_a_new_tutorial-CropSnapshot.jpg]]
...
[[Image:How_to_make_a_new_tutorial-Rename1.jpg]]

This will pop up another dialog which lets you change the name of the image:

[[Image:How_to_make_a_new_tutorial-Rename2.jpg]]

The other method is to select the image and click on ImageJ's {{bc | Image | Rename...}} menu item.
...
[[Image:How_to_make_a_new_tutorial-AddText.jpg|640px]]

== Fourth step: preview ==

Now is the time to preview your work:

[[Image:How_to_make_a_new_tutorial-Preview.jpg|640px]]

The first time you call ''Preview'' (or ''Upload'', whichever comes first), you will be asked for your credentials:

[[Image:How_to_make_a_new_tutorial-Login.jpg|640px]]
...
[[Image:How_to_make_a_new_tutorial-Upload.jpg|640px]]
