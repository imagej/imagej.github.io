{{Project|ImageJ}}<div style="clear: right; float: right">{{Box
| float=right
| text=<h2>ImageJ2's Mission</h2>
...
See also [https://imagej.github.io/presentations/2015-09-03-imagej2-and-fiji/#/4 these presentation slides about ImageJ].
}}</div>ImageJ2 is a new version of [[ImageJ]] for the next generation of multidimensional image data, with a focus on scientific imaging. Its central goal is to broaden the paradigm of ImageJ beyond the limitations of ImageJ 1.x, to support the next generation of multidimensional scientific imaging.
...
The [[Fiji]] distribution of ImageJ has shipped with beta versions of ImageJ2 for quite some time, so you may already be familiar with some of ImageJ2's features—some of which, such as the [[Updater]] and
...
* New commands:
** {{bc | Plugins | Debug | Dump Stack}} for debugging when things [[wikipedia:Hang (computing)|hang]].
** {{bc | Plugins | Debug | System Information}} for reporting on versions of installed plugins and libraries.
...
[[File:Search-bar.png|600px]]

The search bar finds commands, and can search the ImageJ wiki as well as the [http://forum.imagej.net/ ImageJ Forum] if you check those respective checkboxes.

For power users and developers, the search bar supports execution of "code snippets"—single lines of code for performing tasks—by starting the query with <code>!</code>. Any code that works in the [[Script Interpreter]] should be usable as a code snippet.

Developers can extend the capabilities of the search bar by writing [https://github.com/scijava/scijava-search/blob/scijava-search-0.3.1/src/main/java/org/scijava/search/Searcher.java#L36-L46 Searcher] plugins.

=== Improved image I/O with the SCIFIO library ===

ImageJ2 uses the [[SCIFIO]] library (SCientific Image Format Input and Output)  by default for most image input tasks. You can change this behavior at any time by running {{bc | Edit | Options | ImageJ2}} and modifying the ''Use SCIFIO when opening files'' option.
...
== Presentations ==
* 2017-Feb-16 "What's New in ImageJ2?" [ [http://imagej.github.io/presentations/2017-02-16-imagej2-neubias/ slides] ]
* 2015-Sep-03 "The ImageJ2 platform, and the Fiji distribution of ImageJ" [ [https://vimeo.com/140929687 video], [https://imagej.github.io/presentations/2015-09-03-imagej2-and-fiji/ slides] ]
* 2012-Oct-24 "ImageJ2: Current Status and Future Directions" [ [http://conference.imagej.net/2012/curtis-rueden/2012-10-24-imagej-conference.odp slides] ]
* 2010-Oct-27 "ImageJDev: Next Generation ImageJ" [ [http://conference.imagej.net/2010/curtis-rueden/2010-10-27-ImageJDev.pdf slides] ]
