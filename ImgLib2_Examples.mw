...
| maintainer             = Stephan Preibisch, Curtis Rueden
| source                 = {{GitHub | org = imglib | repo = imglib2-tutorials}}
| released               = March 2012
| latest version         = December 2013
| website                = [http://bioinformatics.oxfordjournals.org/content/early/2012/09/07/bioinformatics.bts543.abstract ImgLib2 publication]
}}
{{ImgLibMenu}}
== Jupyter notebook ==

This tutorial is also available in Jupyter notebook form [https://nbviewer.jupyter.org/github/imagej/tutorials/blob/master/notebooks/3-Advanced-Usage/2-ImgLib2-in-Detail.ipynb here]!
...
All examples presented on this page are always entire classes including a main method to run them. Simply copying them into your favorite editor (e.g. the [[Script Editor]]) and compile & run them. The required Java libraries (jar files) are part of ImageJ and can be found in ''ImageJ.app/jars/'':
...
Alternately, you can access the examples from the {{GitHub|org=imglib|repo=imglib-tutorials|label=ImgLib-tutorials Git repository}}. After cloning the source code, open the project in your favorite IDE. See [[Developing ImgLib2]] for further details.
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example1b.java}}
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example1c.java}}
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example1d.java}}
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example2a.java}}
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example2b.java}}
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example2c.java}}
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example3a1.java}}
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example3a2.java}}
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example3a3.java}}
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example3b.java}}
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example4a.java}}
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example4b.java}}
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example5.java}}
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example6a1.java}}
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example6a2.java}}
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example6a3.java}}
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example6a4.java}}
...
[[File:FourierConvolution.jpg|780px]]
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example6b.java}}
...
For the display of complex image data we provide '''Converters''' to display the [http://bioinformatics.oxfordjournals.org/content/19/8/966 gLog] of the power-spectrum (default), phase-spectrum, real values, and imaginary values. It is, however, straight forward to implement you own '''Converters'''.
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example6c.java}}
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example7.java}}
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example8a.java}}
...
[[File:SparseImage2.jpg|638px]]<br>
...
{{GitHubEmbed|org=imglib|repo=imglib-tutorials|source=Example8b.java}}
