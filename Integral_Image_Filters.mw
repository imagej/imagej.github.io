...
}}{{#widget:YouTube|id=p1mhZqj2VTY|width=400}}
...
Integral images have been introduced in by Crow (1984)<ref>{{cite conference
 ...
 | year = 1995
}}</ref>, the [[wikipedia:Viola%E2%80%93Jones object detection framework|Viola-Jones object detection framework]]<ref>{{cite journal
 | first1 = Paul
 | last1 = Viola
 | first2 = Michael J.
 | last2 = Jones
 ...
 | number = 2
 | year = 2004
}}</ref>, and the [[wikipedia:SURF|Speeded Up Robust Feature (SURF)]] transform<ref>{{cite journal
 | first1 = Herbert
 | last1 = Bay
 | first2 = Andreas
 | last2 = Ess
...
<div style="float: right">{{#widget:YouTube|id=MZfnTL9e_fA|width=340}}</div>
