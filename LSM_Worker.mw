<B>LSM-W2 manual</B>
<BR>
[[File:Untitled-7_small.png |200px|thumb|right]]
<P CLASS="western" STYLE="margin-bottom: 0cm"><FONT SIZE=4><SPAN LANG="en-US"><I><B>LSM-W2
...
You can [https://imagej.net/Following_an_update_site follow an update site] 	with URL http://sites.imagej.net/Bionet.nsc/ (LSM-W2 in the [https://imagej.net/List_of_update_sites#Available_update_sites Optional Update Sites]).</SPAN></FONT></P>
...
<UL>
	<LI><P CLASS="western" ALIGN=JUSTIFY STYLE="margin-bottom: 0cm"><FONT SIZE=3><SPAN LANG="en-US">If necessary, you can reduce
...
main window of LSM-W2</B></FONT></P>
...
<FONT SIZE=3>Fig.2 Main window of the LSM-W2 plugin</FONT></P>
<P LANG="en-US" CLASS="western" ALIGN=JUSTIFY STYLE="margin-bottom: 0cm">
<BR>
</P>
...
[https://imagej.net/Morphological_Segmentation Morphological Segmentation]
integrated into LSM-W2 implements the segmentation of the image.
...
<OL>
				...
				back to the window of LSM-W2 plugin.</SPAN></FONT></FONT></FONT></FONT></P>
				<LI><P STYLE="margin-bottom: 0cm; background: #ffffff; line-height: 115%">
...
Morphological_Segmentation, integrated with LSM-W2. An additional
...
<P CLASS="western" STYLE="margin-bottom: 0cm"><FONT SIZE=3><B>A. </B><SPAN LANG="en-US">Run LSM-W2 and open original 3D image. </SPAN></FONT>
</P>
