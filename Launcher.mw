...
The launcher is a native executable whose purpose is to start up a Java Virtual Machine and run ImageJ 1.x, Fiji or ImageJ2 in it. It is used in the [[Fiji]] distribution as well as in [[ImageJ2]].
...
{|
| [[Image:Win.png | alt=Windows (32-bit) | link=http://maven.imagej.net/service/local/artifact/maven/redirect?r=snapshots&g=net.imagej&a=imagej-launcher&v=LATEST&e=exe&c=win32 | x24px]] [http://maven.imagej.net/service/local/artifact/maven/redirect?r=snapshots&g=net.imagej&a=imagej-launcher&v=LATEST&e=exe&c=win32 ImageJ-win32.exe]
| [[Image:Win.png | alt=Windows (64-bit) | link=http://maven.imagej.net/service/local/artifact/maven/redirect?r=snapshots&g=net.imagej&a=imagej-launcher&v=LATEST&e=exe&c=win64 | x24px]] [http://maven.imagej.net/service/local/artifact/maven/redirect?r=snapshots&g=net.imagej&a=imagej-launcher&v=LATEST&e=exe&c=win64 ImageJ-win64.exe]
| [[Image:Osx.png | alt=MacOS | link=http://maven.imagej.net/service/local/artifact/maven/redirect?r=snapshots&g=net.imagej&a=imagej-launcher&v=LATEST&e=exe&c=macosx | x24px]] [http://maven.imagej.net/service/local/artifact/maven/redirect?r=snapshots&g=net.imagej&a=imagej-launcher&v=LATEST&e=exe&c=macosx ImageJ-macosx]
| [[Image:Tux.png | alt=Linux (64-bit) | link=http://maven.imagej.net/service/local/artifact/maven/redirect?r=snapshots&g=net.imagej&a=imagej-launcher&v=LATEST&e=exe&c=linux64 | x24px]] [http://maven.imagej.net/service/local/artifact/maven/redirect?r=snapshots&g=net.imagej&a=imagej-launcher&v=LATEST&e=exe&c=linux64 ImageJ-linux64]
|}

After download, rename to match the filename given above. For MacOS and Linux binaries, set the executable bit using <code>chmod +x</code>. Then replace the launcher with the new one, keeping a backup of the previous launcher in case the new one does not work.
