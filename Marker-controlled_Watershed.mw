...
|style="vertical-align:top" |[[Image:Watershed-flooding-markers-blobs-gradient.gif|thumb|300px|Marker-controlled flooding on the gradient image of the blobs sample.]]
|}
...
== Usage == 
[[Image:Marker-controlled-Watershed-dialog.png|thumb|300px|right|Main dialog of the Marker-controlled Watershed plugin]]
...
[[Image:Arabidopsis-nucleus-segmentation.png|thumb|center|740px|Example of marker-controlled watershed segmentation on nucleus of ''Arabidopsis thaliana'' (image courtesy of Kaori Sakai and Javier Arpon, INRA-Versailles)]]
...
== See also ==
* [[Interactive Marker-controlled Watershed]], same idea as this plugin but with user-defined seed points.
