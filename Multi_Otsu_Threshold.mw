...
| filename               = Multi_OtsuThreshold.class
| source                 = [https://imagej.net/plugins/download/Multi_OtsuThreshold.java Multi_OtsuThreshold.java]
| released               = 14 April 2006
| status                 = stable
| category               = [[:Category:Segmentation|Segmentation]]
| website                = [https://imagej.net/plugins/multi-otsu-threshold.html]
}}
...
Image:Blobs_MultiOtsu_1.png|First class: the dark pixels as background
Image:Blobs_MultiOtsu_2.png|Second class: the intermediate pixels delineate the edges
Image:Blobs_MultiOtsu_3.png|Third class: the bright pixels form the blobs centers
</gallery>
