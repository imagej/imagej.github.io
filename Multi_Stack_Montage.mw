...
| filename               = Multi_Stack_Montage.jar
| released               = August 2015
| latest version         = August 2015
| source                 = {{GitHub|org=PTBIOP|repo=ijp-multi-stack-montage}}
| status                 = stable
| category               = [[:Category:Plugins|Stacks|Montage|Visualization]]
...
== Installation == 
This plugin is available from the {{ListOfUpdateSites|PTBIOP Update Site}}
...
[[File:Hyperstacks_Montage_menu.jpg|400px|thumb|right|Interface of the plugin]]


{{Warning |If you are going to make a montage, you need each stack to be as follows:
...
[[File:Hyperstacks_Montage_example.jpg|400px|thumb|right|Example on RGB Stacks. Also works on multichannel, multislice, timepoints and any combination]]
