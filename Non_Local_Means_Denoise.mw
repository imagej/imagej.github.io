...
You could simply use our update site "[https://fiji.sc/List_of_update_sites biomedgroup]" to install the non local means plugin or copy the jar file into your plugins folder.
