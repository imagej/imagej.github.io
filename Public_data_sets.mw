...
* [http://figshare.com/articles/Segmented_anisotropic_ssTEM_dataset_of_neural_tissue/856713 Segmented anisotropic ssTEM dataset of neural tissue]
...
:All the data and further information is available in the {{GitHub|org=unidesigner|repo=groundtruth-drosophila-vnc|label=GitHub repository}}.

* [http://www.ini.uzh.ch/~acardona/data.html Segmented ssTEM stack of neural tissue], thanks to Albert Cardona.
[[File:TrakEM2-tree-datastructure.png|thumb]]
[[File:TrakEM2-display-s.jpg|thumb]]
...
:See other [http://www.incf.org/about/nodes/switzerland/data manually segmented serial section TEM data sets.]

* [http://loci.wisc.edu/software/sample-data Sample data at LOCI], in a variety of file formats.

* [http://www.openmicroscopy.org/site/support/file-formats/ome-tiff/ome-tiff-data Sample OME-TIFF data on openmicroscopy.org], thanks to Josh Bembenek.[[File:tubhiswt4D.png|right|140px|''C. elegans'' embryo coexpressing tubulin histone GFP]]
...
* [https://fiji.sc/datasets/migrating-macrophages.tif.tar.bz2 Migrating macrophages] in response to stimuli.
:4D data set, kindly provided by Dirk Sieger and [http://www.embl.de/research/units/dev_biology/peri/ Francesca Peri], EMBL.[[File:Migrating-macrophages.gif|right|140px|Macrophages in 4D]]
...
* [http://www.cellimagelibrary.org/ The Cell Image Library] has many images related to cell biology; the images come with one of 4 licenses: Public Domain, Creative Commons Attribution, Creative Commons Attribution Non-Commercial Share-Alike, and Copyrighted (you need to ask the contributor whether you may use their image explicitly). This website allows you to contribute your own data sets, too!

* [http://openconnectomeproject.org/ Open Connectome Project] hosts a 10 terabyte data set of the [http://openconnectomeproject.org/catmaid/?pid=4&zp=45&yp=268892&xp=256060&sid0=4&s0=8 mouse visual cortex] ([http://www.nature.com/nature/journal/v471/n7337/full/nature09802.html Bock et al., 2011]) with [http://www.catmaid.org/ CATMAID], and will offer means to run arbitrary programs on the data very soon.

* [https://www.epfl.ch/labs/cvlab/data/data-em/ A 3D electron microscopy dataset of rodent brain], courtesy of [http://people.epfl.ch/graham.knott Graham Knott] and Marco Cantoni at EPFL. In particular, a FIBSEM volume measuring 5x5x5 micrometers and taken from the CA1 hippocampus region of the brain, and imaged at the extraordinary resolution of 5x5x5 nanometers per voxel! In addition, Aurelien Lucchi from [http://people.epfl.ch/pascal.fua/bio?lang=en Pascal Fua]'s lab has made available, in the same page, image volumes contaning labels for mitochondria.

* [http://www.broadinstitute.org/bbbc/ Broad Bioimage Benchmark Collection]: annotated biological image sets for testing and validation. Collection of freely downloadable microscopy image sets. In addition to the images themselves, each set includes a description of the biological application and some type of "ground truth" (expected results).
