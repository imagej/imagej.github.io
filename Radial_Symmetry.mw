== Download == 
The Radial Symmetry plugin can be downloaded from the [http://sites.imagej.net/milkyklim update site]. After that it will appear in the 'Plugins' menu under 'Radial Symmetry Localization'.
...
[[File:Calculate-anisotropy-coefficient.png|x300px|center]]
...
[[File:Adjust-difference-of-gaussian-values.png|x300px|center]]

[[File:One-spot-overlay.png|x500px|center]]
...
[[File:Radial-symmetry-initital-gui-ransac-on.png|x500px|center]]
...
[[File:Interactive-adjust-ransac-values.png|x500px|center]]
...
File:Multipe-dots-interactive-dog-rs-roi.png|Pre-detecions
File:Multipe-dots-interactive-error-ransac.png|RANSAC Support Regions
</gallery>
...
[[File:Histogram-detections.png|x400px|center]]

[[File:Results-interactive.png|x400px|center]]
...
<gallery mode="packed" heights=500px >
File:Inliers-ransac.png|RANSAC Support Regions
File:Multiple-dots-detections.png|Detected Spots
</gallery>
...
[[File:Manual-set-parameters.png|x400px|center]]
