...
=Tracing=
These instructions assume that you have read the [[SNT: Overview|Overview]] page, including starting up the plugin, enabling [[SNT:_Overview#Auto-snapping|Cursor Auto-snapping]], and [[SNT:_Overview#Auto-tracing|Auto-tracing]] options. This section is also documented in a [[SNT:_Screencasts#Introduction_To_Tracing|Screencast]].
...
<div align="center">
<ul> 
<li style="display:inline-block;"> [[Image:Snt-cropped-confirmation-2.png|none|thumb|400px|A* search completed]] </li>
<li style="display:inline-block;"> [[Image:Snt-cropped-confirmed-2.png|none|thumb|400px|A confirmed segment]] </li>
<li style="display:inline-block;"> [[Image:Snt-cropped-completed-path-2.png|none|thumb|400px|A completed path]] </li>
</ul>
</div>
...
[[Image:Snt-sb-selecting-by-G.gif|center|thumb|600px|[[SNT:_Key_Shortcuts#Path_Handling|Holding 'G']] (''Group paths around cursor'') will select the closest path to the mouse pointer]]
...
<div align="center">
<ul> 
<li style="display:inline-block;"> [[Image:Snt-sb-temporary-path-2.png|none|thumb|400px|1) Temporary path branching-off]] </li>
<li style="display:inline-block;"> [[Image:Snt-sb-confirmed-path-2.png|none|thumb|400px|2) Temporary path confirmed]] </li>
<li style="display:inline-block;"> [[Image:Snt-sb-completed-branch-2.png|none|thumb|400px|3) Branched (child) path completed]] </li>
</ul>
</div>
...
[[File:display-filtered-image.png|center|thumb|400px|Secondary Image MIP]]
...
The same process can be accomplished more completely in a script using [[ImageJ_Ops|ImageJ Ops]]. For example, in Jython:
<source lang="python">
# @ImageJ ij
