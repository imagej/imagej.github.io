...
== Important Note ==
{{Warning | '''''Please Note: This version of the software is outdated. It will be part of Fiji for the time being, but I highly recommend using the new [[Multiview-Reconstruction|Multiview Reconstruction Plugin]]. It is much more powerful, flexible and completely integrated with the [[BigDataViewer]].'''''}}
