...
An example JRuby script, which needs to be customized to be useful to you - the source code is {{GitHub|repo=fiji|path=plugins/Examples/Same_Slice_in_Multiple_Images.rb|label=here}}.
