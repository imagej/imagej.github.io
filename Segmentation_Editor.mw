...
| filename               = VIB_.jar
| source                 = {{GitHub|org=fiji|repo=VIB|source=Segmentation_Editor.java}}
| status                 = stable
...
{{#widget:YouTube|id=tC-b-BFq6jk|width=420}}
...
[[File:Segmentation_Editor_1.png]]
...
[[File:Segmentation_Editor_2.png]]
...
[[File:Segmentation_Editor_medulla_r_labels_rotating.gif]]
