...
| filename               = VIB_.jar
| source                 = {{GitHub|org=fiji|repo=3D_Viewer|source=isosurface/Show_Colour_Surfaces.java}}
| status                 = stable
}}
...
The ''Show Color Surfaces'' command calculates surfaces embedded into the [[3D Viewer]] from label fields:

[[Image:Show-color-surfaces-reduced.png]]

== Menu path ==
{{bc | Plugins | Process | Show Color Surfaces}}
