...
| software               = FIJI
| name                   = StereoMate
| author                 = {{Person|stevenjwest}}
| maintainer           = {{Person|stevenjwest}}
| filename               = Stereo_Mate.jar
| source                 = [https://github.com/stevenjwest/StereoMate]
| released               = August 2019
| status                 = stable
| website                = [https://imagej.net/plugins/stereomate.html]
}}
