...
| software               = tapas
| update site            = TAPAS
| author                 = {{Person|Tboudier}}
| maintainer             = [https://github.com/mcib3d Thomas Boudier] 
| source                 = {{GitHub|org=mcib3d|repo=tapas-core}}
| released               = 14/08/2019, V0.4
| latest version         = 22/06/2020, V0.6.3
| status                 = stable, active
| category               = [[:Category:Automation|Automation]], [[:Category:Analysis|Analysis]], [[:Category:Filtering|Filtering]], [[:Category:Segmentation|Segmentation]]
}}
...
== Features ==
Basically we will propose modules from the [[3D_ImageJ_Suite]], ImageJ/Fiji, along with other modules.
...
* Install [[3D_ImageJ_Suite]]. It is also available as a update site in Fiji. '''ImageScience''' should be installed too, either from [http://www.imagescience.org/meijering/software/featurej/ here] or via the update site in Fiji.
...
* Download [[File:Bundle-tapas0.6.3.zip]] and unzip it into the ImageJ or Fiji directory.
...
A list of tutorials :
* Basic '''Input/Ouptput''' functionalities [https://imagejdocu.list.lu/plugin/utilities/tapas_tutorial/input_output_i/start here].
* Create your first '''processing pipeline'''  [https://imagejdocu.list.lu/plugin/utilities/tapas_tutorial/create_your_processing_pipeline/start here].
* '''Segmentation''' modules [https://imagejdocu.list.lu/plugin/utilities/tapas_tutorial/segmentation/start here]. 
* '''Measurement''' modules  [https://imagejdocu.list.lu/plugin/utilities/tapas_tutorial/measurement/start here]. 
* '''Signal quantification''' and '''numbering''' modules  [https://imagejdocu.list.lu/plugin/utilities/tapas_tutorial/signal_quantification/start here]. 
* '''Co-localisation''' [https://imagejdocu.list.lu/plugin/utilities/tapas_tutorial/colocalisation/start here].
* How to use the '''analyzeParticles''' module for segmentation and measurement [https://imagejdocu.list.lu/plugin/utilities/tapas_tutorial/2d_measurements_with_analyze_particles/start here].
* How to quantify '''layers distribution''' [https://imagejdocu.list.lu/plugin/utilities/layers_analysis/start here].

The list of available modules is described in [[File:Tapas_description0.6.3.pdf]].

== Citation ==
2018 Whitehead, L., Wimmer, V., Lafouresse, F., Ratnayake, D., Currie, P., Groom, J., Rogers, K. and
Boudier, T. Towards an Automated Processing and Analysis System for multi-dimensional light-sheet
microscopy big data using ImageJ and OMERO. International Microscopy Congress IMC 19. ([[File:Abstract_1848_thomasboudier.pdf]])

== License ==
Version 0.5 and later are under GPL distribution (see [http://www.cecill.info/licences/Licence_CeCILL_V2.1-en.html license]). 

Source code is available on '''github''' : [https://github.com/mcib3d/tapas-core tapas-core], [https://github.com/mcib3d/tapas-plugins tapas-plugins].
