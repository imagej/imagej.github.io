...
Starting v5.1.0, please look at the gihub page for TrackMate releases:
https://github.com/fiji/TrackMate/releases


This page contains the version history for the [[TrackMate]] plugin.
...
* [[TrackScheme]] can change of display style.
...
[[2013-02-25 - TrackMate v2.0.0 released|Major update]]:
...
* The 'Load' button was removed from the GUI. TrackMate files can be loaded from the {{bc | Plugins | Tracking | Load a TrackMate file}} menu item.
* T/here is a new {{bc | Plugins | Tracking | Manual tracking with TrackMate}} menu item, that launched another GUI stripped down for manual editing. 
...
* Icy XML track files can be opened in TrackMate. Just point the TrackMate loader plugin to such a file, and its type will be detected and it will be opened in TrackMate. We would like to express our thanks to {{Person|Fab14}} for his help in developing these two features. 
...
TrackMate version bumped by several increments, prompted by the [[2014-12-10 - ImgLib2 released|big update]] that happened to Fiji between this and the previous release. Some minor bugfixes and improvements are shipped nonetheless. 
