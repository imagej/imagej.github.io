<div style="text-align: center;">
 <div style="font-size: 150%;">FUZZY SET INTENSITY TRANSFORMATIONS</div>
</div>
<br>
<div style="text-align: center;">
 <div style="font-size: 150%;">USER GUIDE</div>
</div>
...
To use our software to transform images, the user must install the software onto their own device.  We assume that our users are experienced computer users and have some familiarity with using a browser software such as Google Chrome to link to the fiji website.  We would also like to note that every computer will behave somewhat independently and the use of these instructions must be applied with some flexibility and adaptability.  
Begin by opening a browser window on your device.  Connect to the fiji website via the URL address:  http://fiji.sc/.  Navigate to the appropriate download to meet your operating system requirements, and follow the directions from the website.  Notes when downloading Image J:<br>
...
<div style="text-align: center;">
[[File:LaunchingPlugin.jpg]] 

[[File:LaunchingPlugin2.jpg]]
</div>
A user may now set the appropriate user defined values.
<div style="text-align: center;">
[[File:SelectValues.jpg]] 
</div>
...
<div style="text-align: center;">
[[File:ModifiedHistogramWindow.jpg]]
...
We did many experiments with the application, but to show case one such result, we have included a demo below. 
[[File:2.jpg]] [[File:ModAE.jpg]]
<div>
[[File:Hist2.jpg]] Histogram of Image Before Transformation
</div>
[[File:HistMod.jpg]] Histogram of Image After Transformation

== ACKNOWLEDGEMENTS ==
<div style="text-align: center;">
[[File:Dr.jpg]]
</div>
We would like to thank our professor [http://faculty.tamuc.edu/nsirakov/ Dr. Nikolay Sirakov], [http://www.tamuc.edu/ Texas A&M-Commerce].  Under his tutelage and guidance we were able to transform a class project into a shared application for the ImageJ community.  Special thanks to [mailto:pavan.kumar.pic@gmail.com Pavan Kumar], our coding partner, who developed the application for the plugin.  In addition, we wish to thank Robert Erger and Beverly Baird, the math team, for assistance in developing the algorithm and providing the documentation.  

Contact Person:  [mailto:rerger@leomail.tamuc.edu Email Robert Erger]
