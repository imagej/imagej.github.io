...
| author                 = [https://imagej.net/User:LMCF-IMG Martin Čapek]
| maintainer             = Martin Čapek
| source                 = {{GitHub|org=LMCF-IMG|repo=Wavelet_Denoise}}
| released               = 04/09/2020
...
• <i>Suppress Detail. Coeffs. (DC) – applied with “Suppress AC”</i>:
...
• If you do not see data in image windows well, use {{bc | Image | Adjust-Brightness/Contrast | Auto}}. Do not press <i>Apply</i> for pixel intensity value recomputation.

== Step-by-step manuals ==

'''<u>How to use the plugin for denoising/filtering small data:</u>'''

([https://imagej.net/_images/c/ce/SIM_Lamina_32bit_488_Honeycomb_StrongBckg_Scale-0_25.zip SIM_Lamina_32bit_488_Honeycomb_StrongBckg_Scale-0_25.tif - 7 MB])

1. Open an image/stack.

2. Run {{bc | Plugins | Wavelet_Denoise}}.

3. Arrange positions of <i>Wavelet_Denoise</i> main window and <i>Synchronize Windows</i> dialog in the screen.

4. Run {{bc | Window | Tile}}.
...
([https://imagej.net/_images/e/e8/SIM_Lamina_32bit_488_Honeycomb_StrongBckg.zip SIM_Lamina_32bit_488_Honeycomb_StrongBckg.tif - 73 MB])
...
1. Use LMCF-IMG update site in Fiji. More about installing Fiji plugins using update sites can be found [https://imagej.net/Following_an_update_site here]. 

2. Download Wavelet_Denoise.jar file from [https://github.com/LMCF-IMG/Wavelet_Denoise GitHub] and put it into plugins in ImageJ/Fiji folder.
