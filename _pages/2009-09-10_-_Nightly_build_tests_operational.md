...
-   Only the main project is built (*fiji.git*; subprojects, such as [TrakEM2](TrakEM2) are not being rebuilt).
-   To ensure compatibility with [32-bit MacOSX](MacOSX_tips), we build against Java 5 (update 19, to be precise).
