...
I've broken the Java/Python interface into 3 pieces:
  ...
  - [Bio-Formats](Bio-Formats "wikilink") wrapper (bioformats.formatreader): this module has wrappers for some of the Bio-Formats classes. It's pretty easy to create both ImageReaders and FormatReaders (for instance ChannelSeparator).
