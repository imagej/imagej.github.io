...
Daniel Sage's MIJ library to use Fiji/ImageJ from within [MATLAB](MATLAB "wikilink") is included with Fiji now. Just add Fiji.app/scripts/ to the search path and call *Miji*.
