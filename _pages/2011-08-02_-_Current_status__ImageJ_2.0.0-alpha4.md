...
![**Math plugins:** ImageJ2 math plugins.](/images/pages/Math-plugins.png "Math plugins: ImageJ2 math plugins.") We have reimplemented many ImageJ1 plugins within the ImageJ2 [extensibility framework](extensibility "wikilink"). These plugins illustrate some of the features of ImageJ2, and serve as examples for how to bring legacy plugins up to date.
