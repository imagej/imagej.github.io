...
* There is a new {{bc | Plugins | Tracking | Manual tracking with TrackMate}} menu item, that launched another GUI stripped down for manual editing. 
...
{{Person|JeanYvesTinevez}} ([[User talk:JeanYvesTinevez|talk]]) 05:03, 5 August 2013 (CDT)
