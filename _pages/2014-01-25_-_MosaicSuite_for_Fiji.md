...
This process has started and one example is the MosaicSuite of image processing algorithms developed by the [http://mosaic.mpi-cbg.de/?q=welcome MOSAIC group] headed by Ivo Sbalzarini at [http://www.mpi-cbg.de/en/research/research-groups/ivo-sbalzarini.html MPI-CBG in Dresden]. The suite includes tools for segmentation, particle tracking and more. Some of the algorithms are described in these papers: 
...
All information on how to install the tools, documentation and developer information is available on the [http://mosaic.mpi-cbg.de/?q=downloads/imageJ MOSAIC group website].

The plugins are available in Fiji through a dedicated {{ListOfUpdateSites|'''update site'''}}.
