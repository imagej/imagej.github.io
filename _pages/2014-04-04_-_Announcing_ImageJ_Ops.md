...
We sincerely hope that the Ops project will make it much easier for various software tools (e.g.: [KNIME](KNIME ), CellProfiler, OMERO, Alida, Icy, Vaa3D and of course ImageJ itself) to provide drop-in support for ImageJ's image processing operations, allowing scientists to truly "write once, run anywhere" and share with the world!
...
-   Martin, Christian et al: Ported existing ops from [ImgLib2](ImgLib2 ) and [KNIME](KNIME ) to imagej-ops
...
Thank you so much to the [KNIME](KNIME ) team for making all of this possible!!
