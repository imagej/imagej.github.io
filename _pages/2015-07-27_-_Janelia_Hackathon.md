From Sunday, July 27, 2015 through Friday, July 31, 2015, {{Person|Saalfeld}} at HHMI Janelia in Ashburn, Virginia hosted [[LOCI]]'s {{Person|Rueden}} and {{Person|Hinerm}} for a hackathon to unify [[SCIFIO]]/[[ImgLib2]] development efforts (with MPI-CBG's {{Person|Pietzsch}}), improve support for the [https://bitbucket.org/fernandoamat/keller-lab-block-filetype Janelia KLB format] (with Janelia's Burkhard Hoeckendorf), and improve the development tools available for [[Fiji]] developers.
...
* Curtis made some ImageJ improvements in response to feedback from Burkhard [[https://github.com/imagej/imagej-plugins-commands/commit/6fafbc9c3444e3fe70420244699d02acfb72abfd 2], [https://github.com/imagej/imagej-plugins-commands/commit/ea9596b2d905eff9f7a9b2177dca5fe44b65ae6e 3]].
...
* Mark began work on ImageJ data model changes for SCIFIO "blockization" [[https://github.com/imagej/imagej-common/compare/calibrated-interval 5], [https://github.com/scifio/scifio/compare/blocks-are-so-plane 6]].
