...
| author                 = {{Person|Tboudier}}, Jean Ollion
| maintainer             = [https://github.com/mcib3d Thomas Boudier] 
| source                 = {{GitHub|org=mcib3d|repo=mcib3d-core}}
| released               = 25/09/2012, V2.0
| latest version         = 30/10/2019, V3.96
| status                 = stable, active
| category               = [[:Category:3D|3D]], [[:Category:Analysis|Analysis]], [[:Category:Filtering|Filtering]], [[:Category:Segmentation|Segmentation]], [[:Category:Mathematical_morphology|Mathematical morphology]]
}}

== 3D ImageJ Suite ==
This ''suite'' provides plugins to enhance 3D capabilities of ImageJ.

Migrating contents from [https://imagejdocu.list.lu/plugin/stacks/3d_ij_suite/start 3D Suite on ImageJ Documentation Website]. 

The pdf of the [http://eubias.org/NEUBIAS/training-schools/neubias-academy-home/ NEUBIAS academy] presentation "''Introduction to 3D Analysis with 3D ImageJ suite''" is available : [[Media:NEUBIAS_3DSuite.pdf]]. 

The associated video is available on [https://www.youtube.com/watch?v=OPC2kP-5By4 YouTube]. The QAs are available on the [https://forum.image.sc/t/neubias-academy-home-webinar-introduction-to-3d-analysis-with-3d-imagej-suite-questions-answers/39027 image.sc forum].

The associated project for automation is available in [[TAPAS]].

== Author ==
{{Person|Tboudier}}  [[File:EmailBoudier.png]], [https://www.sinica.edu.tw/en Academia Sinica], Taipei, Taiwan.
...
* [https://imagejdocu.list.lu/plugin/stacks/3d_roi_manager/start 3D RoiManager] (3D display and analysis of 3D objects)
* [https://imagejdocu.list.lu/plugin/analysis/3d_analysis/start 3D Analysis] (Geometrical measurements, Mesh measurements, Convex hull, ...)
* [https://imagejdocu.list.lu/plugin/analysis/3d_mereotopology/start 3D MereoTopology] (Relationship between objects)
* [https://imagejdocu.list.lu/plugin/stacks/3d_tools:start 3D Tools] (Drawing ellipsoids and lines, cropping, ...)

A 2D/3D [https://imagejdocu.list.lu/plugin/analysis/spatial_statistics_2d_3d/start spatial statistics] plugin is also available.
...
Java 1.8 or later is required. '''The [http://www.imagescience.org/meijering/software/featurej/ imagescience] library is required ''' : [http://www.imagescience.org/meijering/software/download/imagescience.jar download here].
...
== License ==
GPL distribution (see [https://cecill.info/index.en.html license]). Sources available on Github (see Download)

== Acknowledgements ==
The 3D suite would like to thanks the developers of the following plugins : 
* [http://www.imagescience.org/meijering/software/featurej/ Imagescience]  
* [http://www.optinav.com/Local_Thickness.htm LocalThickness]
* [http://rsbweb.nih.gov/ij/plugins/3d-convex-hull/index.html ConvexHull3D]
* [https://imagejdocu.list.lu/plugin/analysis/3d_object_counter/start 3D Object Counter]
* [https://imagejdocu.list.lu/plugin/analysis/droplet_counter/start Droplet Counter] 
* and P. Andrey, J.-F. Gilles.

== Links ==
* [[BoneJ2]]
* [https://sites.google.com/site/learnimagej/plugins/3d-shape 3D Shapes]
* [https://imagejdocu.list.lu/plugin/utilities/annotation_roi_3d/start 3D Annotation Tool]
* [[3D Viewer]]
* [[MorphoLibJ]]
