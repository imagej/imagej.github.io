...
{% endcapture %}
{% include info-box software='Fiji ' name='3Dscript ' maintainer=maintainer author=author source=source status='active ' released='January 2019 ' category='[Visualization](_Category_Visualization ), [:Category:Plugins](_Category_Plugins ) ' %}
