...
The fastest way to start batch conversion is via the [https://imagej.net/docs/guide/146-29.html#toc-Subsubsection-29.12.3 {{bc | Process | Batch | Macro...}}] command. This will open a dialog (below) that will allow you to specify an input and output directory. You can select an output file format, and then use the <code>Add Macro Code</code> drop-down to generate a macro with the desired functionality.
...
[[Image:Process_folder_ij1.png|center|762px]]
...
* [https://imagej.net/docs/guide/146-29.html#toc-Subsection-29.12 {{bc | Process | Batch}}] submenu.
* [[Scripting]] documentation and tutorials.
* [[How to apply a common operation to a complete directory]]
* [[Keyboard shortcuts#Creating_your_own_keyboard_shortcuts|Assign your own keyboard shortcuts]]
