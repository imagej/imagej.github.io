...
The deconvolution can be started by selecting the views you wish to deconvolve and selecting {{bc|Processing|(MultiView) Deconvolution}} in the main menu in '''MultiView mode'''.
...
[[File:BigStitcher_Deconvolution_Main.png|center|600px]]

Since you are also producing a fused image for the deconvolution, some parameters are the same as in [[BigStitcher_Fuse]]:
...
* '''Use Tikhonov regularization''' and '''Tikhonov parameter''': By activating Tikhonov regularization, and setting the Tikhonov parameter to <math>>0</math> you can penalize large changes in the iterations. This way, the deconvolution is less prone to amplify noise but the results will generally be less sharp.
...
[[File:BigStitcher_Deconvolution_fromFile.png|center|600px]]
...
[[File:BigStitcher_Deconvolution_blocksize.png|center|600px]]

=== Blending & grouping parameters ===



[[File:BigStitcher_Deconvolution_blending.png|center|600px]]

=== Debug mode ===


[[File:BigStitcher_Deconvolution_debug.png|center|600px]]

=== Deconvolution on GPU ===

== Usage of Previous version ==

As this usage guide is still work in progress, please refer to [[Multi-View_Deconvolution]] for now.
