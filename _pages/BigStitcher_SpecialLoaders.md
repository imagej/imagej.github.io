...
{% endcapture %}
{% include thumbnail src='/images/pages/BigStitcher CZI Import1.png' title=title %}
...
{% endcapture %}
{% include thumbnail src='/images/pages/BigStitcher CZI Import2.png' title=title %}
...
{% endcapture %}
{% include thumbnail src='/images/pages/BigStitcher CZI Import3.png' title=title %}
