...
{% include thumbnail src='/images/pages/BigStitcher Stack Import1.png' title='Step 1: Defining attributes of data in Manual loader.'%}

### Step 2: File pattern and additional options

#### File pattern

{% include thumbnail src='/images/pages/BigStitcher Stack Import2.png' title='Step 2: Defining file pattern and additional options.'%}
...
{% include thumbnail src='/images/pages/BigStitcher Stack Import3.png' title=' Verification of files in dataset.'%}
...
{% include thumbnail src='/images/pages/BigStitcher Stack Import4.png' title='Step 3: Verifying/modifying calibration.'%}
