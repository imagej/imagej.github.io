...
| name                   = Bio7
| software               = Bio7
| logo = [[File:Bio7-icon.png|96px]]
| author                 = [mailto:ed.leik-inu.vu@dlefnetsuam Marcel Austenfeld]
| maintainer             = [mailto:ed.leik-inu.vu@dlefnetsuam Marcel Austenfeld]
| source                 = {{GitHub | org=Bio7 | repo=bio7}}
| status                 = Active
