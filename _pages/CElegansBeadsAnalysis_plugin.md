...
The plugin can be downloaded from: [[File:Celegans beads analysis-1.0.0.jar.zip]]. Its usage is described in the next section and its source code can be accessed on [https://git.mpi-cbg.de/bioimage-informatics/cElegansBeadsAnalysis MPI-CBG git repository]
