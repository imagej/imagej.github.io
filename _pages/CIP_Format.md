...
    `img2 = cip.duplicate( img1 , 'origin', [300,200], 'size', [150,150] )` <img src="/media/CIP_duplicate.PNG" title="fig:CIP_duplicate.PNG" width="400" alt="CIP_duplicate.PNG" />  
<span style="font-size:110%">**Implementation**</span>  
...
<span style="font-size:110%">**Example**</span>  
    `img2 = cip.slice( img1 , 'dimension', 2, 'position', 0 )` <img src="/media/CIP_slice.PNG" title="fig:CIP_slice.PNG" width="400" alt="CIP_slice.PNG" />  
<span style="font-size:110%">**Implementation**</span>  
...
<span style="font-size:110%">**Example**</span>  
    `img2 = cip.project( img1 , 'dimension',2 )` <img src="/media/CIP_project.PNG" title="fig:CIP_project.PNG" width="400" alt="CIP_project.PNG" />  
<span style="font-size:110%">**Implementation**</span>  
