...
{% endcapture %}
{% include info-box name='CSIM Laboratory ImageJ ' software='Fiji ' author=author maintainer=maintainer source=source released='February 01<sup>st</sup>, 2015 ' latest-version='February 01<sup>st</sup>, 2015 ' status='experimental, active ' category='[Plugins](Category_Plugins ), [Filtering](Category_Filtering ), [Feature](Category_Noise_Generator ) ' %}== Purpose ==
...
{% include thumbnail src='/images/pages/CSIM-logo.png' title='CSIM Laboratory. See more details about our research group in the web site: [http://dcm.ffclrp.usp.br/csim'%}](http://dcm.ffclrp.usp.br/csim'%})
...
Please see the [Perfusion MRI wiki page](https://imagej.net/MRIPerfusion) for this specific method.
...
See the [SampEn2D wiki page](https://imagej.net/SampEn2D) to find out more information about this PlugIn.
