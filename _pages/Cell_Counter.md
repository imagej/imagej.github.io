{{ComponentStats:sc.fiji:Cell_Counter}}This plugin will open a new cell counter GUI. On the left are the counter types and counters, on the right the action buttons.

{{Notice|Please consider using the built-in [https://imagej.net/docs/guide/146-19.html#sec:Multi-point-Tool Multi-Point Tool] in ImageJ, as this tool now replicates most of the functionality of Cell Counter.}}
...
Note that at any time you can add types or remove them. Select the type you want to count, and count by clicking on the feature in the image. A colored number corresponding to the type you are counting will be displayed on the image every time you click, and the corresponding counter is updated.
...
* <u>2008/02/29</u>: Updated to work with [https://imagej.net/plugins/grid.html Grid] plugin
