...
| maintainer             = [https://imagej.net/User:Amccall Andrew McCall]
| author                 = [https://imagej.net/User:Amccall Andrew McCall]
| source                 = {{GitHub | org=andmccall | repo=Colocalization_by_Cross_Correlation}}
| status                 = active
| released               = 2020
...
Available on the list of [[Update Sites|ImageJ updates sites]]. Requires Fiji.

'''How it works:'''

[[File:ColocByCorrelation-CorrelationImage.jpg|thumb|Correlation Image]]
...
1. Randomizing Image1 using the [[Media:Costes etalColoc.pdf|Costes randomization method]] and a mask of all theoretically possible localizations for the signal in Image1 (i.e. a mask of the cells, or the nuclei).
...
[[File:ColocByCorrelate-Graph.jpeg|thumb|Radial profile of correlation image shown above]]
...
[[File:ColocByCorrelate-GaussFit.jpg|thumb]]
