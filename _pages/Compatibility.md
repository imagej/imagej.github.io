{{ComponentStats:net.imagej:imagej-legacy}}Backward compatibility is one of ImageJ's most important goals. It must remain possible to use existing plugins and macros with new versions of [[ImageJ]].
