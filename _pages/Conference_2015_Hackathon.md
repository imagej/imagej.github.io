...
# '''Ops.''' The second half focused on development of the [[ImageJ Ops]] component for "write once, run anywhere" image processing. We added more algorithms and routines to the core library, and continued polishing the Ops framework itself, as well as the [[ImageJ Common|ImageJ2 data model]].

=== Side projects ===
As always, there were lots of other exciting collaborations going on, too!
* Troubleshoot the [https://github.com/scifio/scifio-itk-bridge SCIFIO-ITK-bridge] in SimpleITK (Mark + Matt)
* Generalize MATLABCommands to a [https://github.com/Tiago/Scripts/issues/14 general framework] that could be used in BAR (Mark + Tiago)
* The {{GitHub | org=imagej | repo=imagej-omero | label=ImageJ-OMERO}} plugin (Alex + Curtis)
* SciJava {{GitHub | org=scijava | repo=scijava-common | pr=167 | label=robust-io redesign}} (Curtis)
* SCIFIO {{GitHub | org=scifio | repo=scifio | issue=283 | label=blockization}} (Mark)
* {{GitHub | org=fiji | repo=colocalisation_analysis | label=Coloc2}} bugs? (Ellen)
...
<nowiki>*</nowiki> Madison locals include:
* {{Person|etarena}}
* {{Person|Eliceiri}}
* {{Person|Hinerm}}
* {{Person|yuminguw}}
* {{Person|guneetsinghmehta}}
* {{Person|Rueden}}
* {{Person|Awalter2}}
* {{Person|jaywarrick}}
* {{Person|LeonYang5114}}
...
[[Conference 2015|ImageJ 2015 conference]] at the [http://discovery.wisc.edu/home/town-center/apply-to-reserve-town-center-spaces/large-rooms/h-f-deluca-forum/h-f-deluca-forum.cmsx H.F. DeLuca Forum], [http://discovery.wisc.edu/ Wisconsin Institutes for Discovery], 330 N. Orchard St., Madison, WI 53715.
...
WAR Room (B1121), [http://discovery.wisc.edu/ Wisconsin Institutes for Discovery], 330 N. Orchard St., Madison, WI 53715.
...
Room 224 [http://ansci.wisc.edu/ Animal Sciences], 1675 Observatory Dr. [[http://maps.google.com/maps?q=1675+Observatory+Drive,+Madison,+WI See map]]
