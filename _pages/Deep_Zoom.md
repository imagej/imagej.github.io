...
| source                 = {{GitHub|org=uw-loci|repo=deep-zoom-plugin}}
| status                 = inactive
...
The plugin can be downloaded from the [[SciJava Maven repository]] as [https://maven.scijava.org/#nexus-search;gav~loci~deep_zoom-plugin loci:deep_zoom-plugin].
