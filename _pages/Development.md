{{Notice | If your goal is to automate the behavior of ImageJ, consider writing a [[script]] using ImageJ's [[Script Editor]]—it is often much simpler than a plugin in Java.}}
{{DevelopMenu}}This page provides an overview of ImageJ from the perspective of software development: how to use it from your programs, as well as how to modify or extend its capabilities via [[plugins]].

== Quick start ==

* '''Learn to write [[Scripting|ImageJ scripts]]''' from the [https://imagej.github.io/tutorials ImageJ tutorial notebooks].
* '''Learn to use ImageJ from Java''' with the [https://github.com/imagej/tutorials/tree/master/maven-projects ImageJ tutorial Maven projects].

== What is ImageJ? ==

{|style="font-size: large; margin-left: 25px; margin-top: 5px;"
| style="padding: 15px 15px;" | An end-user [[wikipedia:Application software|software application]]
|-
| [[File:Imagej-app.png | 500px | link=Getting started]]
|-
| style="border-top: 1px #aaa solid; padding: 15px 15px;" | Reusable [[wikipedia:Library (computing)|software libraries]]
|-
| style="padding: 0 15px 15px 35px; font-size: small;" |<source lang="java">
...
|-
| style="border-top: 1px #aaa solid; padding: 15px 15px 0 15px;" | An extensible collection of [[plugins]] and [[services]]
|-
| style="padding: 15px 0 30px 45px;" | [[File:Scijava-logo.png | x72px | link=SciJava]]
|-
| style="border-top: 1px #aaa solid; padding: 15px 15px 0 15px;" | ''"Write once, run anywhere"'' [[Ops|image processing routines]]
|-
| style="padding: 15px 0 15px 25px;" | [[File:Write-once-run-anywhere.png | 500px | link=Ops]]
|}
...
! colspan=2 style="font-size: 56px" | {{Logo | ImageJ | size=72px}}[[ImageJ]]
|-
...
|-
! style="font-size: 56px; width: 350px" | {{Logo | ImgLib2 | size=72px}}[[ImgLib2]]
! style="width: 350px" | [[File:Scijava-logo.png | x72px | link=SciJava]]
|-
...
| {{Logo | Git}}
| [[Git]]
| A first-class [[wikipedia:Distributed version control|distributed]] [[wikipedia:Version control|version control]] system.
Git saves "snapshots" of the source code, keeping a history of changes.
|-
| style="vertical-align: middle" | {{Logo | Maven}}
| [[Maven]]
| A [[wikipedia:Build automation|build automation]] tool with great dependency management.
...
Although: ImageJ can be developed using [[IDEs|''any'' IDE]] which supports [[Maven]].
|}
...
Start with the [https://imagej.github.io/tutorials ImageJ tutorial notebooks]!
...
| style="vertical-align: top" |
* [[Developing Fiji]]
* [[Developing Fiji in Eclipse | Fiji + Eclipse]]
