...
| filename              = ImageJ 1.48a to 2.XXX [https://imagej.net/_images/c/cc/DiameterJ_1-018.zip DiameterJ v1.018] 
Fiji any version [https://imagej.net/_images/6/65/DiameterJ_Fiji_-_1-018.zip DiameterJ v1.018]
...
An in-depth training, called [https://sites.google.com/site/diameterj/ Learn DiameterJ], has been developed for users of DiameterJ. In total the training as been broken into 7 components:  

# Initial Installation/Training/Use of DiameterJ
...
# Training 1 -  Cropping and Segmenting
...
# Training 4 - Other Metric Assessment
...
Please go to [https://sites.google.com/site/diameterj/ Learn DiameterJ] to take the training!
...
|- valign="top"
|
#Super Pixel: The mean fiber diameter as calculated using a super pixel determination.  A detailed explanation of how this algorithm  works can be found above. 
#Histogram Mean: The mean fiber diameter as calculated by fitting a Gaussian Curve to the radius data and finding the curves mean value.  
#Histogram SD: The standard dev. of the Gaussian fit of the radius histogram
#Histogram Mode: Most occurring fiber diameter in the histogram
#Histogram Median: Middle fiber diameter in the histogram
#Histogram Min. Diam.: The smallest diameter measured
#Histogram Max. Diam.: The largest diameter measured
#Histogram Integrated Density: The product of length of the fibers and the average radius
#Histogram Raw Integrated Density: The sum of the radii at all pixels in the image or selection
#Diameter Skewness: The third order moment about the mean
#Diameter Kurtosis: The fourth order moment about the mean.
|
#Fiber Length: The total length of the Fiber centerlines in the segmented image.
#Mean Pore Area:  (Total number of black pixels counted in pores) / (Total number of pores in image)
#Pore Area SD: The standard deviation of all pore areas measured
#Min. Pore Area: The minimum pore area measured
#Max Pore Area: The maximum pore area measured
