...
{% endcapture %}
{% include info-box software='ImageJ ' name='FIBSEM importer ' maintainer='Stephan Preibisch ' author='Stephan Preibisch ' source=source released='08/02/2012 ' latest-version='08/02/2012 ' status='stable ' category='[:Category:Plugins](_Category_Plugins ) ' website=' ' %}
