__NOTOC__[[File:File.png|500px|thumb|left]]{{Clear}}{{Infobox Plugin
| software               = Fiji/ImageJ
| name                   = FijiWings
| author                 = Alex Dobens, {{Person|Dobensl}}
| maintainer             = {{Person|Dobensl}}
| filename               = fiji-macosx.zip
| source                 = https://sourceforge.net/projects/fijiwings/
| status                 = stable
}}=== Introduction ===
...
Please report any bugs that you find with Fiji's {{bc | Help | Report a Bug}} menu option.  For other feedback please email ''dobensl'' at ''umkc.edu''.   There are other ways of giving feedback on Fiji (e.g. the mailing lists, IRC, etc.) listed at [[Help]].

=== Citing FijiWings ===

If you would like to reference FijiWings in a publication, you can cite:

* {{Publication | FijiWings}}

== Tutorials ==

{{#widget:YouTube|id=kkwbRaN51ww|width=300|height=170}}
{{#widget:YouTube|id=nlYZyJxV5Bw|width=300|height=170}}
{{#widget:YouTube|id=YDZHy_5mPko|width=300|height=170}}

* [http://www.youtube.com/user/Fijiwingsadmin/videos All FijiWings videos]
