...
| filename               = FRC_-1.0.2.jar
| released               = September 2016
| latest version         = July 2018
| source                 = [https://github.com/BIOP/ijp-frc github page]
| status                 = stable
...
=== June 2019 ===
A remark from Brian Patton, University of Strathclyde, Glasgow says that the original computation for the numerator was wrong, namely:
<code>code|numerator[i] = dataA1[i] * dataA2[i] + dataB1[i] * dataB2[i];</code>
And should be instead:
<code>abs((FFT(Image1)*Complex_Conj(FFT(Image2)))</code>
