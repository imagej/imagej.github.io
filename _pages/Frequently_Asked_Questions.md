...
Not yet as an end-user application. But since Android is a Java-based platform, there is hope. One of the [ImageJ2](ImageJ2 "wikilink") project's central design goals was a better [separation of concerns](wikipedia_Separation_of_concerns "wikilink"), which could make things like an Android version of ImageJ possible. In particular, the [core components of ImageJ2](ImageJ2#ImageJ2_is_more_than_just_an_application "wikilink") are militant in their avoidance of certain Java SE packages not present in the Android version of Java (which is based on Java ME), such as [Java AWT](wikipedia_Abstract_Window_Toolkit "wikilink").
