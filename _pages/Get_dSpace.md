...
This is the window that opens up when you first start the plugin. All you need for the plugin to work is an opened diffraction pattern that is calibrated and saved as a .dm3 file. <img src="/media/First_Window_2.jpg" title="fig:First_Window_2.jpg" width="800" alt="First_Window_2.jpg" />
