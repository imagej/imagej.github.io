...
![](/images/pages/Bdv-MaMuT UpdateSite.png "bdv-MaMuT_UpdateSite.png")
...
![](/images/pages/Bdv-MaMuT MenuItems.png "bdv-MaMuT_MenuItems.png")
...
<img src="/images/pages/Bdv-MaMuT MainGUIWindow beginning.png" width="200"/>
...
<img src="/images/pages/Bdv-MaMuT ViewerExample.png" width="500"/>
...
<img src="/images/pages/Bdv-MaMuT ViewerBrightnessColor.png" width="700"/>
...
<img src="/images/pages/Bdv-MaMuT ViewerOverlays2.png" width="700"/>
...
![](/images/pages/Bdv-MaMuT DesiredOrientation.png "bdv-MaMuT_DesiredOrientation.png")
...
<img src="/images/pages/Bdv-MaMuT MultipleViews.png" width="500"/>
...
![](/images/pages/Bdv-MaMuT ConfigureSpotDisplay.png "bdv-MaMuT_ConfigureSpotDisplay.png")
...
![](/images/pages/Bdv-MaMuT ConfigureFeatureRange.png "bdv-MaMuT_ConfigureFeatureRange.png")
...
<img src="/images/pages/Bdv-MaMuT DesiredTracking 1.PNG" width="500"/>
...
<img src="/images/pages/Bdv-MaMuT DesiredTracking 2.PNG" width="500"/>
...
<img src="/images/pages/Bdv-MaMuT TrackSchemeStepwiseTimeBrowsing.png" width="500"/>
...
![](/images/pages/Bdv-MaMuT ConfigureTrackDisplay.png "bdv-MaMuT_ConfigureTrackDisplay.png")
...
<img src="/images/pages/Bdv-MaMuT TrackSchemeStart.png" width="500"/>
...
<img src="/images/pages/Bdv-MaMuT TrackSchemeOutline.png" width="500"/>
...
<img src="/images/pages/Bdv-MaMuT TrackSchemeTrackDisplayColor.png" width="500"/>
...
<img src="/images/pages/Bdv-MaMuT TrackSchemeDecorationButton.png" width="500"/>
...
<img src="/images/pages/Bdv-MaMuT TrackSchemeThumbnails.png" width="500"/>
...
<img src="/images/pages/Bdv-MaMuT TrackSchemeSelectionOnly.png" width="700"/>
...
<img src="/images/pages/Bdv-MaMuT TrackSchemeSideBar.png" width="800"/>
...
<img src="/images/pages/Bdv-MaMuT TrackSchemeUnlaidSpots.png" width="700"/>
...
<img src="/images/pages/Bdv-MaMuT TrackSchemeDragAndDropLink.png" width="500"/>
...
<img src="/images/pages/Bdv-MaMuT TrackSchemeTrackNames.png" width="500"/>
...
<img src="/images/pages/Bdv-MaMuT TrackSchemeSpotNames.png" width="500"/>
...
<img src="/images/pages/Bdv-MaMuT SemiAutoTracking 1.png" width="500"/>
...
![](/images/pages/Bdv-MaMuT SemiAutoTracking 2.png "bdv-MaMuT_SemiAutoTracking_2.png")
...
![](/images/pages/Bdv-MaMuTRecordMaxProjection.png "bdv-MaMuTRecordMaxProjection.png")
...
![](/images/pages/Bdv-MaMuT ExportTrackStack.PNG "bdv-MaMuT_ExportTrackStack.PNG")
...
<table><tbody><tr class="odd"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">add spot</code></p></td><td style="padding: 5px;"><p> Add a spot at mouse location.</p><p>If the <code style="font-size: 1.25em;">auto-linking</code> mode is on, also link it with the spot previously in the selection, and set the newly added spot to be the current selection.</p></td></tr><tr class="even"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">delete spot</code></p></td><td style="padding: 5px;"><p> Delete the spot at mouse location.</p></td></tr><tr class="odd"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">increase spot radius</code></p></td><td style="padding: 5px;"><p> Increase the spot radius at mouse location by 10%.</p></td></tr><tr class="even"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">increase spot radius a lot</code></p></td><td style="padding: 5px;"><p> Increase the spot radius at mouse location by 100%.</p></td></tr><tr class="odd"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">increase spot radius a bit</code></p></td><td style="padding: 5px;"><p> Increase the spot radius at mouse location by 1%.</p></td></tr><tr class="even"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">decrease spot radius</code></p></td><td style="padding: 5px;"><p> Decrease the spot radius at mouse location by 9.10%.</p></td></tr><tr class="odd"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">decrease spot radius a lot</code></p></td><td style="padding: 5px;"><p> Decrease the spot radius at mouse location by 50%.</p></td></tr><tr class="even"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">decrease spot radius a bit</code></p></td><td style="padding: 5px;"><p> Decrease the spot radius at mouse location by 1%.</p></td></tr><tr class="odd"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">toggle link</code></p></td><td style="padding: 5px;"><p> Add / Remove a link between two spots in the selection.</p></td></tr><tr class="even"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">toggle linking mode</code></p></td><td style="padding: 5px;"><p> Toggle the <code style="font-size: 1.25em;">auto-linking</code> mode.</p></td></tr><tr class="odd"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">semi-auto tracking</code></p></td><td style="padding: 5px;"><p> Launch semi-automatic tracking from the cells currently selected.</p></td></tr><tr class="even"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">help</code></p></td><td style="padding: 5px;"><p> Display the help window.</p></td></tr><tr class="odd"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">brightness settings</code></p></td><td style="padding: 5px;"><p> Toggle the brightness settings dialog.</p></td></tr><tr class="even"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">visibility and grouping</code></p></td><td style="padding: 5px;"><p> Toggle the visibility and grouping settings dialog.</p></td></tr><tr class="odd"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">toggle interpolation</code></p></td><td style="padding: 5px;"><p> Toggle interpolation method for pixel drawing between <code style="font-size: 1.25em;">Nearest neighbor</code> and <code style="font-size: 1.25em;">Tri-linear interpolation</code>.</p></td></tr><tr class="even"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">toggle fused mode</code></p></td><td style="padding: 5px;"><p> Toggle fused or single-source display mode.</p></td></tr><tr class="odd"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">toggle grouping</code></p></td><td style="padding: 5px;"><p> Toggle grouping mode.</p></td></tr><tr class="even"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">toggle source visibility X</code></p></td><td style="padding: 5px;"><p> Replace X by a digit from 0 to 9. Toggle the visibility of the source X.</p></td></tr><tr class="odd"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">align XY plane</code></p></td><td style="padding: 5px;"><p> Change the current view to align it with the XY planes of the source currently active.</p></td></tr><tr class="even"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">align XZ plane</code></p></td><td style="padding: 5px;"><p> Change the current view to align it with the XZ planes of the source currently active.</p></td></tr><tr class="odd"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">align ZY plane</code></p></td><td style="padding: 5px;"><p> Change the current view to align it with the ZY planes of the source currently active.</p></td></tr><tr class="even"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">next timepoint</code></p></td><td style="padding: 5px;"><p> Move to the next time-point.</p></td></tr><tr class="odd"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">previous timepoint</code></p></td><td style="padding: 5px;"><p> Move to the previous time-point.</p></td></tr><tr class="even"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">step time forward</code></p></td><td style="padding: 5px;"><p> Jump to the next time step.</p></td></tr><tr class="odd"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">step time backward</code></p></td><td style="padding: 5px;"><p> Jump to the previous time step.</p></td></tr><tr class="even"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">set bookmark</code></p></td><td style="padding: 5px;"><p> Store a bookmark for the current view.</p></td></tr><tr class="odd"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">go to bookmark</code></p></td><td style="padding: 5px;"><p> Move the view to the specified bookmark.</p></td></tr><tr class="even"><td style="padding: 5px;"><p> <code style="font-size: 1.25em;">got to bookmark orientation</code></p></td><td style="padding: 5px;"><p> Orient the view to the specified bookmark orientation.</p></td></tr></tbody></table>
...
![](/images/pages/Bdv-MaMuTKeyboardLayout.png "bdv-MaMuTKeyboardLayout.png")
