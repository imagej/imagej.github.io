...
Further benefits:
  ...
  - Easily [find the commit which introduced such a regression](Pinpoint_regressions_with_Git "wikilink").
...
If you feel comfortable in using the commandline but you are still not familiar with Git the **[Git workshop](Git_workshop "wikilink")** page might be a perfect entry point for you.

If the commandline is not your favorite playground you can have a look at the Git integration **[EGit](EGit "wikilink")** in the **[Eclipse](Eclipse "wikilink")** IDE.
