...
| filename               = [https://imagej.net/plugins/download/jars/Gran_Filter.jar Gran_Filter.jar] (39,559 Bytes)
| source                 = in .jar file
| released               = 21 May 2005 
| latest version         = 
| status                 = unknown
| category               = 
| website                = [https://imagej.net/plugins/gran-filter.html]
}}
...
<gallery>
Image:Gran_an_example_1.png|Original segmented image
Image:Gran_an_example_2.png|Selecting blobs of radius 10 to 12 px
Image:Gran_an_example_3.png|Selecting blobs of radius 5 to 7 px
Image:Gran_an_example_4.png|The three images merged
</gallery>
