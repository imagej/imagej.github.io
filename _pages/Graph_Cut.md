...
This plugin is based on a reimplementation of Kolmogorov's [http://pub.ist.ac.at/~vnk/software.html#maxflow maxflow v3.01] library, which was written in C++. If you intend to use it for a publication, please cite:
...
The plugin can be found under {{bc|Plugins|Segmentation|Graph Cut}}.
