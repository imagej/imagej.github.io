...
{% include project content='ImgLib2' %}ImgLib2 is a major redesign of ImgLib, and [much has changed](Changes_from_ImgLib1_to_ImgLib2 "wikilink"). This page attempts to provide a "how-to" guide for bringing existing ImgLib1 code up to date with ImgLib2. It is intended as a "quick start" guide—for more details, see the [Changes from ImgLib1 to ImgLib2](Changes_from_ImgLib1_to_ImgLib2 "wikilink") page.
...
Please note that there are cases where using Img is not appropriate, and a better alternative exists; see the [Changes from ImgLib1 to ImgLib2](Changes_from_ImgLib1_to_ImgLib2 "wikilink") page for a more complete explanation.
