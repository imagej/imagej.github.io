...
Often you want to  apply a common operation to all images in a given directory. This tutorial tries to help you doing this. In addition, the [[Script Editor]] provides a template via {{bc | Templates | IJ1 Macro | Process Folder}} that helps getting started quickly.

== Step 1: record a macro ==

First, start the Macro Recorder:

[[Image:How_to_apply_a_common_operation_to_a_complete_directory-1.jpg]]

This will open the Macro Recorder window:

[[Image:How_to_apply_a_common_operation_to_a_complete_directory-2.jpg]]
...
[[Image:How_to_apply_a_common_operation_to_a_complete_directory-3.jpg]]

Then crop it.

[[Image:How_to_apply_a_common_operation_to_a_complete_directory-4.jpg]]

After saving, the recorder window will show this:

[[Image:How_to_apply_a_common_operation_to_a_complete_directory-6.jpg]]

Click on the '''Create''' button, and you will get this:

[[Image:How_to_apply_a_common_operation_to_a_complete_directory-7.jpg]]
...
[[Image:How_to_apply_a_common_operation_to_a_complete_directory-8.jpg]]

The dialog would need to be filled out like this:

[[Image:How_to_apply_a_common_operation_to_a_complete_directory-9.jpg]]
