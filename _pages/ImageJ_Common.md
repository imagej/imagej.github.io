{{ComponentStats:net.imagej:imagej-common}}The ImageJ Common library contains ImageJ's core image data model, based on the [[ImgLib2]] library for multidimensional image data processing, as well as the corresponding core image display logic for user interfaces, based on the [[SciJava Common]] application framework.

{{Testimonial
| quote = I Have to a admit that IJ2 API and Java 8 make the process very smooth
Much better than few years ago :-0
| person = {{Person|hadim}}, Python developer
...
* {{Javadoc | package = net/imglib2/meta | class = ImgPlus}}
* {{Javadoc | package = net/imagej | class = Dataset}} and {{Javadoc | package = net/imagej | class = DefaultDataset}}
