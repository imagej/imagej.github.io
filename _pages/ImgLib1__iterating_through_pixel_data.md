...
* <tt>public int[] getPosition()</tt> returns an array specifying the current position for each dimension; <span style="color:#FF0000;">Warning: this methods creates a new int[] array every time and is therefor inefficient if called very often</span>
