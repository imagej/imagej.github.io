...
{% endcapture %}
{% include info-box name='ImgLib2' software='Generic Image Processing for Java' logo='![](/media/Imglib2-logo.png "fig:imglib2-logo.png")' author=author maintainer=maintainer source=source status='stable, active' category='[:Category:ImgLib](Category_ImgLib)' %}{% include imglibmenu%}
