...
The presentation of what are morphological operations is left to [[wikipedia:Mathematical morphology|Wikipedia]].
...
Classes can be found in the <code>[https://github.com/tinevez/imglib2-algorithm/tree/morphology/src/main/java/net/imglib2/algorithm/morphology net.imglib2.algorithm.morphology]</code> package of the [https://github.com/imglib/imglib2-algorithm imglib2-algorithm library].

Examples can be found in the <code>[https://github.com/tinevez/imglib2-tests/tree/morphology/src/test/java/net/imglib2/algorithm/morphology net.imglib2.algorithm.morphology]</code> package of the [https://github.com/imglib/imglib2-tests imglib2-tests library].
...
In the Imglib2 morphology package, these decompositions are achieved through the [https://github.com/imglib/imglib2-algorithm/blob/master/src/main/java/net/imglib2/algorithm/morphology/StructuringElements.java  StructuringElements] class. For instance:
...
{{Person|JeanYvesTinevez}} ([[User talk:JeanYvesTinevez|talk]]) 09:33, 5 December 2014 (CST)
