...
''"I started working as a Research Software Engineer at Florian Jug's lab, MPI-CBG, one year ago. After building interactive installations and visualizations as a freelancer I discovered the Fiji community while searching for jobs in open source development. I currently rethink the Updater, I am responsible for the CSBDeep / CARE Fiji plugin and for the IJ2 Ops part of CLIJ."'''
...
'''[https://imagej.net/User:Skalarproduktraum Ulrik Günther]''' ''''Hey there! I'm currently a PhD student at the Sbalzarini Lab at CSBD. I'm trying to bring VR to microscopy and systems biology in general, e.g. by enabling VR control of microscopes, or developing [https://github.com/scenerygraphics/scenery scenery] and the new 3D viewer for ImageJ, [https://github.com/scenerygraphics/scenery sciview]."''
...
* Now please try to open the image at [https://imagej.net/images/t1-head.zip https://imagej.net/images/t1-head.zip] and show it on your screen.
...
The images are [https://www.dropbox.com/sh/azrykz3bu4ymrjd/AADj1jhIPhEz5U1O6DsYIxDYa?dl=0 here]
...
[https://github.com/imagej/tutorials/tree/master/maven-projects/widget-demo Widget-Demo] showing all different widgets for all available input @Parameters. 

[https://github.com/tibuch/DoG_Pyramid DoG Pyramid example.]

'''16:00 - 16:30 Image and point transform concepts'''

Concepts:
* [http://alvyray.com/Memos/CG/Microsoft/6_pixel.pdf pixels are not little squares]
* "Forward" transforms apply to points, "inverse" transforms apply for images. [https://github.com/bogovicj/transforms_tutorial/blob/5d9194e38898f942f00fe5e76dd4ca823aa6281d/resources/2019_DAIS.pdf Here's why]
