...
| update site            = LimeSeg
| logo                   = 
| maintainer             = {{Person|NicoKiaru}}
| author                 = {{Person|NicoKiaru}}, {{Person|Sarah Machado}}
| source                 = {{GitHub | org=NicoKiaru | repo=LimeSeg}}
| status                 = 
| released               = 01/2018
...
'''A Fiji plugin for the segmentation of 3D objects. '''
 ...
 [https://imagej.net/Following_an_update_site Enable the LimeSeg update site] to get it.
...
BMC Bioinformatics doi: [https://doi.org/10.1186/s12859-018-2471-0 http://dx.doi.org/10.1186/s12859-018-2471-0]
...
* [https://www.youtube.com/watch?v=i9OC8H6gFA4 Computing and displaying surface curvature]
...
[[File:LimeSeg_Results_Vesicle.png|1000px]]
...
[[File:LimeSeg_Skeleton_Example.png|1000px]]
...
Open Fiji, then launch LimeSeg GUI ('''Plugins>LimeSeg>Show GUI''').
...
Notice that the image name appears in the LimeSeg GUI down panel.
...
* Use the '''selectCellById''' button in the STATE pane (fill in the string id parameter on the right (like 'cell_10') before clicking)
...
They are also accessible as templates in ImageJ script editor (https://imagej.net/Using_the_Script_Editor), if the LimeSeg update site is enabled.
