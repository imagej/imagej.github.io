{{ComponentStats:sc.fiji:Linear_Kuwahara}}This plugin extends the idea of the [https://imagej.net/plugins/kuwahara.html original Kuwahara] filter from rectangular kernels to (straight) linear ones.
