...
| logo                   = [[File:LungJ-logo.png|200px|thumb|left]]
| source                 = {{GitHub|org=LWollatz|repo=LungJ}}
| released               = Nov 10<sup>st</sup>, 2016
| latest version         = 0.5.1, November 10<sup>th</sup>, 2016 (LungJ v0.5.1)
| status                 = stable, new
...
* {{Citation | last1=Wollatz | first1=Lasse | last2=Johnston | first2=Steven J. | last3=Lackie | first3=Peter M. | last4=Cox | first4=Simon J. | title=LungJ v0.5.1 | type=Code | year=2016 | month=November | publisher=University of Southampton | doi=10.5258/SOTON/401280 | url=http://eprints.soton.ac.uk/id/eprint/401280}}
