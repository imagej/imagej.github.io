{{FormatsMenu}}If you have Flex files from an older Opera system, you may receive a message from [[Bio-Formats]] stating that you need a LuraWave LWF license code to decode these files.
