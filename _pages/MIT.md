...
[GPL](GPL), which have reciprocity share-alike requirements. The MIT license is
...
the [Simplified BSD License](BSD-2). A licensee of MIT-licensed software can:
...
{% include license-links shortname="MIT" url='https://choosealicense.com/licenses/mit/' choosealicense='mit' osi='MIT' %}
