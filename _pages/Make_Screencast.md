...
'''Make Screencast''' is a [[Beanshell Scripting|Beanshell]] script to record a screencast in [[wikipedia:Ogg|Ogg]] or [[wikipedia:QuickTime File Format|Quicktime]] video formats.

Access it via {{bc | File | Make Screencast}}.

Stop recording the screencast via {{bc | File | Stop Screencast}}.
