...
* The command is in {{bc | Plugins | Classification | Microscope Image Focus Quality}}.

== Usage ==

* Open an image to analyze (see [https://storage.googleapis.com/microscope-image-quality/static/fiji_plugin_test_images.zip sample images]).
* Run {{bc | Plugins | Classification | Microscope Image Focus Quality}}.
...
The plugin is currently limited to single (i.e., 2D) images of 16-bit integer data only. The model was trained with images in the intensity range of <code>[0, ~10000]</code>; your mileage may vary if the input image intensities diverge from that too greatly.
...
* [https://research.googleblog.com/2018/03/using-deep-learning-to-facilitate.html Using Deep Learning to Facilitate Scientific Image Analysis] post on Google Research Blog
