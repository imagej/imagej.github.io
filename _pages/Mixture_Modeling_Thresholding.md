...
| filename               = [https://imagej.net/plugins/download/jars/Mixture_Modeling.jar Mixture_Modeling.jar] (18,454 Bytes)
| source                 = in .jar file
| released               = 15 December 2003 
| status                 = unknown
| category               = [[:Category:Segmentation|Segmentation]]
| website                = [https://imagej.net/plugins/mixture-modeling.html]
}}
