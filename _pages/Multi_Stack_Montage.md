...
<figure><img src="/images/pages/Hyperstacks_Montage_menu.jpg" title="Interface of the plugin" width="400" alt="Interface of the plugin" /><figcaption aria-hidden="true">Interface of the plugin</figcaption></figure>
