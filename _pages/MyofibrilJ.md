...
| name            = MyofribilJ
| maintainer      = {{Person|Gcardone}}
| author          = {{Person|Gcardone}} and Maria Spletter
| source          = {{GitHub|org=giocard|repo=MyofibrilJ }}
...
== Usage ==
Two distinct commands, ''analyse myofibrils crosswise'' and ''analyse myofibrils lengthwise'', are provided to analyse cross-sections and longitudinal sections of fibers, respectively.
In both cases:
...
== Installation ==
The easiest way to install ''MyofibrilJ'' is by [[Following_an_update_site#Add_update_sites|adding]] its update site. Specifically:
