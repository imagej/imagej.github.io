...
| Strahler classifier     | {% include bc content='Analyze|Skeleton|Strahler Analysis...'%}              | Described in [Strahler Analysis](Strahler_Analysis ). Implemented as a {% include github org='tferr ' repo='hIPNAT ' path='src/main/java/ipnat/skel ' label='Java plugin ' %}.                                                                                                                                                                                                                                                                                                                                                           |
...
# Further information
  ...
  - A list of all pages in this wiki related to image processing in the neurosciences can be found [here](_Category_Neuroanatomy ).
