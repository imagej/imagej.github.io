...
| software               = ImageJ
| name                   = NoiSee
| logo                   = [[File:Noisee-logo.png|96px]]
| author                 = {{Person|Cellkai}}, {{Person|Ehrenfeu}}
| maintainer             = {{Person|Ehrenfeu}}
| update site            = NoiSee
| source                 = {{GitHub|org=imcf|repo=noisee}}
| released               = 2018
| status                 = active
...
[[Following_an_update_site|Enable the NoiSee update site]] and restart Fiji.
...
[[File:Noisee-Dialog-Beads.png]]

* In the image field specify the path to a time lapse beads image.
** The input file format has to be readable by [[Bio-Formats]].
** Data is expected to be 2D+t, with the focus (Z-plane) set to the center of the beads. If unsure, check our provided [https://sites.imagej.net/NoiSee/samples/beads.ome.tif beads sample data] to see how to adjust your acquisition accordingly.
...
[[File:Noisee-Dialog-Fluorescein.png]]
...
We provide a small set of [https://sites.imagej.net/NoiSee/samples/ sample data] to demonstrate the usage of the macros and to give you an idea how the input data is supposed to look like.

== Bead Method Example Results ==

* [https://sites.imagej.net/NoiSee/samples/beads.ome.tif Fluorescent Beads Sample Image] (1.3 Mb)

Running the beads macro on the above sample data will give the following results:

<gallery mode="packed-hover">
File:Noisee-Beads-Original-Data.png|Beads Input Data
File:Noisee-Beads-SNR.png|SNR
File:Noisee-Beads-Kymographs.png|Kymographs
File:Noisee-Beads-Plots.png|SNR Plots
</gallery>

== Fluorescein Method Example Results ==

* [https://sites.imagej.net/NoiSee/samples/fluorescein.ome.tif Fluorescein Sample Image] (300 Kb)
* [https://sites.imagej.net/NoiSee/samples/darkfield.ome.tif Dark Field Sample Image] (55 Kb)

Running the fluorescein macro on the above sample data will give the following results:

<gallery mode="packed-hover">
File:Noisee-Fluorescein-Original-Data.png|Fluorescein Input Data
File:Noisee-Fluorescein-Darkfield.png|Dark Field Input Data
File:Noisee-Fluorescein-Absolute-Signal.png|Absolute Signal
File:Noisee-Fluorescein-Histogram.png|Histogram of the Absolute Signal
</gallery>
...
[https://doi.org/10.1101/291500 bioRxiv 291500].
