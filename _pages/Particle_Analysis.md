...
To analyze the particles in a segmented image, use the menu command {% include bc content='Analyze | Analyze particles...'%}. This will provide you with information about each particle in the image.
{% capture title%}
 |right 
{% endcapture %}
{% include thumbnail src='/images/pages/Analyze particles screenshot.png' title=title %}.
