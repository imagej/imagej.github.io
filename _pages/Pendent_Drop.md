...
| name                   = Pendent Drop
| software               = Fiji
| author                 = [http://www.msc.univ-paris-diderot.fr/~daerr/ Adrian Daerr]
| maintainer             = [http://www.msc.univ-paris-diderot.fr/~daerr/ Adrian Daerr]
| update site            = [[[List of update sites]] http://sites.imagej.net/Daerr/]
| source                 = https://github.com/adaerr/pendent-drop
| released               = September 28, 2010
| latest version         = version 2 (September 20, 2015)
| status                 = stable, active
}}

[[File:eauContrasteMaxFit.jpg]]
...
* Ask questions on the [http://forum.imagej.net/t/pendent-drop-plugin-how-to-use/290 pendent drop topic page of the ImageJ forum]
* To cite this software, please use the following reference: A. Daerr and A. Mogne, ''Pendent_Drop: An ImageJ Plugin to Measure the Surface Tension from an Image of a Pendent Drop''. Journal of Open Research Software, 4: e3 (2016), [http://dx.doi.org/10.5334/jors.97 DOI: 10.5334/jors.97]
* [http://www.msc.univ-paris-diderot.fr/~daerr/misc/pendent_drop.html description on author's home page]
* [https://github.com/adaerr/pendent-drop source code on github]
* [https://github.com/adaerr/pendent-drop/blob/master/article/Goutte_pendante.pdf PDF document descripting both the pendent drop method and the plugin in more detail]
