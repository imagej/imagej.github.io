...
{% include thumbnail src='/images/pages/Photobend demo.gif' title='Animation of the photobend time lapse (\~1500x playback speed)'%}
...
![400pix\|left\|Crystal shape tracking in process](/images/pages/Photobend processing.jpg "fig:400pix|left|Crystal shape tracking in process") ![](/images/pages/Photobend deformation plot.jpg "fig:photobend_deformation_plot.jpg") ![](/images/pages/Photobend curvature plot.jpg "fig:photobend_curvature_plot.jpg")
...
{% include thumbnail src='/images/pages/LaserSpotMove.gif' title='Animation of the laser spot movement obtained while registering the photobending with the laser beam deflection technique (\~70x playback speed)'%}
