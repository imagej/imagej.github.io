...
}}</ref> and an example of the bending process quantification in ref.<ref name="Cizhik2018>{{ cite journal
...
| author = Stanislav Chizhik, Anatoly Sidelnikov, Boris Zakharov, Panče Naumov and Elena Boldyreva
...
[[Image:LaserSpotTrack.jpg|frame|400pix|left|Laser spot tracking in process]]
