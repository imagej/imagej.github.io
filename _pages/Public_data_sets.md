...
![](/images/pages/TrakEM2-tree-datastructure.png "fig:TrakEM2-tree-datastructure.png") ![](/images/pages/TrakEM2-display-s.jpg "fig:TrakEM2-display-s.jpg")
...
-   [Sample OME-TIFF data on openmicroscopy.org](http://www.openmicroscopy.org/site/support/file-formats/ome-tiff/ome-tiff-data), thanks to Josh Bembenek.<img src="/images/pages/tubhiswt4D.png" title="fig:C. elegans embryo coexpressing tubulin histone GFP" width="140" alt="C. elegans embryo coexpressing tubulin histone GFP" />
...
4D data set, kindly provided by Dirk Sieger and [Francesca Peri](http://www.embl.de/research/units/dev_biology/peri/), EMBL.<img src="/images/pages/Migrating-macrophages.gif" title="fig:Macrophages in 4D" width="140" alt="Macrophages in 4D" />
