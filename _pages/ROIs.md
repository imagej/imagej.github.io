...
style="caption-side:bottom; text-align: left; font-size: 0.9em; font-weight: normal;"|<sup>1</sup> Transform is {% include wikipedia title='Continuous\_function' text='continuous'%} (preserves boundary behavior) and will preserve the interval bounds  
