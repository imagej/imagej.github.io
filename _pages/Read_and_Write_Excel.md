...
| maintainer             = Anthony Sinadinos [https://forum.image.sc/u/antinos/ (antinos)]
| source                 = {{GitHub|org=antinos|repo=Read_and_Write_Excel_Modified}}
| category               = [[:Category:Plugins]]
| website                = [https://www.youtube.com/watch?v=dLkoB25MTIY Youtube tutorial]
}}
...
{| class="wikitable mw-collapsible mw-collapsed" style="width: 40%; float:right; margin-left: 10px;"
|+ class="nowrap" | Release version dates
|-
! scope="col" tyle="width: 20%"| Version
! scope="col" tyle="width: 30%"| Release Date
! scope="col" style="width: 50%"| Notes
|-
! scope="row"| v1.0.0
| style="text-align:right;" | 19 Nov 2015
| 
|-
! scope="row"| v1.0.1
| style="text-align:right;" | 25 Nov 2015
| 
|-
! scope="row"| v1.0.2
| style="text-align:right;" | 10 Apr 2017
| 
|-
! scope="row"| v1.1.0
| style="text-align:right;" | 27 Feb 2018
| <span style="font-size:80%; line-height: 0.9em;">This version contains many new features that have been added by Brenden Kromhout https://github.com/bkromhout </span>
|-
! scope="row"| v1.1.1
| style="text-align:right;" | 02 Jul 2018
| 
|-
! scope="row"| v1.1.2
| style="text-align:right;" | 04 Nov 2018
| 
|-
! scope="row"| v1.1.3
| style="text-align:right;" | Jan 2019
| 
|-
! scope="row"| v1.1.4
| style="text-align:right;" | 17 Apr 2019
| 
|-
! scope="row"| v1.1.5
| style="text-align:right;" | 30 Nov 2019
|
|-
! scope="row"| v1.1.6
| style="text-align:right;" | 20 May 2020
| 
|}
{{TOC}}
...
'''Youtube tutorial:'''<br>
{{#widget:YouTube|id=dLkoB25MTIY|width=420}}
</span>
...
# package is not bloated by dependency .jar files.
# now contains source-code for reference.
# removed platform specification as I believe this plugin will work across operating systems.

Version 1.0.2 changes:
# the legacy feature was removed that allowed data to be fed to the plugin in a single-line string to the 'arg' function
# all data is now exported as string/text into the generated spreadsheet. This is sub-optimal, in that cells will then need to be converted back to a number format in the spreadsheet, but was required to immediately fix an issue whereby string data (when it exists within the Results table) was not being handled properly by the plugin
# Replaced the legacy data import function of the argument line (note 1 above) with an allowance for user supplied headings for each import; the argument now accepts a string title (e.g "this is my new title") that will then be used to label the results when exported.

Version 1.1.0 changes: 
# Brenden Kromhout added the optional argument features mentioned above and described on his [https://github.com/bkromhout/Read_and_Write_Excel_Modified GitHub] repo 
# Data imported into an .xlsx file is now recognised as either text or numbers automatically 
# An imageJ progress bar is now visible for each export 
# Now using the latest Apache POI releases (3.17)

Version 1.1.1 changes:
# Fixed an error whereby the plugin would fail to export data if the 'Label' column of the results table contained empty cells. Empty cells are now replace with a "null" string/text upon export.

Version 1.1.2 changes:
# Added an argument so that results data can be exported so that it appears underneath pre-existing data in the created/amended .xlsx file. To implement this function, call the plugin with the argument "stack_results".

Version 1.1.3 changes:
# Bug fix. Results data exported with the "stack_results" argument was being incorrectly referenced after the plugin handled empty cells (from the 'Label' column). When they arise, these empty cells are now handled better.

Version 1.1.4 changes:
# Bug fix. Label column issue fixed. Label data was not being exported; it now is.

Version 1.1.5 changes:
# Bug fix. Export can now proceed when there are non-Label-column empty cells.

Version 1.1.6 changes:
# Bug fix. Fixed a rare 'stack_results' issue whereby the data was exported incorrectly if the results table and the excel file both contained a single-row of data.
</div></div>
...
{| class="wikitable"
|-
! scope="col"| Dependency
! scope="col"| Maven Repo
|-
! jars/commons-collections4.jar
| style="text-align:center;" | [https://mvnrepository.com/artifact/org.apache.commons/commons-collections4]
|-
! jars/xmlbeans.jar
| style="text-align:center;" | [https://mvnrepository.com/artifact/org.apache.xmlbeans/xmlbeans]
|-
! jars/poi-ooxml.jar
| style="text-align:center;" | [https://mvnrepository.com/artifact/org.apache.poi/poi-ooxml]
|-
! jars/poi-ooxml-schemas.jar
| style="text-align:center;" | [https://mvnrepository.com/artifact/org.apache.poi/poi-ooxml-schemas]
|-
! jars/poi.jar
| style="text-align:center;" | [https://mvnrepository.com/artifact/org.apache.poi/poi]
|-
! jars/ij.jar
| style="text-align:center;" | [https://mvnrepository.com/artifact/net.imagej/ij]
|}
