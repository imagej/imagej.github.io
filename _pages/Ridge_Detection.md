{{Unmaintained}}
{{BigNotice | As this plugin is no longer maintained... you can check out [[ImageJ Ops]] for Ridge Detection algorithms.}}

{{Infobox
| software               = Fiji
| name                   = Ridge (Line) Detection Plugin
| author                 = {{Person|Twagner}}, {{Person|Hinerm}}
| maintainer             = Unmaintained
| filename               = Ridge_Detect.jar [https://github.com/thorstenwagner/ij-ridgedetection/releases/latest [1]]
| source                 = Github [https://github.com/thorstenwagner/ij-ridgedetection [2]]
...
There are three parameters which '''have to ''' be specified. These are the mandatory parameters. The optional parameters can be used to estimate the mandatory parameters [[File:Ridge Detection Parameters.png|200px|thumb]]
...
If you use this method of overlap resolution, it is recommended that you first tune the Ridge Detection parameters with <code>Preview</code> enabled to get a minimal starting set of junction points - so that each ridge matches reality as best as possible. For example:

[[File:Slope_detection_low_sigma.png|325px]]

This detection with a sigma of 1.6 produces a set of lines and junctions not suited to slope-based overlap detection.


[[File:Slope_detection_high_sigma.png|325px]]
...
[[File:Slope_detection_bad.png|325px]]
...
[[File:Slope_detection_success.png|325px]]
...
[[File:Ij-ridgedetection.svg|174px|link=https://zenodo.org/badge/latestdoi/18649/thorstenwagner/ij-ridgedetection]]
