...
:Click the "Reset" button to restart the process or click on the "Create mask" button to create a binary image. Please, note that the binary image polarity will follow the option set in {{bc | Process | Binary | Options}}.

{|
|style="vertical-align:top"|[[Image:Screenshot-SIOX_Segmentation.png|thumb|440px|SIOX segmentation Graphical User Interface applied to Leaf sample]]
|style="vertical-align:top"|[[Image:SIOX-Mask.png|thumb|280px|Resulting mask of Leaf sample after SIOX segmentation]]
|}

==User Manual==
[[SIOX]] is a plugin designed to segment 2D color images. If the image is not RGB color, it can be converted to RGB using the command {{bc | Image | Type | RGB Color}}. However, the [[SIOX]] algorithm makes uses color information, so it is expected to work better on real RGB images.
...
This is the '''second step''' in the [[SIOX]] segmentation process. 
...
[[Image:SIOX-Reset-Create-mask.png|thumb|233px|SIOX Reset/Create mask panel]]
...
:Creates a binary (0-255) image based on the current state of the segmentation process. The background color (black or white) is defined in {{bc | Process | Binary | Options...}} This button can be pressed during any of the previous steps.

===Save segmentator===
You can save the segmentation information into a file by clicking on the "Save segmentator" button. This can be used later to a different image or stack of images by clicking on {{bc | Plugins | Segmentation | Apply SIOX segmentator}} (see next section).
...
'''Step 2''': Click on {{bc | Plugins | Segmentation | Apply SIOX segmentator}}, and the following dialog will pop up:

[[Image:Screenshot-Load-SIOX-segmentator.png | left | thumb | 600 px | Apply SIOX segmentator input dialog]]{{-}}
...
[[Image:Combined-SIOX-Stacks.gif | left | thumb | 1014px | Results of applying the previously calculated SIOX segmentator to a stack of transformed versions of the Leaf sample]]
{{-}}
...
==ImageJ version==
Thanks to {{Person|Rasband}}, there is an [https://imagej.net/plugins/siox/index.html ImageJ] version of this plugin without Fiji dependencies:

[https://imagej.net/plugins/siox/index.html https://imagej.net/plugins/siox/index.html]

==Licenses==
The [https://fiji.sc/cgi-bin/gitweb.cgi?p=fiji.git;a=tree;f=src-plugins/Siox_Segmentation/org;h=902e7e0379b36f7f03b512552fb899861d866fa9;hb=d451306e290fb55a31052cbfc5426eaa70df17d6 SIOX Java library] developed by [http://www.gerald-friedland.org/ Gerald Friedland], [http://www.inf.fu-berlin.de/~jantz Kristian Jantz] and [http://www.inf.fu-berlin.de/~knipping Lars Knipping] is licensed under the '''Apache License''', Version 2.0 (the "License"): [http://www.apache.org/licenses/LICENSE-2.0 http://www.apache.org/licenses/LICENSE-2.0]. Unless required by applicable law or agreed to in writing, software distributed under the License is distributed on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied. See the License for the specific language governing permissions and limitations under the License.

The Fiji plugin GUI, developed by {{Person|Iarganda}}, [http://fly.mpi-cbg.de/~saalfeld/ Stephan Saalfeld] and {{Person|Schindelin}} is free software; you can redistribute it and/or modify it under the terms of the '''GNU General Public License''' as published by the Free Software Foundation ([http://www.gnu.org/licenses/gpl.txt http://www.gnu.org/licenses/gpl.txt]).
