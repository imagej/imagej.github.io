...
All components in this collection are managed by SciJava's [Bill of Materials](/Architecture#Bill_of_Materials) to make it easier for downstream components to use them without version conflicts.
