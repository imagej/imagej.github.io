...
|                                                                                      |                                                                                                                             |                                                                                                              |                                                                                                      |                                                                                                                           |                                                                                                      |                                                                                                       |
| ------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| <a style="text-align center vertical-align: middle%OO% {% include logo content='ImageJ2' %} | <a href="CellProfiler"><img src="/images/pages/Cellprofiler-logo.png" height="64px"/></a> | <a href="KNIME"><img src="/images/pages/Knime-logo.jpg" height="54px"/></a>                                                |                                                                                                      | %NN%text-align center vertical-align: middle" href="OMERO"><img src="/images/pages/Omero-logo.png" height="32px"/></a>             | <a href="https://github.com/scenerygraphics/scenery"><img src="/images/pages/Scenery-logo.png" height="72px"/></a> |                                                                                                       |
| <a style="text-align center vertical-align: middle%OO% {% include logo content='Fiji' %}    | <a href="Icy"><img src="/images/pages/Icy-logo.png" height="48px"/></a>                   | {% include logo content='Micro-Manager' size='48px ' %} | {% include logo content='VCell' size='48px ' %} | {% include logo content='Alida' size='48px ' %} | {% include logo content='MiToBo' size='48px ' %} |
