...
The [[Script Editor]] will automatically search the <code>script_templates</code> directory and register any discovered scripts as templates. For example, a [[Maven|Mavenized]] project could add a sample script in <code>src/main/resources/script_templates</code> and it would be packaged into the appropriate location of the resultant <code>.jar</code>.
