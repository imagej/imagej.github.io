...
When you will need access to those folders, for exemple the "luts" folder in the Dialog opened by {{bc | Color | Edit LUT | Open...}}, you will be able to get into the folder easily using the alias:
