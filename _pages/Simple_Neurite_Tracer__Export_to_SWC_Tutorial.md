...
![Save-all-as-swc.png](/images/pages/Save-all-as-swc.png "Save-all-as-swc.png")
...
\<img src="/images/pages/Simple Neurite Tracer "Export to SWC" Tutorial-1.png" width="750"/\>

Those are actually three disconnected groups of paths, as you can see from the path list:

![Simple\_Neurite\_Tracer\_"Export\_to\_SWC"\_Tutorial-2.png](Simple_Neurite_Tracer_"Export_to_SWC"_Tutorial-2.png "Simple_Neurite_Tracer_\"Export_to_SWC\"_Tutorial-2.png")
...
(Paths are connected when you start one path on another one (branching) or end one path on another one (joining). To find out how to do that, see the [Simple Neurite Tracer: Step-By-Step Instructions](Simple_Neurite_Tracer__Step-By-Step_Instructions "wikilink").)
...
![Simple\_Neurite\_Tracer\_"Export\_to\_SWC"\_Tutorial-3.png](Simple_Neurite_Tracer_"Export_to_SWC"_Tutorial-3.png "Simple_Neurite_Tracer_\"Export_to_SWC\"_Tutorial-3.png")
...
![Snt-set-to-soma.png](/images/pages/Snt-set-to-soma.png "Snt-set-to-soma.png")

You can set each path to a different type in this way, e.g.:

![Snt-after-setting-swc-types.png](/images/pages/Snt-after-setting-swc-types.png "Snt-after-setting-swc-types.png")
