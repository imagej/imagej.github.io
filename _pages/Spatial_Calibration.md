...
8.  Now make a line or area selection. If you use the measure function {% include bc content='Analyze | Measure'%} or {% include key content='Ctrl\|M' %}, the results will be spatially calibrated. ![](/images/pages/SpatialCalibrationSS2.png "fig:SpatialCalibrationSS2.png")
...
![](/images/pages/ImageProperties.png "ImageProperties.png")
