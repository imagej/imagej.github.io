...
![ 300px | Image of a stage micrometer](/images/pages/60Xnooptovar.gif " 300px | Image of a stage micrometer") [300px | Image of a stopped spinning disk confocal scanner head](Image_Disc60xwithoutoptovar.gif "wikilink")
...
6.  Now turn on the "Global" option by clicking the check box, so all open images will take the same spatial calibration when you click OK. (If not then only the image with the line selection is calibrated. <img src="/images/pages/SpatialCalibrationSS1.png" width="700"/>
