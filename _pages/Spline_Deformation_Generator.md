...
{% include component-stats content='sc.fiji:SplineDeformationGenerator\_' %}{% include thumbnail src='/media/Spline-deformations-examples.gif' title='SplineDeformationGenerator available image deformations'%}
