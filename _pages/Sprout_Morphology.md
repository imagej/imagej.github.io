...
Open a maximum intensity projection of the multi-channel image to be analyzed, then start the plugin via {{bc|Analyze|Sprout Morphology}}. The process consists of up to six dialogs:
