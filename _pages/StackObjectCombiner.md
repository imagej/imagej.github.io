...
[[File:SOC_meshes.png|250px]] Meshes listing box<br/>
...
[[File:SOC_autoMerge.png]] Automatic merging box<br/>
This box contain the different parameters to merge the meshes automatically. The parameters correspond to constants inside the plugin, and changing them can help to resolve malfunctioning of the plugin. Here is a description of the different parameters:<br/>
<ul>
...
[[File:SOC_manualMerge.png]] Manual merging box<br/>
...
Once the parameters are set, add the meshes you want to fuse. Select them in the list and click on the ">>>" button. You can also use the shortcut "A" to add a mesh highlighted.<br/>
Finally click on the "Merge" button or use the shortcut "S".

== Example ==

During this example, you can look at the different step with the [https://fiji.sc/3D_Viewer 3DViewer], or with [https://www.blender.org/ Blender].
<ol>
...
T. Boissonnet,"Stack Object Combiner plugin for ImageJ", https://imagej.net/StackObjectCombiner, October 2015
