...
The Stitching package comes with 4 different plugins:
  ...
  - **[ Stitch Directory with Images (unknown configuration)](Stitching_2D/3D#Stitch_Directory_with_Images_unknown_configuration )**: Stitch all images that are located in a given directory without any knowledge of the tile configuration.
