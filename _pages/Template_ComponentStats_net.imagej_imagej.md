...
| source = {{GitHub | org=imagej | repo=imagej | tag=imagej-2.0.0-rc-61}}
| license = [[BSD-2]]
| release = {{Maven | g=net.imagej | a=imagej | v=2.0.0-rc-61 | label=2.0.0-rc-61}}
...
| contributors = {{Person|dscho}}, {{Person|hinerm}}, {{Person|carandraug}}
}}
