<includeonly>[https://javadoc.scijava.org/{{{project|ImageJ}}}{{#if:{{{package|}}}|/{{{package|}}}|}}{{#if:{{{class|}}}|/{{{class}}}.html|/}}{{#if:{{{anchor|}}}|&#35;{{{anchor|}}}|}} {{#if:{{{label|}}}|{{{label}}}|{{{class|{{{project|}}}}}}{{#if:{{{anchor|}}}|&#35;{{{anchor|}}}|}}}}]</includeonly><noinclude>
==Usage==
<pre>
