...
The nominal implementation of the paper remains the one developed under [Matlab](_Category_Matlab ) by Khuloud Jaqaman <i>et al.</i> and published in Nature Methods. The software is called u-track and can be found on [Khuloud Jaqaman homepage](http://www.utsouthwestern.edu/labs/jaqaman/software/).
