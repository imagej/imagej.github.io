...
{% include biginfo-box content='See [:Category:Tracking](_Category_Tracking "wikilink") for pages about particle tracking.' %} {% include learn content='techniques' %} Particle tracking algorithms identify and link objects across multiple images over time.
