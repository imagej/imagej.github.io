...
In this tutorial we describe step by step **how to add new classifiers** to the [Trainable Weka Segmentation](Trainable_Weka_Segmentation "wikilink") plugin using the [Weka package manager](http://weka.wikispaces.com/How+do+I+use+the+package+manager%3F).

### Calling the package manager

We assume you are familiar with the [Trainable Weka Segmentation](Trainable_Weka_Segmentation "wikilink") plugin and know why and how to use it, otherwise, please go back to a more basic tutorial.
