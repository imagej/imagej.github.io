...
| software               = Fiji
| author                 = {{Person|Iarganda}}, Albert Cardona and Stephan Saalfeld
| maintainer             = {{Person|Iarganda}}
| filename               = {{Maven | g=sc.fiji | a=register_virtual_stack_slices}}
| source                 = {{GitHub|org=fiji|repo=register_virtual_stack_slices}}
| released               = September 24<sup>th</sup>, 2009
| latest version         = 3.0.0, February 17<sup>th</sup>, 2016
| status                 = stable, active
| category               = [[:Category:Registration|Registration]], [[:Category:Transform|Transform]]
}}{|
|style="vertical-align:top" | [[Image:Transform Virtual Stack scheme.png|381px|Transform Virtual Stack scheme - All images are transformed based on the XML files]]
|}
...
[[Image:Main-Dialog-Transform Virtual Stack.png|thumb|400px|Transform Virtual Stack main dialog]]
