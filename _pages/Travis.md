...
* Perform [[releases]] of [[SciJava]] projects. Travis deploys release builds to the appropriate Maven repository—typically either the SciJava Maven repository or [https://oss.sonatype.org/ OSS Sonatype].
