...
The dialog is based on the {{ListOfUpdateSites}} wiki page. You can edit that page to add your own update site.
...
# Right click and choose "'''Mark obsolete (unshadowing)'''" for the  file.
# Click "'''Apply changes (upload)'''" to finalize the unshadowing.
...
# Start the [[Updater|updater]] and click the ''Advanced mode'' button.
# Select the ''View files of the '[your site name here]''' option.
# The updater will see the file is missing and automatically flag it  "'''Install it'''". You need to right-click the file and change it to "'''Keep as-is'''". See [[#Why don't I have an upload option?|Why don't I have an upload option?]] below for an explanation.
# Right-click the deleted file again and choose "'''Mark obsolete'''".
# Click "'''Apply changes (upload)'''" to finalize the deletion.
...
* If you using a [[Personal Update Sites|personal update site]], then [[Contact|contact an ImageJ administrator]] to have the offending file(s) removed.
...
Please see the [[Personal Update Site Terms of Service]] page.
...
If you want to completely remove your update site, [[Contact|contact an ImageJ administrator]] to have the site removed.
...
* Be sure to set your upload password for your currently logged-in wiki account. Just click [[Special:ChangeUploadPassword|Set/change upload password]] under the MORE TOOLS section at the bottom of any wiki page.
* Be sure that under “Manage update sites” that your credentials are inserted for your update site. See [[How_to_set_up_and_populate_an_update_site#Uploading_files_to_your_update_site|Uploading files to your update site]] on the ImageJ wiki to double-check how to do this.
