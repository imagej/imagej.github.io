...
Updates will be downloaded to <code>Fiji.app/updates</code>.  The launcher is moving the updates to their final destination on the next reboot (?). 
...
* in case there are updates, <code>CheckForUpdates</code> calls <code>PromptUserToUpdate</code> which invokes <code>net.imagej.ui.swing.updater.ImageJUpdater</code>
