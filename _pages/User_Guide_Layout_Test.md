...
If you want to add other templates, here you can find the ones existing on imagej.net: [https://imagej.net/index.php?title=Special%3AAllPages&from=&to=&namespace=10 Template pages]
...
<br/>
<pre>
{{macOS | Everyone agrees: macOS is the ''best'' operating system!}}
</pre>
{{macOS | Everyone agrees: macOS is the ''best'' operating system!}}
<br/>
<br/>
