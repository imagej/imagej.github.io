...
![ right \| 256px](/images/pages/Loci-logo.png "fig: right | 256px") This account is used to manage the [LOCI update site](http://sites.imagej.net/LOCI/). See also {% include list-of-update-sites%}
.
