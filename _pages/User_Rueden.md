...
}}Curtis Rueden directs the [https://loci.wisc.edu/software/home software development efforts] of [[LOCI]]. He is the principal architect of [[ImageJ2]], and the current maintainer of the [[Fiji]] distribution of ImageJ.
...
# [https://github.com/scijava/pom-scijava pom-scijava] 29.0.0 release.
# '''[[LOCI]] web server downsizing.''' Retiring and migrating services.
# Update [[Fiji]] distribution to use [https://confluence.jetbrains.com/display/JBR/JetBrains+Runtime JBRSDK8] version of Java.
# [https://github.com/imagej/pyimagej PyImageJ] 1.0.0 bug-fixes + release.
# Reconcile latest ImageJ 1.x version with ImageJ2 patching logic ([https://github.com/imagej/ij1-patcher/pull/47 imagej/ij1-patcher#47])
# [https://openjdk.java.net/projects/jigsaw/ JPMS/Jigsaw] modularization. ([https://github.com/scijava/incubator scijava/incubator])
# '''Document community expectations.''' Formally define and clarify who is responsible for maintaining which plugins, to what extents ([https://forum.image.sc/t/project-developer-roles/206 Project developer roles], [https://github.com/ctrueden/ctr-scripts/blob/master/dev-find ctrueden/ctr-scripts:dev-find], [https://github.com/fiji/fiji/blob/master/bin/team-hints.perl fiji/fiji:bin/team-hints.perl])
...
# '''GitHub issue reporting plugin.''' The Fiji BugZilla and ImageJ Trac are now static content only. The [[Report a Bug]] plugin needs to send reports to GitHub instead. ([https://github.com/scijava/scijava-plugins-issues-github scijava/scijava-plugins-issues-github])
...
# '''ImageJ Launcher.''' Switch to a JavaFX-based native launcher. Retire the current ImageJ Launcher. ([https://github.com/imagej/imagej-launcher/issues/33 imagej/imagej-launcher#33])
# '''ImageJ Electron app.''' Shared memory between Java, JavaScript and Python. ([https://github.com/imagej/imagej-electron-app imagej/imagej-electron-app])
...
# (with {{Person|Xanthorapedia}}) '''[[FLIMJ]].'''
# (with {{Person|gselzer}}) '''SciJava Ops''' ([https://github.com/scijava/scijava-ops scijava/scijava-ops]) and '''[[ImageJ Ops]].'''
# (with {{Person|elevans}}) New ImageJ web site. ([https://github.com/imagej/imagej.github.io/tree/jekyll-prototype imagej/imagej.github.io])
...
# User support – questions on the [[Image.sc Forum]], [[Bugs|bug reports]], [https://github.com/search?q=is%3Apr+is%3Aopen+user%3Afiji+user%3Aimagej+user%3Amaven-nar+user%3Ascifio+user%3Ascijava+user%3Aslim-curve&type=Issues pull requests], email
...
|-
| [https://ecd-plugin.github.io/ Enhanced Class Decompiler]
| Automatic decompilation when browsing classes in Eclipse
|-
| colspan=4 |
|-
! rowspan=7 | [https://www.vim.org/ Vim]
| rowspan=7 | Great editor. Crazy fast [https://vim.wikia.com/wiki/Macros macros]
| [https://github.com/VundleVim/Vundle.vim Vundle]
| Manage your vim plugins like a boss
|-
| [https://github.com/tpope/vim-sensible vim-sensible]
...
|-
| colspan=2 | See also [https://github.com/ctrueden/dotfiles/blob/master/vimrc my .vimrc]
|-
| colspan=4 |
|-
! rowspan=6 | [https://www.zsh.org/ Zsh]
| rowspan=6 | Awesome shell – even [https://www.slideshare.net/jaguardesignstudio/why-zsh-is-cooler-than-your-shell-16194692 better than bash]
...
* '''z''' - stop <code>cd</code>ing your life away
* And ''much'' more
|-
...
|-
| [https://github.com/zsh-users/zsh-completions zsh-completion]
| Even more and better tab completions
|-
| colspan=2 | See also [https://github.com/ctrueden/dotfiles/blob/master/zshrc my .zshrc]
|-
| colspan=4 |
|-
! rowspan=2 | [[Git]]
| rowspan=2 | It is worth the pain, I promise
| [https://myrepos.branchable.com/ myrepos]
| Commit, push & pull across repositories [https://github.com/ctrueden/dotfiles/blob/master/mrconfig en masse]
|-
| colspan=2 | See also [https://github.com/ctrueden/dotfiles/blob/master/gitconfig my .gitconfig]
|-
| colspan=4 |
|-
! [[GitHub]]
| colspan=3 | If you don't have a GitHub account, [https://blog.codinghorror.com/how-to-stop-sucking-and-be-awesome-instead/ you don't exist]
|-
| colspan=4 |
|-
! [[Maven]]
| colspan=3 | Build [https://en.wikipedia.org/wiki/Standing_on_the_shoulders_of_giants reusable software components]
|}

See also:
* The [[Dotfiles]] setup guide
* [[Development#Key_developer_tools|Key developer tools]] on this wiki
* [https://loci.wisc.edu/software/developing-loci-software LOCI developer getting started guide]
