...
To add the repository to your list of FiJi update sites, use this address:
  ...
  - http://sites.imagej.net/UniBas-IMCF/

Please see [how to follow a 3rd party update site](how_to_follow_a_3rd_party_update_site "wikilink") for detailed instructions how to enable an additional update site in your Fiji installation.
