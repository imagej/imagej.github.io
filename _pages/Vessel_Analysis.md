...
| filename               = [https://imagej.net/File:Vessel_Analysis.zip  Vessel Analysis.zip]
...
Download the [https://imagej.net/File:Vessel_Analysis.zip Vessel Analysis.zip] package and save an unzipped copy in Fiji's Plugins folder.
...
Also make sure you install [https://imagej.net/plugins/mexican-hat/index.html Mexican Hat Filter]  plugin

== '''Usage:''' ==

Detailed Instructions [https://imagej.net/File:Vessel_Analysis_User_Manual.pdf HERE]
