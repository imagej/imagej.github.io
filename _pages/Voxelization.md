...
# Launch SciView  [[File:launch_threedviewer.png]]  
# Import a 3D mesh (at the time of this writing OBJ, STL, and Isosurfaces taken from a 3D image opened in ImageJ, all work) [[File:import_obj.png]]  
# Convert mesh to image [[File:mesh_to_image.png]]  
# Select output dimensions [[File:mesh_to_image_dimensions.png]]  
# Inspect the result [[File:voxelization_output.png]]  
...
If a filled volume is desired, then take a watertight image (see above) and use the Flood Fill (3D) utility available within [[Fiji]] under the {{bc|Plugins|Process|Flood Fill (3D)}}.
