...
| author                 = Beat Münch
| filename               = install from ImageJ Updater (Help-->Update-->Manage update sites-->Xlib).  Takes repository from https://sites.imagej.net/Xlib
| released               = 01.06.2015
| latest version         = 09.05.2020
| status                 = maintained actively as of May 2020
...
*  [[#Import DMP|"Import DMP"]]: Import elementary image data from ".dmp" files (e.g. originating from [[MATLAB]])
'''Filtering:'''
...
A step by step tutorial for the clustering and phase identification of EDS maps is provided in the manual entitled [[Media:xClusteringPhaseIdentification.pdf|"Instructions for the Phase Clustering and Identification Using the Plugins for ImageJ"]].
...
| last3 = Leemann
| first3 = A
| title = Segmentation of Elemental EDS Maps by Means of Multiple Clustering Combined with Phase Identification
...
A short [[MATLAB]] code for writing such an image variable "image" with the size "width" and "heigth" is given below:
...
Reading the a DMP image with [[MATLAB]] can be achieved like this:
...
{|
|style="vertical-align:top" |[[Image:xFig6_1.jpg|thumb|right|500px|CT slice after strong alcali aggregate reactions (top) and edge preserving / smoothing filtering with a 4x4 median (bottom left) and anisotropic diffusion (bottom right).]]<br />
|}
...
=== Cluster Image ===
[[Image:xFig6_3_1.jpg|thumb|right|600px|Image acquired by BSE and EDX maps at the same local position showing the amounts of Ca, C (1st row),  Al, Cl, Fe, K (2nd row), Mg, Mn, Na, O (3rd row), P, Si, S, Ti (4th row).]]
...
The plugin also allows clustering by using [[Image:xFig6_3_3.jpg|here|30px]] [http://elki.dbs.ifi.lmu.de ELKI] (Environment for Developing KDD-Applications Supported by Index-Structures, developed by the [[Image:xFig6_3_3.jpg|here|30px]] [http://elki.dbs.ifi.lmu.de ELKI] team http://elki.dbs.ifi.lmu.de/wiki/Team).  [[Image:xFig6_3_3.jpg|here|30px]] [http://elki.dbs.ifi.lmu.de ELKI] is an open source data mining software written in Java.  In addition to multiple features, [[Image:xFig6_3_3.jpg|here|30px]] [http://elki.dbs.ifi.lmu.de ELKI] offers various ways for clustering.  A [[Image:xFig6_3_3.jpg|here|30px]] [http://elki.dbs.ifi.lmu.de ELKI] wrapper for the clustering of images is included into the [[#Image Clustering|"Image Clustering"]] plugin.  As soon as the respective elki.jar bundle is copied to the "plugins" directory of the current ImageJ version, image clustering with [[Image:xFig6_3_3.jpg|here|30px]] [http://elki.dbs.ifi.lmu.de ELKI] is possible.  The required specification parameters for the [[Image:xFig6_3_3.jpg|here|30px]] [http://elki.dbs.ifi.lmu.de ELKI] clustering algorithm together with its parameters (details see [[Image:xFig6_3_3.jpg|here|30px]] [http://elki.dbs.ifi.lmu.de ELKI] documentation) can be defined by the user.
...
{|
|style="vertical-align:top" |[[Image:xFig6_4.jpg|thumb|right|800px|3D FIB-nanotomography of cement grains (left), subsequent thresholding (center), disconnected (k=0.7) and labeled particles (right).]]
|}
...
| last3 = Flatt
| first3 = R
| title = FIB Nanotomography of Particulate Systems - Part II: Particle Recognition and Effect of Boundary Truncation
| journal = Journal American Ceramics Society
| volume = 89(8)
| pages = 2586-2595
| year = 2006
}}
...
{|
|style="vertical-align:top" |[[Image:xFig6_5_1.jpg|thumb|right|700px|Binary mask from cement particles (left) and Euclidian distance transform of it (center) and of its reversed mask (right).]]
|}
...
{|
|style="vertical-align:top" |[[Image:xFig6_5_2.jpg|thumb|right|700px|Mask containing 3 black dots only (left) and its Euclidian, Chessboard and Citymap (right) distance transform.]]
|}
...
| last3 = Hesselink
| first3 = W H
| title = A General Algorithm for Computing Distance Transform in Linear Time
| journal = in Proc. Mathematical Morphology and its Applications to Image and Signal Processing, Kluwer
| pages = 331-340
| year = 2000
}}

[[Image:xFig6_6.jpg|thumb|right|600px|FIB-nt image (427x768 pixels) from cement paste (left) and the magnitudes (center) and angles (right) of its Fourier transform.]]
...
[[Image:xFig6_7_01.jpg|right|440px|thumb|left: image i0, 2nd: image i1, 3nd: image i2, right: mean value of the images i0, i1 and i2]]
For instance, 
...
<br />
<br />
[[Image:xFig6_7_02.jpg|right|300px|thumb|left: image i0, right: mask where regions higher than 170 are colored in red]]
The operation 
...
<br />
<br />
[[Image:xFig6_7_03.jpg|right|440px|thumb|left: image i0, 2nd: image i1, 3rd: image i2, right: colored mask out of images i0, i1, i2]]
The operation 
...
<br />
<br />
[[Image:xFig6_7_04.jpg|right|300px|thumb|left: image i0, right: power of two of image i0]]
The operation 
...
<br />
<br />
[[Image:xFig6_7_05.jpg|right|300px|thumb|left: image i0, right: copy of the image i0 overlayed by a horizontal ramp]]
Or the operation 
...
<br />
<br />
[[Image:xFig6_7_06.jpg|right|300px|thumb|left: image i0, right: ramp with the same size as image i0]]
And the code line 
...
<br />
<br />
[[Image:xFig6_7_07.jpg|right|350px|thumb|left: image i0 defining image size, right: halo centered at (100, 200)]]
The code 
...
<br />
<br />
[[Image:xFig6_7_08.jpg|right|300px|thumb|left: image i0, right: binary thresholding of i0 by value 128]]
The line 
...
<br />
<br />
[[Image:xFig6_7_09.jpg|right|300px|thumb|left: image i0, right: circular mask around (100, 200)]]
The command
...
<br />
<br />
[[Image:xFig6_7_10.jpg|right|320px|thumb|left: image i3, right: content of image i3 inside of a circle only]]
...
<br />
<br />
[[Image:xFig6_7_11.jpg|right|360px|thumb|left: image i0, center: image i1, right: exclusive OR of images i0 and i1]]
...
[[Image:xFig6_7_13.jpg|right|350px|thumb|left: image i0, right: message box with number of pixel values >= 10]]
The code fragment 
...
[[Image:xFig6_7_14.jpg|right|500px|thumb|left: image i3, center: image i5, right: image i5 embedded at the center area of image i3]]
...
<br />
<br />
[[Image:xFig6_7_15.jpg|right|500px|thumb|left: image i0, center: image mask i1, right: message box with mean value of i0 within mask i1]]
The code fragment 
...
[[Image:xFig6_7_16.jpg|right|200px]]
<br />
<br />
...
[[Image:xFig6_7_17.jpg|right|200px]]
...
[[Image:xFig6_7_18.jpg|right|380px|thumb]]
...
{|
|[[Image:xFig6_8.jpg|right|400px|thumb|Particle image (left) and its labeling (right)]]
|}
...
{|
|style="vertical-align:top" |[[Image:xFig6_09_1_PhasesMedianFiltering.png|right|500px|Color image containing multiple phases (top left) and different types of median filtering: conventional band-wise (top right), multidimensional geometrical (bottom left), and multidimensional geometrical by choosing the closest available vectors.]]
|}
...
=== Remove Background ===
If an image is subject to consistent global shifts of the image values depending on the location, this might be due to inconsistencies in the data acquisition rather than to real changes in the material properties.  In that case, background removal techniques might be appropriate.
A typical example is image data from FIB-nanotomography (FIB-nt).  Thereby, FIB-nt is applied onto cubes that are engraved into the flat sample surface prior to data acquisition.  Due to shadowing effects, the subsequent 3D data acquisition lacks in loss of brightness and contrast towards the lower boundaries of the slices.  This erroneously causes systematic inhomogeneities of the image values impeding reliable quantitative imaging.
Correction of such deficits can be obtained by determining a global polynomial of low degree over the entire image and by subsequently subtracting the values of the polynomial function from the original image.  The global polynomial function is determined by performing least squares optimization.  Accordingly, systematic brightness variations can be globally corrected.  The necessary assumption is that the overall image values remain more or less constant over the entire image, at least in an average sense.

{|
|style="vertical-align:top" |[[Image:xFig6_9_1.jpg|thumb|right|600px|FIB-nt image with strong shadowing effects (top left), its thresholding (top centre), global polynomial of degree 1 (top right), its subtraction from the original image (bottom left), and its thresholding (bottom right).]]
|}
...
{|
|style="vertical-align:top" |[[Image:xFig6_9_2.jpg|thumb|right|600px|FIB-nt image of a fuel cell and its shadowing effects (left), and the image after correction (right) by assuming three existing phases.]]
|}
...
{|
|style="vertical-align:top" |[[Image:xFig6_11.jpg|thumb|right|700px|Some 3D objects (top), their skeletonization (bottom left) and their restoration by inflating the pipes up to the distance transform values of the original objects (bottom right).]]
|}
...
| last2 = Kuba
| first2 = A
| title = A 3D-Subiteration Thinning Algorithm for Extracting Medial Lines
...
{|
|style="vertical-align:top" |[[Image:xFig6_12_1.jpg|thumb|right|600px|Gray level (top) and RGB (bottom) image containing horizontal stripes (left) and the results of the stripe filtering plugin (right).]]
|}
...
{|
|style="vertical-align:top" |[[Image:xFig6_12_2.jpg|thumb|right|600px|Projection image in a CT slice (top) before (left) and after (right) stripe filtering.  The stripes in the projections yield ring artifacts in the reconstructed image (bottom).  An original (left) and its filtered version (right) is displayed.]]
|}
...
[[Image:xFig6_13.jpg|thumb|right|550px|Flowers image (top left), its transform into polar coordinates (top right), its scaling followed by a rotation (bottom left), its rotation followed by a scaling (bottom right).]]
=== Transform 2D 3D ===
...
[[Image:xFig6_15_lenna.jpg|thumb|right|550px|Well known Lenna image (left), its wavelet decomposition at decomposition level 2 by using the Haar wavelet when providing a nice view (top center) and a reconstructible format (bottom center), and finally, its reconstruction (right).]]
=== Wavelets 2D ===
...
{|
|style="vertical-align:top" |[[Image:xFig7_3_2.jpg|thumb|right|600px|Shaded 3D representation of the reconstructed 3D stacks from the reconstructed volume of the cement paste (left) and the anode membrane (right).]]
|}
...
{|
|style="vertical-align:top" |[[Image:xFig8_1.jpg|thumb|right|600px|Grainy structure (top left), segmented mask of the grains (top right), and the evaluation of its particle size distribution (center and bottom).]]
|}
...
{|
|style="vertical-align:top" |[[Image:xFig8_2.jpg|thumb|right|800px|Phase image (top, left) and the parameters provided for the phase image evaluation (top, right).  The resulting plots and the list of parameters are displayed below.]]
|}
...
| last4 = Holzer
| first4 = L
| title = Influence of Compaction on the Interfacial Transition Zone and the Permeability of Concrete
...
| last3 = Münch
| first3 = B
| title = Influence of Cement Type on ITZ Porosity and Chloride Resistance on Self-Compacting Concrete
...
{|
|style="vertical-align:top" |[[Image:xFig8_3.jpg|thumb|right|800px|3D volume of cement paste (OPC CEM 1, 42.5, w/c 0.35, 28 days hydration) acquired by FIB-nanotomography (top) and its pore size distributions of varying definition (bottom, see referenced paper).]]
|}

The above figure (top) shows a picture of a 3D volume of cement paste measured by FIB-nanotomography at a pixel size of 14.84 x 18.84 x 30.0 nm^3.  The pores have been segmented by thresholding and different definitions of PSD's have been calculated in slice-wise 2D as well as in real 3D (bottom graph, containing the results of the PSD calculations visualized by [[MATLAB]]).
...
| journal = Journal of American Ceramics Society
| volume = 91(12)
| pages = 4059-4067
| year = 2008
}}
...
{|
|style="vertical-align:top" |[[Image:xFig9_1.jpg|thumb|right|700px|Orthogonal slicer view of the nanotomographic 3D volume from cement paste as displayed in the section for the [[#Pore Size Distribution|"Pore Size Distribution"]] plugin (top).]]
|}
...
[[Image:xFig9_3.jpg|thumb|right|800px|Engine for 3D segmentation (top right) which is currently operating on two gray level images (left).  The image at the bottom right is the interactively segmented phase image which is currently containing four different phases (see top left figure for the plugin [[#Phase Image Evaluation|"Phase Image Evaluation"]]).]]
=== Segment Phases 3D ===
...
[[Image:xFig9_4.jpg|thumb|right|600px|Triangulated and shaded visualization of the 3D volume in the plugin for [[#Pore Size Distribution|"Pore Size Distribution"]] and [[#Display Volume|"Display Volume"]].]]
=== View 3D Mask ===
...
--[[User:Beat|Beat]] ([[User talk:Beat|talk]]) 06:26, 1 June 2015 (CDT)
