...
{% include person content='Rueden' %}</p></td><td><p> {% include person content='Rasband' %}</p></td><td><p>See <a href="https://imagej.net/notes.html">release notes</a></p></td></tr><tr class="odd"><td><p> {% include logo content='ImageJ2' %}</p></td><td><p><strong><a href="/software/imagej2">ImageJ2</a></strong></p></td><td><p> {% include person content='Rueden' %}<br />
