...
<figure><img src="/media/cookbook/bleach-correction-window.png" title="bleach_correction_window.png" width="257" height="112" alt="bleach_correction_window.png" /><figcaption aria-hidden="true">bleach_correction_window.png</figcaption></figure>
...
![](/media/cookbook/bleach-raw-data.png)

Bleach corrected time course

![](/media/cookbook/bleach-corrected-data.png)
...
![](/media/cookbook/contrast-window.png)
...
![](/media/cookbook/f-f0-raw.png) ![](/media/cookbook/f-f0-corrected.png)
...
![](/media/cookbook/delta-f-raw.png)

**Raw**

![](/media/cookbook/delta-f-corrected.png)
...
![](/media/cookbook/surface-plot-compare.png)
...
<figure><img src="/media/cookbook/analyze-surface.png" title="analyze_surface.png" width="212" height="243" alt="analyze_surface.png" /><figcaption aria-hidden="true">analyze_surface.png</figcaption></figure>
