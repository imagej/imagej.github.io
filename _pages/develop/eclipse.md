...
**Understand Java 6 vs. Java 8.** Eclipse should work on OS X with no further configuration. However, we recommend reading the [OS X section of the FAQ](/help/faq#mac-os-x), as there are several Java-related issues on OS X. </tab> <tab name="/platforms/linux"> ![ x32px](/media/Tux.png "fig: x32px") **Linux**
