...
One major problem when debugging [ImageJ 1.x](/software/imagej-1.x) plugins is
...
* {% include github org='imagej' repo='example-legacy-plugin' label='example-legacy-plugin' %} ([ImageJ 1.x](/software/imagej-1.x)-style command)
