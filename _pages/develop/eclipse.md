...
This article explains how to install, configure and use Eclipse to develop [ImageJ](/about) [components](/Architecture#Definitions) and [plugins](/fiji/plugins). Directions correspond to Eclipse 4.4 Luna, and may need adjustment for other versions.
...
**Understand Java 6 vs. Java 8.** Eclipse should work on OS X with no further configuration. However, we recommend reading the [OS X section of the FAQ](FAQ#Mac_OS_X), as there are several Java-related issues on OS X. </tab> <tab name="/platforms/linux"> ![ x32px](/media/Tux.png "fig: x32px") **Linux**
