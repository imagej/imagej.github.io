...
With the original [ImageJ](/software/imagej), a special [HandleExtraFileTypes](https://imagej.net/ij/plugins/file-handler.html) plugin exists that can be modified to support new data formats—but it has some significant disadvantages:
