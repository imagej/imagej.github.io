...
many developers in this community use [Eclipse](/develop/eclipse) and the [command line](/develop/command-line).
...
ImageJ can be developed using any IDE which supports [Maven](/develop/maven), which includes:
