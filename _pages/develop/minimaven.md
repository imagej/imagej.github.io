...
Therefore we needed a system to build [ImageJ 1.x](/software/imagej-1.x), [ImageJ2](/software/imagej2) and [Fiji](/software/fiji) quickly from the same type of project description files as Maven interprets, to be maximally flexible and interoperable.
