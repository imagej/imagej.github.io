...
{% include img src="diadem-challenge-data-1" %}
...
{% include img src="diadem-challenge-data-2" %}
...
{% include img src="diadem-challenge-data-4" %}
...
{% include img src="diadem-challenge-data-6" width="750" %}
...
{% include img src="diadem-challenge-data-7" %}
...
{% include img src="diadem-neocortical-layer-6-axons-1" %}
...
{% include img src="diadem-neocortical-layer-6-axons-2" width="750" %}
...
{% include img src="diadem-neocortical-layer-6-axons-3" %}
...
{% include img src="diadem-neocortical-layer-6-axons-4" width="750" %}
...
{% include img src="diadem-neocortical-layer-6-axons-7" %}

Then the traces should load in the correct position with those offsets:

{% include img src="diadem-neocortical-layer-6-axons-6" width="750" %}
...
{% include img src="diadem-cerebellar-1" %}
...
{% include img src="diadem-cerebellar-2" width="750" %}
...
{% include img src="diadem-cerebellar-3" width="750" %}
...
{% include img src="diadem-cerebellar-4" width="750" %}
...
{% include img src="diadem-cerebellar-5" %}
...
{% include img src="diadem-cerebellar-6" width="750" %}
...
{% include img src="diadem-cerebellar-7" %}
...
{% include img src="diadem-cerebellar-7b" %}
...
{% include img src="diadem-cerebellar-8" width="750" %}
...
{% include img src="diadem-hippocampal-ca3-interneuron-2" %}

That should load in the image data:

{% include img src="diadem-hippocampal-ca3-interneuron-3" width="750" %}
...
{% include img src="diadem-hippocampal-ca3-interneuron-4" width="750" %}

... and invert the image with {% include bc path='Edit | Invert'%}, saying "Yes" to the question about whether to process all 110 slices:

{% include img src="diadem-hippocampal-ca3-interneuron-5" width="750" %}
...
{% include img src="diadem-hippocampal-ca3-interneuron-6" %}
...
{% include img src="diadem-hippocampal-ca3-interneuron-7" width="750" %}

Then you can load the SWC files via "Load Traces / SWC file" with these options:

{% include img src="diadem-hippocampal-ca3-interneuron-8" %}
...
{% include img src="diadem-hippocampal-ca3-interneuron-9" width="750" %}
...
{% include img src="neuromuscular-0-7-stitched" width="750" %}
