...
title: DokuWiki Migration (Legacy)
---

## Notice

This page is now outdated as the wiki has migrated again to [Jekyll](https://jekyllrb.com/) hosted on [GitHub pages](https://pages.github.com/).

Please see the [current editing guide](help/editing/) for ImageJ-specific instructions.
