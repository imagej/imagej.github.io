...
![Colocblur](/media/imaging/colocblur.gif)
...
If the blurring of you images is too much, you might want to consider [deconvolution](/imaging/deconvolution). Have a look at [this page](https://svi.nl/BlurAndNoiseAffectColocalization) from SVI, the guys that provides [Huygens](https://svi.nl/) software to see how it can help.

  

### Background

![Colocbgnoise](/media/imaging/colocbgnoise.gif)
...
{% include img src="500px-crosstalkbleedthrough" alt="Fluorophore crosstalk and bleedthrough spectra" width="500" %}
...
{% include img src="500px-colocalizationsampling" alt="Colocalization spatial sampling diagram" width="500" %}
