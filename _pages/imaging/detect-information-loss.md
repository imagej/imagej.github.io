...
{% include wikipedia title='Lossy data compression' %}
...
## Intensity Saturation or Clipping or Over Exposure

{% include wikipedia title='Overexposure' %}
...
{% include img src="saturateddapihistogram" %}
