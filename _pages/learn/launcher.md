...
**(or: how to separate Java options and Fiji options from command line options)**
...
-   In the presence of a double-dash, Fiji options have to go *before* the *--* (this is to allow passing options to the Java program that would be mistaken for Fiji options otherwise).
