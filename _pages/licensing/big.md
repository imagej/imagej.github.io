...
Components distributed via the [BIG-EPFL update site](/update-sites/big-epfl) were developed by the [Biomedical Imaging Group](http://bigwww.epfl.ch/) (BIG) at the [École Polytechnique Fédérale de Lausanne](http://epfl.ch/) (EPFL).
