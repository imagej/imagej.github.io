...
We have designed initial versions of several aspects of the ImageJ2 architecture, including the [image data model](/plugins/imagej-common), and [IJ2 plugin architecture](/Architecture#Extensibility). At this point, everything is completely subject to change, with many things not yet ready for public review.
