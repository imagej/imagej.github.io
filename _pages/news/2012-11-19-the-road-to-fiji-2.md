...
{% include img src="/media/news/ij2-screenshot.jpg" align="center" width="665" caption="ImageJ2 screenshot" %}
...
{% include img src="/media/news/fiji-modular.png" align="center" width="665" caption="Modules in Fiji" %}
...
{% include img src="/media/news/ij2-jenkins.png" align="center" width="665" caption="Automated regression testing" %}
...
{% include img src="/media/news/fiji-continuous-releases.jpg" align="center" width="665" caption="Continuous Fiji releases" %}
...
{% include img src="/media/news/ij2-trac.jpg" align="center" width="610" caption="ImageJ2 Project Management" %}

## Fiji vs Fiji2

What will change with Fiji2 is best illustrated by this figure:

{% include img src="/media/news/fiji2-roadmap.png" align="center" width="665" caption="Fiji will become Fiji2" %}
...
{% include img src="/media/news/ij2-updater.png" align="center" width="664" caption="ImageJ2 updater" %}
...
{% include img src="/media/news/ij2-script-editor.png" align="center" width="624" caption="ImageJ2 Script Editor" %}
...
{% include img src="/media/news/ij2-legacy-mode.png" align="center" width="665" caption="ImageJ2 legacy mode" %}
