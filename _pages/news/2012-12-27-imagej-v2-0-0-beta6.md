...
{% include img align="right" src="/media/news/legacy-mode.gif" caption="Legacy mode: ImageJ2&apos;s legacy mode provides total compatibility with ImageJ1." width="571px" %}
