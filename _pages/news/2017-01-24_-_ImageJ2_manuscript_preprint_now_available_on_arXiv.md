...
This manuscript provides a technical overview of [ImageJ2](/software/imagej2), including in-depth description of the [architecture](/develop/architecture), with sections on [SciJava Common](/libs/scijava-common), [ImageJ Common](/plugins/imagej-common), [SCIFIO](/software/scifio), [ImageJ Ops](/libs/imagej-ops), [ImageJ Legacy](/Compatibility), and the [ImageJ Updater](/plugins/updater), as well as a discussion on how ImageJ2 improves upon key areas of functionality, [extensibility](/develop/architecture#extensibility), [reproducibility](/develop/architecture#reproducible-builds), usability, performance, [compatibility](Compatibility) and [community](/help).
