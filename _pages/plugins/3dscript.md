...
{% endcapture %}
{% include info-box software='Create high-quality 3D/4D animations using a natural-language based syntax' logo='/media/logos/3dscript.png' name='3Dscript' maintainer=maintainer author=author source=source status='active' released='January 2019' category='Visualization, Plugins' %}
