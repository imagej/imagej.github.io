...
{% endcapture %}
{% include info-box name='AplimTools' software='Fiji' author='Romain Fernandez & Bamba Diop' maintainer='Romain Fernandez' source=source released='March 23<sup>th</sup>, 2020' status='unstable, active' category='[Analysis](/plugin-index#analysis)' %}
