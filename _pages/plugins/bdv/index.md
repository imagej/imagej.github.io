...
We have documented the steps and software needed to execute the above mentioned Fiji plugin on a cluster computer on [**this wiki page**](/plugins/spim-registration/on-cluster). Specifically, the sections [**Define XML**](SPIM_Registration_on_cluster#Define_XML) and [**Re-save as HDF5**](SPIM_Registration_on_cluster#Re-save_as_HDF5) deal with the conversion process.
