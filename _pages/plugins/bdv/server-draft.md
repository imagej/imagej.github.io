...
{% endcapture %}
{% include info-box name='BigDataServer' software='Fiji' author=author maintainer=maintainer source=source latest-version='1.0.5' status='experimental' category='[Visualization](/plugin-index#visualization), [Transform](/plugin-index#transform)' %}
...
The web interface of /manager context looks like this: <img src="/media/plugins/bdv/bigdataserver-manager.png" width="600"/>
