...
![BigStitcher interest point detection initial dialog](/media/plugins/bigstitcher/bigstitcher-register-1.png)
...
<img src="/media/plugins/bigstitcher/bigstitcher-register-2.png" alt="Register 2" width="600"/>
...
![BigStitcher interactive detection preview with grouped views](/media/plugins/bigstitcher/bigstitcher-register-3.png)
...
![BigStitcher interactive interest point detection window](/media/plugins/bigstitcher/bigstitcher-register-4-1.png)![BigStitcher detected interest points preview](/media/plugins/bigstitcher/bigstitcher-register-4-2.png)
...
![BigStitcher GPU CUDA directory selection dialog](/media/plugins/bigstitcher/bigstitcher-interestpoint-gpu-1.png)
...
![BigStitcher GPU separable convolution library selection](/media/plugins/bigstitcher/bigstitcher-interestpoint-gpu-2.png)
...
![BigStitcher GPU device and memory selection dialog](/media/plugins/bigstitcher/bigstitcher-interestpoint-gpu-3.png)
