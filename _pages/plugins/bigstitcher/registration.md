...
In addition to the descriptor-based registration algorithm, we also offer registration via a slightly modified version of the [Iterative Closest Point (ICP)](https://en.wikipedia.org/wiki/Point_set_registration#Iterative_closest_point\|) algorithm.
