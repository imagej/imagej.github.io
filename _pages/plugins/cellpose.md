...
{% include img name="cellpose-icon" src="/media/icons/cellpose.png" width="150px" %} ![External image](https://fiji.sc/site/logo.png){:width="150px"}
...
- [Fiji-Cellpose](https://imagej.net/plugins/fiji-cellpose): handles `Cellpose` thanks to [Appose](https://apposed.org/).
  Appose creates and activates python virtual environment automatically, without any action from the user.
  
{% include notice icon="info" content="In addition of the online documentation, this [youtube tutorial](https://www.youtube.com/watch?v=orySPQ2Hk-w) shows how to use this plugin." %}
...
{% include notice icon="info" content="In addition of the online documentation, this [tutorial](https://github.com/AlexHego/Cellpose_TrackMate_LiveCell) guide you through the installation and usage of TrackMate-Cellpose, including creation of the python environment. " %}
