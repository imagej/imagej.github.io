...
{% include info-box software='ImageJ/Fiji' name='CIP' update-site='CIP' author=benoalo maintainer=benoalo released='January 2018' filename='CIP update site' source='https://github.com/benoalo/CIP' category='[Scripting](/plugin-index#scripting)' %}
