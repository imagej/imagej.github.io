...
![Linetool](/media/linetool.png) ![Seedingline](/media/plugins/seedingline.png)

Open the LRoi plugin and specify the number of ROIs you want to create, the ROI width and height.

![Lroi example](/media/plugins/lroi-example.png) ![Lroi length](/media/plugins/lroi-length.png)
...
![Rois example](/media/plugins/rois-example.png)
