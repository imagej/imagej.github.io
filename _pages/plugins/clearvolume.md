...
artifact: sc.fiji:imglib-clearvolume
logo: /media/clearvolumelogo.png
website: https://clearvolume.github.io/
---

ClearVolume is a volume renderer developed at MPI-CBG.
This plugin enables you to use ClearVolume from within ImageJ.
