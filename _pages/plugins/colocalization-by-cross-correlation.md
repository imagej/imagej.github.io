...
$$\lim\limits_{n \to \infty} \left(\frac{\sum_{i=1}^n \left(rand\(Img1\)_i \bigstar Img2\right)}{n}\right) = \lim\limits_{n \to \infty} \left(\left(\frac{\sum_{i=1}^n \left(rand\(Img1\)_i}{n} \right)\bigstar Img2\right)$$
