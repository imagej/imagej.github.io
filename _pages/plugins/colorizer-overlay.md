...
{% include info-box software='ImageJ1' name='Colorizer\_Overlay' author='Fred Damen' filename='Colorizer\_Overlay.jar' source=' [Colorizer\_Overlay.zip](/media/colorizer-overlay.zip)' released='1 April 2020' status='stable' category='[Image annotation](/plugin-index#image-annotation)' website='' %}
...
Unzip [Colorizer\_Overlay.zip](/media/colorizer-overlay.zip) into ImageJ1 plugins {% include bc path="File|Show Folder|Plugins" %} or plugins/jars directories. Source code in jar file.  
