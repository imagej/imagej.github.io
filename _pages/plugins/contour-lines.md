...
![CL2](https://katpyxa.info/software/ContourLines/CL2.gif)

## Parameters

After plugin launch, rendering parameters window will appear

![CL parameters dialog](https://katpyxa.info/software/ContourLines/CL_parameters_dialog.png)
...
![Smoothing 2 line 0.05 distance 3](https://katpyxa.info/software/ContourLines/smoothing_2_line_0.05_distance_3.png) ![Smoothing 10 line 0.05 distance 3](https://katpyxa.info/software/ContourLines/smoothing_10_line_0.05_distance_3.png)
...
![Smoothing 2 line 0.05 distance 3](https://katpyxa.info/software/ContourLines/smoothing_2_line_0.05_distance_3.png) ![Smoothing 2 line 0.5 distance 3](https://katpyxa.info/software/ContourLines/smoothing_2_line_0.5_distance_3.png)

### Distance between lines

Well, how densely you want contour lines to be plotted. Left image is 3 px, right image is 10 px.

![Smoothing 2 line 0.05 distance 3](https://katpyxa.info/software/ContourLines/smoothing_2_line_0.05_distance_3.png) ![Smoothing 2 line 0.05 distance 10](https://katpyxa.info/software/ContourLines/smoothing_2_line_0.05_distance_10.png)
...
![Smoothing 2 line 0.05 distance 3 x](https://katpyxa.info/software/ContourLines/smoothing_2_line_0.05_distance_3_x.png) ![Smoothing 2 line 0.05 distance 3 single color end 0.1](https://katpyxa.info/software/ContourLines/smoothing_2_line_0.05_distance_3_single_color_end_0.1.png)

### Use single color

With this option checked, plugin will use current selected color (in toolbar or Color Picker) to build lines. Example:

![Smoothing 2 line 0.05 distance 3 single color](https://katpyxa.info/software/ContourLines/smoothing_2_line_0.05_distance_3_single_color.png)
...
![Smoothing 2 line 0.05 distance 3](https://katpyxa.info/software/ContourLines/smoothing_2_line_0.05_distance_3.png) ![Smoothing 2 line 0.05 distance 3 not inverted thermal](https://katpyxa.info/software/ContourLines/smoothing_2_line_0.05_distance_3_not_inverted_thermal.png)
...
![Smoothing 2 line 0.05 distance 3 x](https://katpyxa.info/software/ContourLines/smoothing_2_line_0.05_distance_3_x.png) ![Smoothing 2 line 0.05 distance 3 single color closed only](https://katpyxa.info/software/ContourLines/smoothing_2_line_0.05_distance_3_single_color_closed_only.png)
