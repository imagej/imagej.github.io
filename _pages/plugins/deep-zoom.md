...
The CHAINED code is [here](https://github.com/uw-loci/deep-zoom-plugin/tree/-/src/main/java/loci/chainableplugin).  SINGLEINSTANCE and MULTIINSTANCE both use the same package [here](https://github.com/uw-loci/deep-zoom-plugin/tree/-/src/main/java/loci/multiinstanceplugin).  (There's also some experimental workflow code in this project [here](https://github.com/uw-loci/deep-zoom-plugin/tree/-/src/main/java/loci/deepzoom/workflow), tested [here](https://github.com/uw-loci/deep-zoom-plugin/tree/-/src/test/java/loci/workflow).  This creates a workflow/pipeline of components (chunks of code or plugins) with named input and output images chained together.  A workflow may be a component.  Workflows can be saved/restored to/from XML.)
