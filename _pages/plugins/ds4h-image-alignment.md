...
- [ImageJ/Fiji plugin](https://github.com/UniBoDS4H/IA/releases) (".jar" file), to be copied in the plugins folder of ImageJ or Fiji, available for Mac (Intel or ARM chip), Windows, Linux.
