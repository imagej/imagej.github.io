...
- ".jar" file at https://github.com/UniBoDS4H/IA/releases, to be copied in the plugins folder of ImageJ or Fiji, available for Mac (Intel or ARM chip), Windows, Linux.
