...
{% include github org='fiji' repo='Fiji_Plugins' source='fiji/stacks/Dynamic_Reslice.java' %}
...
Download the jar file [Dynamic_Reslice.jar](https://fiji.sc/tinevez/Dynamic_Reslice.jar) and drop it into the *plugins* menu. The plugin will appear in the {% include bc path='Plugins | Dynamic_Reslice' %} menu.

### Fiji

The plugin is part of the Fiji distribution, as a member of the [Fiji_Plugins](/plugins/fiji-plugins) package. You can find it in the {% include bc path='Image | Stacks' %} menu.
...
![](/media/dynamicresliceroi.gif) ![](/media/dynamicreslice.gif)
