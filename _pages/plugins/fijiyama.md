...
-   Rigid transformations (translation + rotation), estimated using [VIB-lib](/software/vib-lib)
-   Similarities (rigid + isotropic homothetic factor) estimated using [VIB-lib](/software/vib-lib)
