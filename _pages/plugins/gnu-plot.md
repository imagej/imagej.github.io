...
{% include info-box software='ImageJ 1.x' name='Gnu\_Plot' author='Fred Damen' Maintainer='Fred Damen' filename='Gnu\_Plot.jar' source=' [Gnu\_Plot.zip](/media/plugins/gnu-plot.zip)' released='1 April 2020' status='stable' category='Plotting' website='' %}
