...
<<<<<<< HEAD
{% include info-box software='ImageJ1' name='Gnu\_Plot' author='Fred Damen' Maintainer='Fred Damen' filename='Gnu\_Plot.jar' source=' [Gnu\_Plot.zip](/media/gnu-plot.zip)' released='1 April 2020' status='stable' category='[Plotting](Category_Plotting)' website='' %}
=======
{% include info-box software='ImageJ1' name='Gnu\_Plot' author='Fred Damen' Maintainer='Fred Damen' filename='Gnu\_Plot.jar' source='[Gnu\_Plot.zip](/media/Gnu_Plot.zip)' released='1 April 2020' status='stable' category='[Plotting](Category_Plotting)' website='' %}
>>>>>>> ea70f1166 (WIP)
