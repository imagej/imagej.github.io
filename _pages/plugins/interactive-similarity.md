---
mediawiki: Interactive_Similarity
title: Interactive Similarity
categories: [Plugins,Transform]
---

{% include info-box name='Interactive Similarity' software='Fiji' author='Stephan Saalfeld' maintainer='Stephan Saalfeld' source=' [in gitweb](https://fiji.sc/cgi-bin/gitweb.cgi?p=mpicbg.git;a=blob;f=Transform_Similarity.java)' released='November 22<sup>th</sup>, 2008' latest-version='December 15<sup>th</sup>, 2008' status='stable' category='[Transform](/plugin-index#transform), [Plugins](/plugin-index)' %}
