...
![LLTT update site items to install](/media/plugins/lltt-install4.jpg)

## Install the required files

![LLTT required files for installation](/media/plugins/lltt-install5.jpg)
...
![LLTT plugin startup dialog](/media/plugins/lltt-start1.jpg)

## Set global options

Upon startup of the plugin you will be asked to enter three values.

![LLTT global options dialog for 2D data](/media/plugins/lltt-globaloptions2d.jpg)
...
![LLTT main data window and kymographs](/media/plugins/opendatasmall.png) ![LLTT control window](/media/plugins/controlwindownew.png)
...
![LLTT new session dialog](/media/plugins/lltt-choosesession.jpg)
...
![LLTT session options dialog with sigma settings](/media/plugins/sessionoptions.png)
...
![LLTT tracked objects shown as circles in main window](/media/plugins/createdots.png)
...
![LLTT edit object parameters dialog](/media/plugins/objectoption.png)
...
![LLTT tracking result filling kymograph line](/media/plugins/result1.png)
...
![LLTT tracking results table with trace frame ranges](/media/plugins/result2.png)
...
![LLTT 3D data windows with side projections](/media/plugins/newwindows.jpg)
...
![LLTT 3D tracking with object marker](/media/plugins/newwithdot.jpg)
...
![LLTT multiscale tracking options dialog](/media/plugins/mscaleoptions.png)
