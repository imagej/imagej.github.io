...
{% endcapture %}
{% include info-box name='LungJ' author='[Lasse Wollatz](/users/LungJ)' maintainer='[Lasse Wollatz](/users/LungJ)' software='ImageJ/Fiji' logo='<img src="/media/icons/lungj.png" title="fig:LungJ-logo.png" width="200" alt="LungJ-logo.png" />' source=source released='Nov 10<sup>st</sup>, 2016' latest-version='0.5.1, November 10<sup>th</sup>, 2016 (LungJ v0.5.1)' status='stable, new' category='[Segmentation](/plugin-index#segmentation), [Binary](/plugin-index#binary), [Filtering](/plugin-index#filtering), [Image annotation](/plugin-index#image-annotation)' %}
