...
![Microscope meas tools choose calibration 01](/media/microscope-meas-tools-choose-calibration-01.png)

The "Draw Measurement" plugin then allows you to draw a line with the calibrated measurement length, as so:

![Microscope meas tools draw meas line](/media/microscope-meas-tools-draw-meas-line.png)
