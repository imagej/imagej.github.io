...
dev-status: "stable"
team-founder: '@mhl and Greg Jefferis'
team-maintainer: '@mhl'
---
...
![Landmarks 00 no points yet](/media/plugins/landmarks-00-no-points-yet.png)
...
![Landmarks 01 named unset](/media/plugins/landmarks-01-named-unset.png)
...
![Landmarks 02 point roi selected](/media/plugins/landmarks-02-point-roi-selected.png)

... and after step 3 (clicking the appropriate button to mark the point) it should like this:

![Landmarks 03 point named](/media/plugins/landmarks-03-point-named.png)
...
![Landmarks 04 second point set](/media/plugins/landmarks-04-second-point-set.png)
...
![Landmarks 05 six points set](/media/plugins/landmarks-05-six-points-set.png)
...
![Landmarks 06 template set](/media/plugins/landmarks-06-template-set.png)
...
![Landmarks 07 floating image](/media/plugins/landmarks-07-floating-image.png)
...
![Landmarks 09 registered and overlayed](/media/plugins/landmarks-09-registered-and-overlayed.png)
