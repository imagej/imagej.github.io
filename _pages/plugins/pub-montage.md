...
<img src="/media/temp.jpg" alt="Pub Montage example output 1" width="1070"/> <img src="/media/plugins/temp2.jpg" alt="Pub Montage example output 2" width="1070"/>
...
The main window is shown to the right. It puts the controls at your fingertips from the beginning. In most cases after you click "OK" on this window, the plugin will proceed directly to building your montage unless you have selected the "Yes" option for editing the stack order. <img src="/media/window1.jpg" alt="Pub Montage main window dialog" width="400"/>
