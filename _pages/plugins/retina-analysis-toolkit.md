...
=======
{% include info-box logo='![ 96px](/media/fiji-icon.png "fig: 96px")' software='ImageJ' name='RETINA Analysis Toolkit' author='[**Daniel E. Maidana**](https://www.researchgate.net/profile/Daniel_Maidana2)\n[**Demetrios G. Vavvas**](https://www.masseyeandear.org/research/investigators/v/vavvas-demetrios-g)' maintainer='**Daniel E. Maidana**\nAngiogenesis Laboratory\nMassachusetts Eye and Ear Infirmary\nHarvard Medical School\nEmail: [Daniel Maidana](mailto:dmaida3@uic.edu)' filename='[TUNEL Cell Counter Macro](https://github.com/DanielMaidana/TUNEL_Cell_Counter/archive/master.zip)' source='[TUNEL Cell Counter Repository](https://osf.io/9rveh/)' released='August 18<sup>th</sup>, 2015' latest-version='July 21<sup>th</sup>, 2016' status='Active and validated with Fiji (ImageJ 1.51d)' website='[RETINA Analysis Toolkit at YouTube](https://www.youtube.com/channel/UCqGMCPY9ViyAPWhYciRNuKQ)' %}
