...
{% include info-box logo='![ 96px](/media/fiji-icon.png)' software='ImageJ' name='RETINA Analysis Toolkit' author=' [**Daniel E. Maidana**](https://www.researchgate.net/profile/Daniel_Maidana2)  
