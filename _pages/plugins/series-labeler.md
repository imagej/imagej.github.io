...
{% include component-stats content='sc.fiji:Series\_Labeler' %}This plugin is inspired by the [Time Stamper](/plugins/time-stamper) plugins from ImageJ and from Tony Collins' [MBF Plugin Collection](/software/mbf-imagej), as well as the imageJ built-in {% include bc path='Image|Stack|Label'%} command.
