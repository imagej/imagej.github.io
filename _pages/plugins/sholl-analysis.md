...
{% include figure-right name="extended-fitting" src="/media/animatedpolyfit.gif" content="Sampled data from the ddaC cell being fitted to polynomials of varying degree using a complementary [BAR](/plugins/bar) script."%}
