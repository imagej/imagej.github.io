...
Would you like to help, but Java is not your thing? That is fine. You should know that Java is not the favorite programming language of SNT developers either. You prefer Python? Julia? R? Great! There is a broad interest in linking SNT functionality to other programming languages. If you are familiar with with Python have a look at [PySNT](https://github.com/morphonets/pysnt). Development of SNT follows the same [open process](/contribute/fiji#open-development-process) followed by Fiji. Do [reach out](https://forum.image.sc/tag/snt) with your ideas!
