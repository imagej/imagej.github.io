...
{% capture title%}
Synthetic neuron generated using the {% include bc path='Demo|Cx3D|Random Branching'%} command ([source code](https://github.com/morphonets/cx3d/blob/master/src/main/java/sc/iview/cx3d/commands/RandomBranchingDemo.java)), accessible from SciView's main menu.
{% endcapture %}
