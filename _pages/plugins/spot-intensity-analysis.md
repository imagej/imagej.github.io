...
release-date: "2018/01/18 - version 0.3"
initial-release-date: "2015/09/15"
team-founder: '@nicost'
team-maintainer: '@nicost'
team-contributors: [Ankur Jain]
source-url: https://github.com/nicost/spotIntensityAnalysis
---
...
![Spotintensityanalysisimage](/media/plugins/spotintensityanalysisimage.jpg) ![Spotintensityprofile](/media/plugins/spotintensityprofile.png)
...
![Spotintensityanalysisscreenshot](/media/plugins/spotintensityanalysisscreenshot.png) ![Spotintensityanalysistable](/media/plugins/spotintensityanalysistable.png)
