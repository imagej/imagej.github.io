...
![ComDet plugin launch dialog](https://katpyxa.info/software/ComDet/ComDet_open_v.0.5.0.png)

## Simple detection (1 channel)

If the image is not multi-channel image, the following dialog window will appear:

![ComDet single-channel detection parameters dialog](https://katpyxa.info/software/ComDet/ComDet_detection_only_v0.5.0.png)
...
![ComDet preview mode showing particle detection](https://katpyxa.info/software/ComDet/ComDet_preview_button.gif)
...
![ComDet detection results with ovals overlaid on particles](https://katpyxa.info/software/ComDet/ComDet_detection_before_after_v2.png)
...
![Image with ROI selected before running ComDet detection](https://katpyxa.info/software/ComDet/ComDet_ROI_before_v2.png)

In this case only particles in that ROI will be detected (also supported in "*Preview..*" mode):

![ComDet detection results limited to selected ROI](https://katpyxa.info/software/ComDet/ComDet_ROI_after_v2.png)
...
![ComDet multi-channel detection and colocalization dialog](https://katpyxa.info/software/ComDet/ComDet_detection_and_coloc_v0.5.0.png)
...
![ComDet per-channel detection parameter windows](https://katpyxa.info/software/ComDet/ComDet_detection_and_coloc_v0.5.0_multich.png)
...
![ComDet colocalized particles marked in overlapping color](https://katpyxa.info/software/ComDet/ComDet_detection_and_coloc_mark_v2.png)
...
![ComDet Results table with particle coordinates and channel info](https://katpyxa.info/software/ComDet/Results_v.0.5.0.png)
