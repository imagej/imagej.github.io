...
{% include thumbnail src='/media/plugins/3dstitching.png' title='Shows the 3D Stitching Dialog.'%}  
...
{% include thumbnail src='/media/plugins/stitchgrid.png' title='Shows the Stitch Grid Dialog.'%}  
...
{% include thumbnail src='/media/plugins/stitchcollection.png' title='Shows the Stitch Image Collection Dialog.'%}  
