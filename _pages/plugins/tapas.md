...
-   Install [ImageJ](https://imagej.net/ij/) or [Fiji](http://fiji.sc/).
...
-   Download ![Bundle tapas0.6.3](/media/plugins/bundle-tapas0.6.3.zip) and unzip it into the ImageJ or Fiji directory.
