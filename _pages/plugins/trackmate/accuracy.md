...
<div class="row">
  <div class="column3">
{% include img align="fit" name="Low density" src="/media/plugins/trackmate/vesicle-snr-7-density-low-1.png" %}
  </div>
  <div class="column3">
{% include img align="fit" name="Medium density" src="/media/plugins/trackmate/vesicle-snr-7-density-mid-1.png" %}
  </div>
  <div class="column3">
{% include img align="fit" name="High density" src="/media/plugins/trackmate/vesicle-snr-7-density-high-1.png" %}
  </div>
</div>
...
<div class="row">
  <div class="column5">
{% include img align="fit" name="SNR = 7" src="/media/plugins/trackmate/receptor-snr-7-density-low-1.png" %}
  </div>
  <div class="column5">
{% include img align="fit" name="SNR = 4" src="/media/plugins/trackmate/receptor-snr-4-density-low-1.png" %}
  </div>
  <div class="column5">
{% include img align="fit" name="SNR = 3" src="/media/plugins/trackmate/receptor-snr-3-density-low-1.png" %}
  </div>
  <div class="column5">
{% include img align="fit" name="SNR = 2" src="/media/plugins/trackmate/receptor-snr-2-density-low-1.png" %}
  </div>
  <div class="column5">
{% include img align="fit" name="SNR = 1" src="/media/plugins/trackmate/receptor-snr-1-density-low-1.png" %}
  </div>
</div>
...
{% include img align="fit" name="SNR = 4, density = mid" src="/media/plugins/trackmate/microtubule-snr-4-density-mid-1.png" %}
