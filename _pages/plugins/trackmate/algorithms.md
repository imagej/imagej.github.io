...
description: Description of the algorithms used in TrackMate.
extensions: ["mathjax"]
---
...
The new detectors introduced in the version 7 of TrackMate and that can segment objects in 2D are documented [here](/plugins/trackmate/trackmate-v7-detectors). 
...
These morphological analyzers are documented in the page dedicated to the [v7 novelties](/plugins/trackmate/trackmate-v7-detectors#object-morphology-analysis).
