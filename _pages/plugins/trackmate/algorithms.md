...
{% include img src='/media/plugins/trackmate/trackmate-track-features.png' width='400px' %}
...
{% include img src='/media/plugins/trackmate/trackmate-kalman-tracker-principle.png' width='400px' %}
