...
logo: /media/plugins/trackmate-Logo85x50-color-300p.png
...
![](/media/plugins/trackmate Celegans devel.gif "TrackMate_Celegans_devel.gif")
...
<figure><img src="/media/plugins/trackmate Celegans lineage detail.png" title="TrackMate_Celegans_lineage_detail.png" width="500" alt="TrackMate_Celegans_lineage_detail.png" /><figcaption aria-hidden="true">TrackMate_Celegans_lineage_detail.png</figcaption></figure>
...
![](/media/plugins/trackmate Split Merge Gapclosing.gif "TrackMate_Split_Merge_Gapclosing.gif")

TrackMate can be set to detect and deal with gap-closing events, splitting events and merging events.

![TrackMate Celegans CellDiameter.png](/media/plugins/trackmate Celegans CellDiameter.png "TrackMate Celegans CellDiameter.png")
...
![](/media/plugins/trackmate CelegansCellFollowed.gif "TrackMate_CelegansCellFollowed.gif")
...
[TrackMate-manual.pdf](/media/plugins/trackmate-manual.pdf) 14 MB
