...
In this tutorial we describe step by step **how to compare the performance of different classifiers** in the same segmentation problem using the [Trainable Weka Segmentation](/plugins/tws) plugin.
...
<img src="/media/plugins/tws/screenshot-open-aws.png" alt="Opening Trainable Weka Segmentation plugin" width="700"/>

For this tutorial, we used one of the TEM sections from [ Albert Cardona's public data set](/plugins/public-data-sets).

After loading, the main GUI of the plugin will pop up: <img src="/media/plugins/tws/screenshot-aws-startup.png" alt="Trainable Weka Segmentation main GUI" width="700"/>
...
![Trainable Weka Segmentation settings dialog](/media/plugins/tws/screenshot-aws-tutorial-settings-dialog.png)
...
<img src="/media/plugins/tws/screenshot-aws-tutorial-select-training-traces.png" alt="Trainable Weka Segmentation training traces selection" width="700"/>
...
![Trainable Weka Segmentation save data dialog](/media/plugins/tws/screenshot-aws-tutorial-save-data.png)
...
![WEKA GUI Chooser](/media/plugins/tws/screenshot-aws-tutorial-weka-chooser.png)

We click on "Experimenter" and the Weka Experiment Environment GUI will pop up:

<img src="/media/plugins/tws/screenshot-aws-weka-experiment-environment.png" alt="WEKA Experiment Environment GUI" width="700"/>
...
<img src="/media/plugins/tws/screenshot-weka-experiment-environment-simple-new.png" alt="WEKA Experiment Environment simple new experiment" width="700"/>
...
![WEKA Experimenter save destination ARFF file](/media/plugins/tws/screnshot-aws-tutorial-save-destination-arff.png)
...
<img src="/media/plugins/tws/screenshot-aws-tutorial-select-experiment-type.png" alt="WEKA Experimenter select experiment type" width="700"/>
...
![WEKA Experimenter add dataset dialog](/media/plugins/tws/screenshot-aws-tutorial-add-dataset.png)
...
![WEKA Experimenter select algorithm dialog](/media/plugins/tws/screenshot-aws-tutorial-select-algorithm.png)

With the *Choose* button one can open the *GenericObjectEditor* and choose another classifier:

![WEKA GenericObjectEditor selecting NaiveBayes classifier](/media/plugins/tws/screenshot-aws-tutorial-select-naivesbayes.png)
...
<img src="/media/plugins/tws/screenshot-aws-tutorial-add-some-algorithms.png" alt="WEKA Experimenter with multiple algorithms added" width="700"/>
...
One can also paste classifier settings here by right-clicking (or {% include key keys='Alt|Shift|left click' %}) and selecting the appropriate menu point from the popup menu, to either add a new classifier or replace the selected one with a new setup. This is rather useful for transferring a classifier setup from the Weka Explorer over to the Experimenter without having to setup the classifier from scratch.
...
![WEKA Experimenter save setup dialog](/media/plugins/tws/screenshot-aws-tutorial-save-setup.png)
...
<img src="/media/plugins/tws/screenshot-aws-tutorial-experiment-initial-run.png" alt="WEKA Experimenter initial run configuration" width="700"/>

Click *Start* to run the experiment:

<img src="/media/plugins/tws/screenshot-aws-tutorial-experiment-run.png" alt="WEKA Experimenter running with results in log" width="700"/>
...
<img src="/media/plugins/tws/screenshot-aws-tutorial-analyse-result-experiment.png" alt="WEKA Experimenter analyse tab with experiment results" width="700"/>
...
<img src="/media/plugins/tws/screenshot-aws-tutorial-percentage-correct-test.png" alt="WEKA Experimenter percentage correct comparison test results" width="700"/>
...
<img src="/media/plugins/tws/screenshot-aws-tutorial-analyse-number-correct.png" alt="WEKA Experimenter number correct comparison test results" width="700"/>
...
![WEKA Experimenter output format precision dialog](/media/plugins/tws/screenshot-aws-tutorial-analyse-precision-dialog.png)
...
![WEKA Experimenter result list analysis panel](/media/plugins/tws/screenshot-aws-tutorial-result-list-analyse.png)
