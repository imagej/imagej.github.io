...
<img src="/media/plugins/tws/tws-gui-ubuntu.png" alt="Gui ubuntu" width="700"/>
...
![Weka gui chooser package warning ubuntu](/media/plugins/tws/weka-gui-chooser-package-warning-ubuntu.png)
...
![Weka gui chooser package manager](/media/plugins/tws/weka-gui-chooser-package-manager.png)

This will open the Weka Package Manager window:

<img src="/media/plugins/tws/weka-package-manager-window.png" alt="Weka package manager window" width="700"/>
...
<img src="/media/plugins/tws/weka-package-manager-classificationviaclustering.png" alt="Weka package manager classificationviaclustering" width="700"/>

A confirmation dialog will pop up:

![Weka package manager confirmation](/media/plugins/tws/weka-package-manager-confirmation.png)
...
![Weka warning install package](/media/plugins/tws/weka-warning-install-package.png)
...
<img src="/media/plugins/tws/weka-package-manager-loaded-package.png" alt="Weka package manager loaded package" width="700"/>
...
![Settings new classifier](/media/plugins/tws/tws-settings-new-classifier.png)
