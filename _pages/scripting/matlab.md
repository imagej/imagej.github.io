...
-   From MATLAB R2010a onward, you can increase the Jave Heap Memory size from {% include bc path="Preferences | General | Java Heap Memory" %}. ![Matlab java heap memory](/media/scripting/matlab-java-heap-memory.png)
...
![Matlab options](/media/scripting/matlab-options.png)
...
Now, you should see a new ImageJ2 instance shows up as a window. <img src="/media/scripting/imagej-launched-from-matlab.png" alt="ImageJ2 window launched from MATLAB" width="400"/>
...
{% include img src="boats-screenshot" alt="Boats image opened in ImageJ2 from MATLAB" width="400" %}
...
<img src="/media/scripting/corn-gray-matlab.png" alt="Corn image in MATLAB" width="250"/> <img src="/media/scripting/corn-gray.png" alt="Corn image in ImageJ2" width="250"/> <img src="/media/scripting/corn-gray-transposed.png" alt="Corn image transposed in ImageJ2" width="250"/>
...
`IJM.show(name)` cannot reproduce the dimensions and the data type. Channels (C), slices (Z), and frames (T) are all treated as frames. Image type is 32 bit. <img src="/media/scripting/ijmshow-image006.png" alt="IJM.show result" width="150"/>

`copytoImagePlus` can keep the dimensions and the data type. <img src="/media/scripting/image003.png" alt="copytoImagePlus result" width="150"/>
