...
{% include info-box content='Script parameters are a feature of [ImageJ2](/software/imagej2); they will not work in plain [ImageJ1](/software/imagej1). The [Fiji](/software/fiji) distribution of ImageJ is built on ImageJ2, so they also work in Fiji.' %}
