...
{% include notice icon="info" content='Script parameters are a feature of [ImageJ2](/software/imagej2); they will not work in plain [ImageJ 1.x](/software/imagej-1.x). The [Fiji](/software/fiji) distribution of ImageJ is built on ImageJ2, so they also work in Fiji.' %}
