...
-   If you want to embed ImageJ2 inside of your Python code, such as within a [Jupyter notebook](https://jupyter.org/) using the Python kernel, check out the [PyImageJ](https://pypi.org/project/pyimagej/) Python package. It allows you to create an ImageJ2 with full access to its API from Python. See the [ImageJ2 tutorial notebooks](/tutorials/notebooks) for an introduction.
