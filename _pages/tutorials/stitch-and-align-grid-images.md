...
![](/media/stitching-menu-grid-sequence.png)

Then, the next dialog pops up to choose the stitching parameters:

![](/media/screenshot-stitch-image-grid-sequence.png)
...
![](/media/screenshot-message-sequence-stitching.png)
...
![](/media/screenshot-feature-extraction.png)
...
![](/media/screenshot-aligned-stack-v.png)
