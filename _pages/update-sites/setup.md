...
Select the file to upload, click under the *Stats/Action* column, or right-click (on macOS, {% include key content='Ctrl' %}+{% include key content='click' %}) in any column, for the context menu and select *Upload to <update site name>*.
