...
2.  (with {% include person content='gselzer' %}) **SciJava Ops** ([scijava/scijava-ops](https://github.com/scijava/scijava-ops)) and **[ImageJ Ops](/libs/imagej-ops).**
...
4.  (with {% include person content='etarena' %}) **[Coloc 2](/plugins/coloc-2)** algorithms in [ImageJ Ops](/libs/imagej-ops).
