...
Kyle Harrington developed the [FunImageJ](FunImageJ) plugin to facilitate concise [Clojure](/scripting/clojure) code, which is also an easy way to write standalone [ImageJ](/about)/[ImgLib2](/libs/imglib2)-based programs in Clojure.
