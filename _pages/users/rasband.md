...
{% include image-left name="Wayne Rasband" image-path="/media/Wayne-rasband.jpg" %} Wayne Rasband was a software developer at the National Institutes of Health (NIH) for 40 years. He retired in 2010 but continues to work on ImageJ as an NIH volunteer. He fixes bugs, answers questions and adds features based on user feedback. Wayne also manages the [ImageJ 1.x website](/ij/index.html) and [mailing list](Mailing_list).
