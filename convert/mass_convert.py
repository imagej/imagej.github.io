...
def handle_templates():
    res = []
    pages = os.path.join(root_out, "pages")
...
copy_media_enabled = True

blacklist = load_blacklist(blacklist_path)
delete_autogenerated_pages()
# _convert("Downloads", recursive=False)
# catch_media("/home/random/Development/imagej/imagej/imagej-net-temp/Updater.mw", images_dir())
convert_all()
handle_templates()
save_status()
