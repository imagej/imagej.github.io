 ...
 *  surface and the direction to the light source (sun).  If that angle is 90 degrees or more,
 *  i.e. if the slope that is directed away from the light source, the output is black.
