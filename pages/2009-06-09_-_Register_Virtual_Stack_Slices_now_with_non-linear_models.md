...
Slices](Register_Virtual_Stack_Slices "wikilink") has been updated to
work with the new generic image transformation library by {% include
person content='Saalfeld' %} and with
[bUnwarpJ](http://biocomp.cnb.uam.es/~iarganda/bUnwarpJ/) by Ignacio
Arganda. As a result, stack slices may be now registered using:
