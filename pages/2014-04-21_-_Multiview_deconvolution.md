...
associated Fiji plugin was published at [Nature
Methods](http://www.nature.com/nmeth/journal/vaop/ncurrent/full/nmeth.2929.html).
The approach is relevant especially as a fusion strategy for SPIM data,
...
The [**documentation**](Multi-View_Deconvolution "wikilink") for the
Fiji plugin contains description of parameters and a 'how to' for hacks
that didn't yet make it into the plugins menu's. It complements other
SPIM related Fiji plugins such as [**bead based
registration**](SPIM_Bead_Registration "wikilink") & [**Multiview
fusion**](Multi-View_Fusion "wikilink").

Finally, a Figure from the paper showing that multi-view deconvolution
matters\!

[700px](FIle:MV_deconv_examples.jpg "wikilink")

This is probably not the last answer to SPIM data deconvolution. We are
looking forward to the input from the computer vision community to this
hard problem.
