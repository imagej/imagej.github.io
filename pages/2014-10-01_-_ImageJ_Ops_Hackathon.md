...
[KNIME](KNIME "wikilink") is an open source data analytics, reporting and integration platform, which integrates various components for machine learning and data mining through its modular data pipelining concept. The [**KN**IME **I**mage **P**rocessing](http://knime.imagej.net/) extension, KNIP, provides nodes for working with images, and is built on the ImageJ Ops library. Ops makes it possible to execute the image processing algorithm in many contexts, including from within [ImageJ](ImageJ "wikilink") itself, from [OMERO](OMERO "wikilink"), [KNIME](KNIME "wikilink"), [CellProfiler](CellProfiler "wikilink") and beyond.

## Accomplishments

This hackathon focused on the [ImageJ Ops](ImageJ_Ops "wikilink") library, adding support for key image processing operations, as well as improving the framework itself. Achievements from the hackathon include:
...
All thresholding algorithms from [ImageJ 1.x](ImageJ_1.x "wikilink") have been ported to Ops. Available thresholding methods now include:
...
[Category:News](Category:News "wikilink") [Category:ImageJ2](Category:ImageJ2 "wikilink") [Category:Hackathons](Category:Hackathons "wikilink") [Category:Ops](Category:Ops "wikilink")
