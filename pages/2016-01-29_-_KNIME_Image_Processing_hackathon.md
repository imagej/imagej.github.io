...
### Mark Hiner
  ...
  - Proof-of-concept'd restoring the Add Imports functionality to the
    script editor ({% include github org='imagej' repo='imagej-ui-swing'
    pr='67' label='imagej/imagej-ui-swing\#67' %})
  - Added Renjin-flavored R scripting to ImageJ ({% include github
    org='scijava' repo='scripting-renjin'
  ...
  - Furthered development of the Ops Browser ({% include github
    org='imagej' repo='imagej-ui-swing' issue='60'
...
### Curtis Rueden
  ...
  - Improvements
      - Added ops to convert images between types (using map) ({%
        include github org='imagej' repo='imagej-ops'
      ...
      - Improved inplace and hybrid op interfaces ({% include github
        ...
        label='binary-inplace' %}, {% include github org='imagej'
        repo='imagej-ops'
      ...
      - Improved structure of [Script Editor](Script_Editor "wikilink")
        ...
        content='kephale' %} ({% include github org='imagej'
      ...
      - Marked [ImageJ Legacy](ImageJ_Legacy "wikilink") as optional,
        ...
        and others ({% include github org='imagej' repo='imagej'
      ...
      - Added a View marker interface to ImgLib2, to facilitate
        "lightweight" ops ({% include github org='imglib' repo='imglib2'
        pr='116' label='view-marker' %})
      - Helped clean up {% include person content='tibuch' %}'s Ops
        Views PR ({% include github org='imagej' repo='imagej-ops'
        pr='168' label='views' %})
...
<!-- end list -->
  ...
  - Bugs
      - Fixed equals/hashCode problems with
        ...
        org='imglib' repo='imglib2' pr='111' label='imglib/imglib2\#111'
        %})
      ...
      - Fixed [SCIFIO](SCIFIO "wikilink") bug with DICOM format, noticed
        ...
        org='scifio' repo='scifio' pr='292' label='dicom-file-list-npe'
        %})
      - Fixed bug when executing ops as commands, noticed by {% include
        person content='kephale' %} ({% include github org='imagej'
        repo='imagej-ops'
      ...
      - Investigated SJC bug in class loading, noticed by {% include
        ...
        github org='scijava' repo='scijava-common' issue='219'
...
<!-- end list -->
  ...
  - Research
      ...
      - Explored possible Ops matching performance improvements ({%
        include github org='imagej' repo='imagej-ops' pr='332'
        label='fast-op-index' %})
      - Improved Jenkins jobs to build SNAPSHOT javadoc for all core
        ...
        content='stelfrich' %} ({% include github org='imagej'
        repo='imagej-javadoc'
        commit='8cffdfa07c7406ebc8152cbdb84213d8a9774ff8' label='1' %},
        {% include github org='scifio' repo='scifio-javadoc'
        commit='be25fda9f6baaaaa84f62fc6081d7e0ded8891e8' label='2' %},
        {% include github org='imglib' repo='imglib2-javadoc'
...
<!-- end list -->
  ...
  - Pair programming bug-fixes and enhancements:
      - {% include github org='imagej' repo='imagej-common' pr='58'
        label='alias-for-img' %} (with {% include person
        content='kephale' %})
      - {% include github org='imagej' repo='imagej-ops' pr='318'
        label='refactor-stats-ops' %} (with {% include person
        content='imagejan' %})
      - {% include github org='imagej' repo='imagej-ops' pr='322'
...
### Tobias Pietzsch
  ...
  - reviewed, augmented and merged {% include person content='tinevez'
    %} YAML serialization for {% include github org='scijava'
    repo='ui-behaviour' label='ui-behaviour' %}.
  - moved {% include github org='scijava' repo='ui-behaviour'
...
### Stefan Helfrich
  ...
  - worked on integral image-based local thresholding ops
      - {% include github org='imglib' repo='imglib2-algorithm' pr='17'
        label='corner-cursor' %}
      - {% include github org='imglib' repo='imglib2-algorithm' pr='16'
        label='integralimg-of-squares' %}
      - {% include github org='imagej' repo='imagej-ops' pr='335'
...
## Technical discussions
  ...
  - How to handle "lazy" ops ({% include github org='imagej'
