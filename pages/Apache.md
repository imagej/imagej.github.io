...
%}The **Apache License** is a **permissive** [free
...
The Apache License is named for the [Apache Software
...
{% include license name='Apache License 2.0' shortname='Apache 2'
description='The """Apache 2""" license is a permissive license, similar
to the [MIT](MIT "wikilink") and [BSD](BSD "wikilink") licenses, but
with additional protection against patent-related lawsuits. A licensee
of Apache-2-licensed software can:
