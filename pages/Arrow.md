...
{% include component-stats content=':sc.fiji:Arrow\_' %} ![Arrow\_example.png](/images/pages/Arrow example.png "Arrow example.png")
...
![Arrow\_example2.png](/images/pages/Arrow example2.png "Arrow example2.png")
...
![Arrow\_example3.png](/images/pages/Arrow example3.png "Arrow example3.png") To customize the arrow shape and type, double click the arrow tool. A dialog is displayed that allow to select the line thickness, the arrow head length and the arrow type. Changes made to the configuration panel are reflected to the arrow immediately.
...
![Arrow\_example4.png](/images/pages/Arrow example4.png "Arrow example4.png") So far, 4 types of arrow head are implemented:
