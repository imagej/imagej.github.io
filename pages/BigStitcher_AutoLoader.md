...
![Select the files to include in the dataset.](/images/pages/BigStitcherAutoLoader1.png "Select the files to include in the dataset.")
...
![Preview of selected files](/images/pages/BigStitcherAutoLoader2.png "Preview of selected files")
...
![Defining metadata for Views.](/images/pages/BigStitcherAutoLoader3.png "Defining metadata for Views.")
...
![Options for manually moving tiles to a grid (macro-scriptable).](/images/pages/BigStitcherAutoLoader6a.png "Options for manually moving tiles to a grid (macro-scriptable).")
...
![Options for loading or re-saving the dataset.](/images/pages/BigStitcherAutoLoader4.png "Options for loading or re-saving the dataset.")
...
![Options for re-saving as multi-resolution HDF5.](/images/pages/BigStitcherAutoLoader5.png "Options for re-saving as multi-resolution HDF5.")
