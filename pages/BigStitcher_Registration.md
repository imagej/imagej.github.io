...
![BigStitcher\_Register\_basic.png](BigStitcher_Register_basic.png "BigStitcher_Register_basic.png")
...
![BigStitcher\_Register\_scpecific.png](BigStitcher_Register_scpecific.png "BigStitcher_Register_scpecific.png")
...
![BigStitcher\_Register\_fix\_same\_all\_tps.png](BigStitcher_Register_fix_same_all_tps.png "BigStitcher_Register_fix_same_all_tps.png")
...
![Parameters for Fast descriptor-based (rotation invariant) registration](BigStitcher_Register_fast_desc_rot.png "Parameters for Fast descriptor-based (rotation invariant) registration")
...
![Parameters for Precise descriptor-based (translation invariant) registration](BigStitcher_Register_prec_desc_tr.png "Parameters for Precise descriptor-based (translation invariant) registration")
...
![Parameters for ICP-based (no invariance) registration](BigStitcher_Register_icp.png "Parameters for ICP-based (no invariance) registration")
...
![BigStitcher\_regularize\_model.png](BigStitcher_regularize_model.png "BigStitcher_regularize_model.png")
...
![BigStitcher\_register\_grouping.png](BigStitcher_register_grouping.png "BigStitcher_register_grouping.png")
