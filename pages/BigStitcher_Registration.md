...
After you have [detected interest points](BigStitcher_Interest_points "wikilink") in your images, you can proceed to register them. In **MultiView mode**, select the views to be registered, right-click and choose {% include bc content='Processing|Register using Interest Points...'%}.
...
![BigStitcher\_Register\_basic.png](/images/pages/BigStitcher Register basic.png "BigStitcher Register basic.png")
...
![BigStitcher\_Register\_scpecific.png](/images/pages/BigStitcher Register scpecific.png "BigStitcher Register scpecific.png")
...
![BigStitcher\_Register\_fix\_same\_all\_tps.png](/images/pages/BigStitcher Register fix same all tps.png "BigStitcher Register fix same all tps.png")
...
![Parameters for Fast descriptor-based (rotation invariant) registration](/images/pages/BigStitcher Register fast desc rot.png "Parameters for Fast descriptor-based (rotation invariant) registration")
...
![Parameters for Precise descriptor-based (translation invariant) registration](/images/pages/BigStitcher Register prec desc tr.png "Parameters for Precise descriptor-based (translation invariant) registration")
...
![Parameters for ICP-based (no invariance) registration](/images/pages/BigStitcher Register icp.png "Parameters for ICP-based (no invariance) registration")
...
![BigStitcher\_regularize\_model.png](/images/pages/BigStitcher regularize model.png "BigStitcher regularize model.png")
...
![BigStitcher\_register\_grouping.png](/images/pages/BigStitcher register grouping.png "BigStitcher register grouping.png")
