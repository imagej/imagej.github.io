...
![BigStitcher\_Illu\_1.png](/images/pages/BigStitcher Illu 1.png "BigStitcher Illu 1.png")
...
![**Figure 1:** Performance of the illumination selection methods on the images of a 2 angle, dual-illumination, 2x3 grid dataset. All methods correctly identify the right/left side illumination for the right and left images of the grid.](/images/pages/BigStitcher Illumselect benchmark.png "Figure 1: Performance of the illumination selection methods on the images of a 2 angle, dual-illumination, 2x3 grid dataset. All methods correctly identify the right/left side illumination for the right and left images of the grid.")
...
![BigStitcher\_Illu\_2.png](/images/pages/BigStitcher Illu 2.png "BigStitcher Illu 2.png")
...
![BigStitcher\_Illu\_3.png](/images/pages/BigStitcher Illu 3.png "BigStitcher Illu 3.png")
