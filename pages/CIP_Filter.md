...
    `img2 = cip.gauss( img1 , 5 )` ![CIP\_gauss.PNG](CIP_gauss.PNG "CIP_gauss.PNG")  
...
<span style="font-size:110%">**Example**</span>  
    `img2 = cip.erode( img1 , 2 )` ![CIP\_erode.PNG](CIP_erode.PNG "CIP_erode.PNG")  
...
<span style="font-size:110%">**Example**</span>  
    `img2 = cip.dilate( img1 , 2 )` ![CIP\_dilate.PNG](CIP_dilate.PNG "CIP_dilate.PNG")  
<span style="font-size:110%">**Implementation**</span>  
...
<span style="font-size:110%">**Example**</span>  
    `img2 = cip.opening( img1 , 5 )` ![CIP\_opening.PNG](CIP_opening.PNG "CIP_opening.PNG")  
<span style="font-size:110%">**Implementation**</span>  
...
<span style="font-size:110%">**Example**</span>  
    `img2 = cip.closing( img1 , 16, 'disk' )` ![CIP\_closing.PNG](CIP_closing.PNG "CIP_closing.PNG")  
<span style="font-size:110%">**Implementation**</span>  
...
<span style="font-size:110%">**Example**</span>  
    `img2 = cip.tophat( img1 , 5, 'disk' )` ![CIP\_tophat.PNG](CIP_tophat.PNG "CIP_tophat.PNG")  
<span style="font-size:110%">**Implementation**</span>  
...
<span style="font-size:110%">**Example**</span>  
    `img2 = cip.distance( img1 , 500 )` or `img2 = cip.distance( img1 , 'threshold', 500 )` ![CIP\_distance1.PNG](CIP_distance1.PNG "CIP_distance1.PNG")  
    `img2 = cip.distance( img1 )` will build the distance map for a binary image. ![CIP\_distance2.PNG](CIP_distance2.PNG "CIP_distance2.PNG")  
<span style="font-size:110%">**Implementation**</span>  
...
<span style="font-size:110%">**Example**</span>  
    `img2 = cip.median( img1 , 5 )` ![CIP\_median.PNG](CIP_median.PNG "CIP_median.PNG")  
<span style="font-size:110%">**Implementation**</span>  
...
<span style="font-size:110%">**Example**</span>  
    `img2 = cip.invert( img1 )` ![CIP\_invert.PNG](CIP_invert.PNG "CIP_invert.PNG")  
<span style="font-size:110%">**Implementation**</span>  
