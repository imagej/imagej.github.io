...
![Teaser of what DenoiSeg can compute on your data.](/images/pages/DenoiSeg-teaser.png "Teaser of what DenoiSeg can compute on your data.")
...
![N2V train parameters](/images/pages/denoiseg-train-parameters.png "N2V train parameters")
...
![N2V train & predict parameters](/images/pages/denoiseg-trainpredict-parameters.png "N2V train & predict parameters")
...
![DenoiSeg training progress window](/images/pages/denoiseg-train-progress.png "DenoiSeg training progress window") ![N2V training preview window](/images/pages/denoiseg-train-preview.png "N2V training preview window") During training, you will see two windows:
...
You can <b>open the model directly</b>: ![DenoiSeg prediction from model parameters](/images/pages/denoiseg-modelpredict-parameters.png "DenoiSeg prediction from model parameters")
...
Alternatively, you can <b>use the DenoiSeg menu</b>: ![DenoiSeg prediction parameters](/images/pages/denoiseg-predict-parameters.png "DenoiSeg prediction parameters")
...
![Update site Labkit](/images/pages/updatesite-labkit.png "Update site Labkit") ![Labkit](/images/pages/labkit.png "Labkit") ![3D Objects counter options](/images/pages/3Dobjectscounter.png "3D Objects counter options")
