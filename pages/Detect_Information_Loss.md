...
![SplitColourChannels.png](SplitColourChannels.png "SplitColourChannels.png")

1.  **[Lossy Compression](wikipedia_Lossy_data_compression "wikilink"):** First, we can interrogate the red or green channel, and see if there are any [lossy compression](wikipedia_Lossy_data_compression "wikilink") artifacts visible by eye: Click the magnifying glass icon in the Fiji main window and left click to zoom in to an area of interest (left click zooms in, right click zooms out again).
    ...
    ![LossyJPEGCompressionArtifacts1.png](LossyJPEGCompressionArtifacts1.png "LossyJPEGCompressionArtifacts1.png")
2.  **Intensity Saturation or Clipping or [Over Exposure:](wikipedia_Overexposure "wikilink")** Next we can have a look to see of the image has been acquired or manipulated in such a way that the highest intensity information has been lost, due to detector [CCD](wikipedia_Charge-coupled_device "wikilink"), [PMT](wikipedia_Photomultiplier "wikilink"), etc. saturation / over exposure, such that the intensity scale of the information is clipped off at the top, like a mountain with the peak removed... so you can't tell how high it was.
    ...
    ![SaturatedDAPIHistogram.png](SaturatedDAPIHistogram.png "SaturatedDAPIHistogram.png")
