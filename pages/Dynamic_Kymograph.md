...
{% capture includecontent %} name = Dynamic\_Kymograph | software = Fiji
| author = {% include person content='Rudy Zhou' %} | maintainer = {%
include person content='Rudy Zhou' %} | released = 26 July 2018 | source
