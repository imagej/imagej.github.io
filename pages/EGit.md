...
This page provides an introduction on how to start using the
[EGit](http://www.eclipse.org/egit/) extension in the
...
2.  you can look in the "All Available Sites" drop down panel if EGit is
    existing there or add update site with the  button
3.  enter this URI: http://download.eclipse.org/egit/updates
4.  choose the *JGit* and the *Eclipse Team Provider* and  the
    installation
...
1.  go to  and select under  at least *Git Repositories* and *Git
    Staging*
    1.  additionally, it is helpful to add under  *History*
...
4.  hit  and select the branch(es) you would like to clone (then hit )
...
6.  once the cloned repository is visible in the *Git Repositories*
    ...
    2.  specify the projects name and 
