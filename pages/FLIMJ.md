...
![FLIMJ\_usage\_open\_dataset.png](FLIMJ_usage_open_dataset.png "FLIMJ_usage_open_dataset.png")
...
![FLIMJ\_first\_launch.png](FLIMJ_first_launch.png "FLIMJ_first_launch.png")
...
![Options on the **Settings** pannel.](FLIMJ_fit_settings.png "Options on the Settings pannel.")
...
![Left to right: Intensity of dataset after binning of radius 0, 1, and 2.](FLIMJ_settings_binning.png "Left to right: Intensity of dataset after binning of radius 0, 1, and 2.")
...
![Change of the cursors results in different fit results.](FLIMJ_settings_start_end.png "Change of the cursors results in different fit results.")
...
2.  In **Preview** panel, select *IRF Intensity* for the "Show" option (you may also select *Grayscale* for the "as" option to deactivate pseudocoloring):![Choose *IRF Intensity* to enter IRF picking mode.](FLIMJ_irf_show_irf.png "Choose IRF Intensity to enter IRF picking mode.")
3.  Click on the image to select the candidate pixel and adjust the *Start* and *End* cursors in **Plot** pannel to crop out the section of interest (*IRF is plotted in green*):![Drag the cursors to crop IRF.](FLIMJ_irf_crop_irf.png "Drag the cursors to crop IRF.")
...
![Viewing the \(\tau\) (lifetime) parameter of the fitted dataset.](FLIMJ_fit_dataset_preview_results_show.png "Viewing the \\tau (lifetime) parameter of the fitted dataset.")

You may also change the "as" option to specify how the results are rendered. Currently supported options are:

![Left to right: The \(\tau\) image rendered with **Grayscale**, **Color** and **Composite Color**.](FLIMJ_fit_dataset_preview_results_as.png "Left to right: The \\tau image rendered with Grayscale, Color and Composite Color.")
...
![Hover on image to see the color bar, the pixel value, and its place in the range.](FLIMJ_fit_dataset_preview_results_lut.png "Hover on image to see the color bar, the pixel value, and its place in the range.")

## Image export

![Options on the **Export** pannel.](FLIMJ_image_export.png "Options on the Export pannel.")
