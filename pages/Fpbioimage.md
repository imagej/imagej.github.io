...
{% capture includecontent %} software = ImageJ | name = FPBioimage
Helper Plugin | logo = ![FPB\_Logo.png](/images/pages/FPB_Logo.png "FPB_Logo.png")" |
author = [FPBioimage](http://fpb.ceb.cam.ac.uk)  
Marcus Fantham | Maintainer = Marcus Fantham | source = {% include
github org='fpBioimage' repo='FPBioimageHelper-FIJI' %}

{% endcapture %}

{% include info-box content=includecontent %} FPBioimage is an
interactive tool for viewing volumetric data in the web browser. To
quickly share 3D data with your collaborators using FPBioimage, we
provide this useful plugin for ImageJ and FIJI. %Replace% TOC %Replace%
...
content='org = fpbioimage | repo = FPBioimageHelper-FIJI' %}.

The source code for the FPBioimage web app can also be accessed {%
include github content='org = fpbioimage | repo = unity' %}.
