...
{% capture includecontent %} name = Gabriel Graph | software = Fiji |
author = Olivier Burri | maintainer = Olivier Burri | filename =
Gabriel\_Graph-1.0.0.jar | released = August 2015 | latest version =
July 2017 | source = {% include github org='ptbiop'
repo='ijp-gabriel-graph' %} | status = stable | website = [BIOP Staff
