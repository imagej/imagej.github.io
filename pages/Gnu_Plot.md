...
{% include info-box software='ImageJ1' name='Gnu\_Plot' author='Fred Damen' Maintainer='Fred Damen' filename='Gnu\_Plot.jar' source=' [Gnu\_Plot.zip](https://imagej.net/_images/2/23/Gnu_Plot.zip) ' released='1 April 2020' status='stable' category='[Plotting‏‎](:Category:Plotting‏‎ "wikilink")' website='' %}
...
[Category:Plotting‏‎](Category:Plotting‏‎ "wikilink") [Category:Plugins](Category:Plugins "wikilink")
