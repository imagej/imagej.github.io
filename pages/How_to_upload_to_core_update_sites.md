...
breadcrumb: How to upload to core update sites
layout: page
author: test author
categories: 
...
1.  Update {% include GitHub content="org=fiji | repo=fiji |
    label=Fiji.git" %} to depend on the latest {% include GitHub
    content="org=scijava | repo=pom-scijava | label=pom-scijava" %}
...
{% include warning-box content="There is a known issue where
...
content="Help | Update" %} and click on the *Manage update sites*
button:
