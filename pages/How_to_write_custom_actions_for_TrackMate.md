...
two classes. The behavior is described by the  interface. The
integration mechanism is controlled by the  interface, which extends the
 interface.
...
check its  to know what we can get. It gives us access to:
