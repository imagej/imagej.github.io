...
Refactoring ImageJ to use an MVC design is a significant effort, but fortunately, preliminary work has already been done in this direction: Grant Harris has written a whitepaper (![ImageJX\_Mar09.pdf](ImageJX_Mar09.pdf "ImageJX_Mar09.pdf")) describing his efforts thus far to deploy an interface-driven architecture for extensible, modular GUI support. With further development, we will transform ImageJ into a flexible library usable by a wide variety of scientific image software.
...
## See also
  ...
  - ![ImageJX\_Mar09.pdf](ImageJX_Mar09.pdf "ImageJX_Mar09.pdf"), the ImageJX whitepaper from 2008
