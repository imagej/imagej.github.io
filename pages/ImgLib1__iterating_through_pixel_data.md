...
The architecture of [Imglib](Imglib "wikilink") aims at completely separating the image - which can be seen as a data container - from the concrete basic data type it encapsulates. In practice, this means that you can write "blind" algorithms, which can safely ignore whether they operate on a `uint8` image, a RGB image or a `uint16` stack of 15 slices.
...
[Category:ImgLib](Category:ImgLib "wikilink") [Category:Tutorials](Category:Tutorials "wikilink") [Category:Development](Category:Development "wikilink")
