...
Many more file formats can be imported via Fiji plugins. One plugin is called [Bio-Formats](Bio-Formats "wikilink"). This will import and export a wide number of file formats along with their important metadata. They can be accessed directly via the menu command {% include bc content='File | Import | Bio-Formats'%} or indirectly via the {% include bc content='File | Open'%} menu command which will use the Bio-Formats plugin if needed. See the [list of supported file formats](http://openmicroscopy.org/site/support/bio-formats5/supported-formats.html) on the Bio-Formats website for the complete list (135 as of this writing).
...
The LSM panel plugin duplicates the Zeiss LSM file import function of the LOCI Bio-Format Importer, but will also extensively catalogue the LSM metadata. The *[LSM Toolbox](LSM_Toolbox "wikilink")* is activated by the menu command {% include bc content='File | Import | LSM.'%} Once you select LSM the panel will appear.
...
## Fiji Extensions
  ...
  - **[Extract Images From PDF...](Extract_Images_From_PDF... "wikilink")**: Extract all images from a PDF file, in their original resolution.
...
[Category:Cookbook](Category:Cookbook "wikilink") [Category:Tutorials](Category:Tutorials "wikilink") [Category:Plugins](Category:Plugins "wikilink") [Category:Import-Export](Category:Import-Export "wikilink")
