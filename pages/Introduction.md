...
\== What is ImageJ? == ![ x48px | link=ImageJ](Imagej2-icon.png
" x48px | link=ImageJ") [ImageJ](ImageJ "wikilink") is an [open
source](open_source "wikilink") [image
processing](techniques "wikilink") program for multidimensional image
data with a focus on scientific imaging.
