...
This link contains the data used to generate this tutorial, and a two channel 3D data set to try. [Media:Example\_Data.zip‎](Media:Example_Data.zip‎ "wikilink")
