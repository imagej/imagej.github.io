...
## Prerequisites
  ...
  - Add the {% include list-of-update-sites content='ImageJ-MATLAB' %} update site. See [Following an update site](Following_an_update_site "wikilink") for more detail.
    ...
    3.  Tick `ImageJ-MATLAB` and then `Close` ![Manage\_update\_sites\_ImageJ\_MATLAB.png](/images/pages/Manage update sites ImageJ MATLAB.png "Manage update sites ImageJ MATLAB.png")
...
### Memory issue
  ...
  - From MATLAB R2010a onward, you can increase the Jave Heap Memory size from **Preferences \> General \> Java Heap Memory**. ![MATLAB\_java\_heap\_memory.png](/images/pages/MATLAB java heap memory.png "MATLAB java heap memory.png")
...
![MATLAB\_options.png](/images/pages/MATLAB options.png "MATLAB options.png")
