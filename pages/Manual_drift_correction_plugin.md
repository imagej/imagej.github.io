...
To get started with the plugin first download it (![Manual\_Drift\_Correction-1.0.0.jar.zip](/images/pages/Manual_Drift_Correction-1.0.0.jar.zip "Manual_Drift_Correction-1.0.0.jar.zip")), unzip it and install it (Fiji menu Plugins\>Install...). Alternatively you can manually copy the unzipped file in <Fiji folder>/plugins.Once the file is installed, restart Fiji. A new entry will be available in the menu Plugins\>Registration\>Manual drift correction meaning that the plugin was properly installed.
