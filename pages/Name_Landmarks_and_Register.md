...
source="landmarks/Name\_Points.java" %} {% endcapture %} {% include
sidebox-right software='ImageJ' name='Name Landmarks and Register'
author='Mark Longair and Greg Jefferis' maintainer='Mark Longair'
