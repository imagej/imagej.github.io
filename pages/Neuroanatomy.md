...
{% capture includecontent %} software = Fiji | name = Neuroanatomy
update site | author = {% include person content='Tiago' %} | maintainer
= {% include person content='Tiago' %} | source = {% include github
org='tferr' repo='hIPNAT' %} | released = April 2016 | status = Active |
latest version = **1.0.10 May 2017** ({% include github org='tferr'
repo='hIPNAT/releases' label='Changelog' %}) | category =
...
| Multi-SWC renderer      | {% include bc content='Plugins|NeuroAnatomy|Render Multiple SWC Files'%}     | Renders multiple SWC files in a single image canvas or a [3D viewer](3D_Viewer "wikilink") universe. Implemented as a {% include github org='tferr' repo='hIPNAT' path='src/main/resources/scripts/' label='Python' %}.                                                                                                                                                                                                                                                                                                                 |
| Remote File renderer    | {% include bc content='Plugins|NeuroAnatomy|Render Remote SWC File'%}        | Exemplifies how to download and access a remote (e)SWC (internet connection required). Implemented as a {% include github org='tferr' repo='hIPNAT' path='src/main/resources/scripts/' label='Python' %}.                                                                                                                                                                                                                                                                                                                               |
| *Utilities*             |                                                                              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Fractal Trees           | {% include bc content='File|Open Samples|Fractal Tree'%}                     | Synthetic images ([L-System](https://en.wikipedia.org/wiki/L-system) Trees) useful for debugging, testing or prototyping. Implemented as a {% include github org='tferr' repo='hIPNAT' path='src/main/java/ipnat/skel' label='Java' %}.                                                                                                                                                                                                                                                                                                 |
