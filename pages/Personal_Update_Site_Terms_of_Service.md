...
{% include menu-updatesites%}By creating a personal update site, you agree to the following terms and conditions:
...
4.  It is strongly encouraged, but not required, for your functionality to use an [open source](open_source "wikilink") license.
