...
![TrakEM2-tree-datastructure.png](TrakEM2-tree-datastructure.png "TrakEM2-tree-datastructure.png") ![TrakEM2-display-s.jpg](TrakEM2-display-s.jpg "TrakEM2-display-s.jpg")
...
<!-- end list -->
  ...
  - [Sample OME-TIFF data on openmicroscopy.org](http://www.openmicroscopy.org/site/support/file-formats/ome-tiff/ome-tiff-data), thanks to Josh Bembenek.![*C. elegans* embryo coexpressing tubulin histone GFP](tubhiswt4D.png "C. elegans embryo coexpressing tubulin histone GFP")
...
<!-- end list -->
  ...
  -   
    4D data set, kindly provided by Dirk Sieger and [Francesca Peri](http://www.embl.de/research/units/dev_biology/peri/), EMBL.![Macrophages in 4D](Migrating-macrophages.gif "Macrophages in 4D")
