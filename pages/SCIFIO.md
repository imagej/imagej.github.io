...
SCIFIO is focused on robust and extensible support for reading and writing image file formats. Using it with ImageJ provides many advantages:
  ...
  - There is a [Bio-Formats](Bio-Formats "wikilink") plugin for SCIFIO, included with the [Fiji](Fiji "wikilink") distribution of ImageJ, that adds automatic support for over a hundred life sciences file formats.
