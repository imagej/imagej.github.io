...
<div align="left">
  ...
  - ![Stretch-to-Fill - enabled](/images/pages/Reconstruction-viewer-stretched.png "Stretch-to-Fill - enabled")
...
<div align="left">
  ...
  - ![Impose Isotropic Scale - None](/images/pages/Reconstruction-viewer-aspect-ratio-none.png "Impose Isotropic Scale - None")
...
<div align="left">
  ...
  - ![Unique Color Coding](/images/pages/Reconstruction-viewer-color-mapping-unique.png "Unique Color Coding")
...
<div align="left">
  ...
  - ![Thickness = 1.0](/images/pages/Reconstruction-viewer-thickness-1.png "Thickness = 1.0")
...
<div align="left">
  ...
  - ![Transparency = 95%](/images/pages/Reconstruction-viewer-obj-transparency-95.png "Transparency = 95%")
...
<div align="center">
  ...
  - ![Allen Adult Mouse Whole Brain + Thalamus](/images/pages/Reconstruction-viewer-whole-mouse-thalamus.png "Allen Adult Mouse Whole Brain + Thalamus")
...
![Brain Area Analyis: Cable Length](/images/pages/Reconstruction-viewer-brain-area-analysis.png "Brain Area Analyis: Cable Length")
  ...
  - {% include bc content='Create Dendrogram...'%} Runs the {% include bc content='Utilities|Create Dendrogram...'%} command found in the main SNT dialog. See [Dendrogram Viewer](SNT:_Analysis#Dendrogram_Viewer "wikilink"). Note only one reconstruction may be selected at a time with this option.
...
<div align="left">
  ...
  - ![AA0100 Sholl Table](/images/pages/Reconstruction-viewer-AA0100-sholl-table.png "AA0100 Sholl Table")
...
### Scripting
  ...
  - {% include bc content='Script This Viewer'%} Opens an instance of the Script Editor with pre-loaded extensible boilerplate code for advanced scripting of Reconstruction Viewer. For an example of the scripting capabilities of Reconstruction Viewer, see [Scripting Reconstruction Viewer](SNT:_Scripting#Scripting_Reconstruction_Viewer "wikilink"). A related script template can also be found in the Script Editor at {% include bc content='Templates|Neuroanatomy|Analysis|Reconstruction Viewer Demo (Python)'%}.
