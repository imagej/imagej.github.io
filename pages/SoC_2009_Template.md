...
a success? What features must be there? What functionality must it have?
...
of any existing code. Describe the existing libraries or other projects
that your project will be able to reuse and benefit from.

## About You

Can you list some prior projects that you have worked on?

These don't need to be Fiji (or even open source) related. We'd love to
...
list, or even just chatted up someone on \#fiji, please include
