...
![Screenshot-File-Browser-Sequence.png](Screenshot-File-Browser-Sequence.png "Screenshot-File-Browser-Sequence.png")

## Stitching

As a first step, we start Fiji and go to '{% include bc content='Plugins | Stitching | Stitch Sequence of Grids of Images'%}':

![Stitching-Menu-Grid-Sequence.png](Stitching-Menu-Grid-Sequence.png "Stitching-Menu-Grid-Sequence.png")

Then, the next dialog pops up to choose the stitching parameters:

![Screenshot-Stitch\_Image\_Grid\_Sequence.png](Screenshot-Stitch_Image_Grid_Sequence.png "Screenshot-Stitch_Image_Grid_Sequence.png")
...
![Screenshot-Message-Sequence-Stitching.png](Screenshot-Message-Sequence-Stitching.png "Screenshot-Message-Sequence-Stitching.png")

As result, the stitched images are stored in the output folder:

![Screenshot-File-Browser-Stitched-Sequence.png](Screenshot-File-Browser-Stitched-Sequence.png "Screenshot-File-Browser-Stitched-Sequence.png")
...
![Screenshot-RVSS-Menu.png](Screenshot-RVSS-Menu.png "Screenshot-RVSS-Menu.png")

As before, a dialog will pop up where we have to choose the registration parameters:

![Screenshot-Register\_Virtual\_Stack.png](Screenshot-Register_Virtual_Stack.png "Screenshot-Register_Virtual_Stack.png")
...
![Screenshot-Feature\_extraction.png](Screenshot-Feature_extraction.png "Screenshot-Feature_extraction.png")
