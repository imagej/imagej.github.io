...
<!-- end list -->
  ...
  - Iteration log  
    If *Show detailed information* is checked, *Average branch length*, *N. of trees*, *N. of branches*, *N. of junctions*, *N. of triple points*, *N. of quadruple points* are also retrieved for each iteration. These are described in the AnalyzeSkeleton's [documentation page](AnalyzeSkeleton#Table_of_results "wikilink").
...
## Related Links
  ...
  - [AnalyzeSkeleton](AnalyzeSkeleton "wikilink") and [Skeletonize3D](Skeletonize3D "wikilink"), analysis of topographic skeletons
  - [Sholl Analysis](Sholl_Analysis "wikilink"), bitmap morphometry based on the Sholl technique
...
[Skeletonization](Skeletonize3D "wikilink") and [Skeleton Analysis](AnalyzeSkeleton "wikilink"):
