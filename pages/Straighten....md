...
![The original banana with a segmented line selection](Tutorial-banana-selection.png "The original banana with a segmented line selection")
...
![The result of running the Straighten plugin](Tutorial-banana-straightened.jpg "The result of running the Straighten plugin")
...
![The original banana and the straightened version](Tutorial-bananas-result.jpg "The original banana and the straightened version")
