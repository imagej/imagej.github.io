...
![Replace the value 3095.975 in the source code with your microscope spatial scale.](Scale.png "Replace the value 3095.975 in the source code with your microscope spatial scale.") To convert pixels to mm<sup>2</sup>, the image spatial scale is required. This can be found in the image metadata or in the microscope's bundled software.
...
![Representative animation of Macro Mode. Processing time is \~5 seconds/image.](Stack_-_Macro.gif "Representative animation of Macro Mode. Processing time is ~5 seconds/image.") ![Representative animation of Batch Mode. Processing time is \~2.7 seconds/image.](Stack_-_Batch.gif "Representative animation of Batch Mode. Processing time is ~2.7 seconds/image.")
...
![Example of an original TUNEL assay image (top) after macro processing (bottom).](Montage.jpg "Example of an original TUNEL assay image (top) after macro processing (bottom).")
...
![A new window is generated with the output variables.](Bar.png "A new window is generated with the output variables.") When executed in Batch Mode, ONL Area, INL Area, ONL TUNEL<sup>+</sup> cells, and INL TUNEL<sup>+</sup> cells are reported. These values were used for macro validation.  
