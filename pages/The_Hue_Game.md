...
It is also educating to play with the hues that are displayed. The script represents colors in the [CIELab space](wikipedia:CIELAB "wikilink"). The *L* axis represents the luminance. The *a* and *b* axes represent the hue (*a* is often referred to as the green/red axis and *b* as yellow/blue one, but this is not quite an accurate notion).
