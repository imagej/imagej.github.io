...
Hit {% include key content='Ctrl|L' %} to start the [Command Finder](Command_Finder "wikilink"). Type (part of) the name of the entry, then click on *Show full information*.
