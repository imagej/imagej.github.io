...
There is a ROI exporter action is in a separate package called `TrackMate-extras`. To install it, you have to download its *jar* file and drop it in the *plugins* folder of Fiji. Link and instructions are on the [TrackMate\#Downloadable\_jars](TrackMate#Downloadable_jars "wikilink") page.
...
![TrackMate\_JaggedLines.png](/images/pages/TrackMate_JaggedLines.png "TrackMate_JaggedLines.png")
...
This kind of error is caused when a Java class is missing in your installation. In most cases, this happens because your Fiji installation did not update properly. Possible solutions are
  ...
  - Check if you have the [Jave8](2015-12-22_-_The_road_to_Java_8 "wikilink") update site in the Fiji [Updater](Updater "wikilink")
  - Finally, if nothing works, rather than digging in your Fiji installation in details, just install Java 8 and [re-download](Downloads "wikilink") a fresh Fiji application.
