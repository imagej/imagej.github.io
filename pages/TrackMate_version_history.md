...
This page contains the version history for the [TrackMate](TrackMate "wikilink") plugin. Bug fixes are not mentioned here, and do not get their own release number.
...
## 19/03/2014 - v2.2.0
  ...
  - We also took the chance to rewrite all the detectors from scratch, using the latest development in [ImgLib2](ImgLib2 "wikilink"). This prompted **major performance improvement for the detection process**.
...
TrackMate version bumped by several increments, prompted by the [big update](2014-12-10_-_ImgLib2_released "wikilink") that happened to Fiji between this and the previous release. Some minor bugfixes and improvements are shipped nonetheless.
...
## 26-01-2015 - v2.7.1
  ...
  - Add a new tracking algorithm: [the linear motion LAP tracker](TrackMate_algorithms#Linear_motion_tracker "wikilink").
...
If you need other detectors and trackers, you have to rely on Python for now. [Scripting\_TrackMate](Scripting_TrackMate "wikilink")
