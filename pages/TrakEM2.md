...
{% endcapture %}
{% include thumbnail src="/images/pages/3D-Viewer.jpg" title=title %} 
{% capture title%}
 The three TrakEM2 trees, as an interface for editing and visualizing the three internal TrakEM2 data structures. 
{% endcapture %}
{% include thumbnail src="/images/pages/TrakEM2-trees.png" title=title %} 
{% capture title%}
...
{% endcapture %}
{% include thumbnail src="/images/pages/Clahe-live-filter.jpg" title=title %} 
{% capture title%}
 Neuronal arbors reconstructed with TrakEM2 using the [treeline](http://www.ini.uzh.ch/~acardona/trakem2_manual.html#trees) segmentation type. 
{% endcapture %}
{% include thumbnail src="/images/pages/Neuronal-arbors-1.png" title=title %} 
{% capture title%}
 Neuronal arbors from serial section electron microscopy reconstructed with TrakEM2 using the [manually segmentated data set](http://www.ini.uzh.ch/~acardona/data.html). 
{% endcapture %}
{% include thumbnail src="/images/pages/TrakEM2-arealists.png" title=title %} 
{% capture title%}
 [TrakEM2](TrakEM2 "wikilink") showing one section of a serial section transmission electron microscopy (ssTEM) data set, with numerous neuronal arbors reconstructed using [treelines](http://www.ini.uzh.ch/~acardona/trakem2_manual.html#trees) and [connectors](http://www.ini.uzh.ch/~acardona/trakem2_manual.html#connectors) (for synapses). 
{% endcapture %}
{% include thumbnail src="/images/pages/TrakEM2-display-2.png" title=title %} 
{% capture title%}
 Example TrakEM2 segmentations, including Ball, Pipe, Profile, AreaList and floating text labels. 
{% endcapture %}
{% include thumbnail src="/images/pages/TrakEM2 Display segmentations.png" title=title %} {% include clear content='left' %}
