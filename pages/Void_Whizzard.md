...
A user guide with download and installation instructions is available here: [Media:Void Whizzard User Guide v1.4.pdf](Media:Void_Whizzard_User_Guide_v1.4.pdf "wikilink")
...
`         `![`Void_Whizzard.PNG`](/images/pages/Void_Whizzard.PNG "Void_Whizzard.PNG")` `![`Figure_01.jpg`](/images/pages/Figure_01.jpg "Figure_01.jpg")
