...
![TrackAdvancedWater.png](/images/pages/TrackAdvancedWater.png "TrackAdvancedWater.png")"

Here the user can again make a choice of increasing or decreasing the edge enhancement factor.

All the watershed and MSER parameters appear in the second panel. The threshold value to create the binary image to perform watershedding has been explained in the section about it in [watershedding and Hough transform parameters](watershedding_and_Hough_transform_parameters "wikilink").
...
The MSER parameters that appear here as explained in [MSER parameters](MSER_parameters "wikilink")
