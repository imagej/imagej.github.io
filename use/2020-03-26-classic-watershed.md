...
To include images with a legend, use the markdown/HTML syntax above nested inside a <div class="figure POSITION" markdown="1"></div> tags, where position can be: left, right and center. For example:
...
This is example text for the caption
